---
layout: container
name:  "quay.io/biocontainers/bioconductor-cottonprobe"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:25:21.734143"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cottonprobe
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-cottonprobe:2.18.0--r42hdfd78af_10
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cottonprobe/2.18.0--r42hdfd78af_10
$ module help quay.io/biocontainers/bioconductor-cottonprobe/2.18.0--r42hdfd78af_10
```
...
#### bioconductor-cottonprobe-shell:
...
#### bioconductor-cottonprobe-inspect:
...
#### bioconductor-cottonprobe-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cottonprobe-inspect-deffile:
