---
layout: container
name:  "quay.io/biocontainers/bioconductor-epimutacionsdata"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:06:59.375707"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epimutacionsdata
```
...
#### bioconductor-epimutacionsdata-run:
...
#### bioconductor-epimutacionsdata-shell:
...
#### bioconductor-epimutacionsdata-exec:
...
#### bioconductor-epimutacionsdata-inspect:
...
#### bioconductor-epimutacionsdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-epimutacionsdata-inspect-deffile:
