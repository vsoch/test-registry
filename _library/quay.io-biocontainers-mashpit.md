---
layout: container
name:  "quay.io/biocontainers/mashpit"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:34:51.318272"
...
```bash
$ module load quay.io/biocontainers/mashpit/0.9.2--pyhdfd78af_0
$ module help quay.io/biocontainers/mashpit/0.9.2--pyhdfd78af_0
```
...
#### mashpit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mashpit-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mashpit
$ podman run --it --rm --entrypoint /usr/local/bin/mashpit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mashpit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
