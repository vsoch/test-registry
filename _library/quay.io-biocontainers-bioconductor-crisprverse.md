---
layout: container
name:  "quay.io/biocontainers/bioconductor-crisprverse"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:35:04.071899"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprverse
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprverse:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprverse/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprverse/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-crisprverse-shell:
...
#### bioconductor-crisprverse-inspect:
...
#### bioconductor-crisprverse-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-crisprverse-inspect-deffile:
