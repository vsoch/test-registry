...
updated_at: "2023-03-09 03:41:29.084630"
latest: "0.4.6--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/atlas-fastq-provider:0.4.6--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/atlas-fastq-provider/0.4.6--hdfd78af_0
$ module help quay.io/biocontainers/atlas-fastq-provider/0.4.6--hdfd78af_0
```
