---
layout: container
name:  "quay.io/biocontainers/bioconductor-charm"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:30:51.975162"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-charm
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-charm:2.28.0--r351_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-charm/2.28.0--r351_0
$ module help quay.io/biocontainers/bioconductor-charm/2.28.0--r351_0
```
...
#### bioconductor-charm-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-charm-inspect-deffile:
