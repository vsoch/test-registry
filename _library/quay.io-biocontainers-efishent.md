...
updated_at: "2023-03-09 03:00:05.420570"
...
```bash
$ shpc install quay.io/biocontainers/efishent:0.0.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/efishent/0.0.2--pyhdfd78af_0
$ module help quay.io/biocontainers/efishent/0.0.2--pyhdfd78af_0
```
