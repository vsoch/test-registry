...
updated_at: "2023-03-10 03:09:30.559588"
...
```bash
$ shpc install quay.io/biocontainers/mob_suite:3.1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mob_suite/3.1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/mob_suite/3.1.4--pyhdfd78af_0
```
