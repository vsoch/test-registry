---
layout: container
name:  "quay.io/biocontainers/perl-devel-symdump"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:34:13.815871"
...
```bash
$ shpc install quay.io/biocontainers/perl-devel-symdump
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-devel-symdump:2.18--pl5321hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/perl-devel-symdump/2.18--pl5321hdfd78af_2
$ module help quay.io/biocontainers/perl-devel-symdump/2.18--pl5321hdfd78af_2
```
...
#### perl-devel-symdump-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-devel-symdump-inspect-deffile:
