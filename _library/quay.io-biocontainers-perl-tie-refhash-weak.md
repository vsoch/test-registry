---
layout: container
name:  "quay.io/biocontainers/perl-tie-refhash-weak"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:13:18.800080"
latest: "0.09--pl526_2"
...
```bash
$ shpc install quay.io/biocontainers/perl-tie-refhash-weak
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-tie-refhash-weak:0.09--pl526_2
```
...
```bash
$ module load quay.io/biocontainers/perl-tie-refhash-weak/0.09--pl526_2
$ module help quay.io/biocontainers/perl-tie-refhash-weak/0.09--pl526_2
```
...
#### perl-tie-refhash-weak-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-tie-refhash-weak-inspect-deffile:
