---
layout: container
name:  "quay.io/biocontainers/bioconductor-affypdnn"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:39:11.214863"
latest: "1.60.0--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-affypdnn
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-affypdnn:1.60.0--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-affypdnn/1.60.0--r36_0
$ module help quay.io/biocontainers/bioconductor-affypdnn/1.60.0--r36_0
```
...
#### bioconductor-affypdnn-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-affypdnn-inspect-deffile:
