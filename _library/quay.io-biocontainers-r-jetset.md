---
layout: container
name:  "quay.io/biocontainers/r-jetset"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:28:54.221078"
...
```bash
$ shpc install quay.io/biocontainers/r-jetset
```
...
#### r-jetset-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-jetset-inspect-deffile:
