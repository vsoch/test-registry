---
layout: container
name:  "quay.io/biocontainers/typing"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:06:36.119001"
...
```bash
$ shpc install quay.io/biocontainers/typing
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/typing:3.5.2.2--py36_0
```
...
```bash
$ module load quay.io/biocontainers/typing/3.5.2.2--py36_0
$ module help quay.io/biocontainers/typing/3.5.2.2--py36_0
```
...
#### typing-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### typing-inspect-deffile:
