---
layout: container
name:  "quay.io/biocontainers/perl-bio-asn1-entrezgene"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:29:54.328078"
...
aliases:
 ...
 - "chartex"
versions:
 - "1.73--pl5321hdfd78af_3"
description: "shpc-registry automated BioContainers addition for perl-bio-asn1-entrezgene"
config: {"url": "https://biocontainers.pro/tools/perl-bio-asn1-entrezgene", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for perl-bio-asn1-entrezgene", "latest": {"1.73--pl5321hdfd78af_3": "sha256:175f133ff788fc21d37c4d077a60c30b7db83af250af1883eee3bb0a5e4b0243"}, "tags": {"1.73--pl5321hdfd78af_3": "sha256:175f133ff788fc21d37c4d077a60c30b7db83af250af1883eee3bb0a5e4b0243"}, "docker": "quay.io/biocontainers/perl-bio-asn1-entrezgene", "aliases": {"bp_find-blast-matches.pl": "/usr/local/bin/bp_find-blast-matches.pl", "ace.pl": "/usr/local/bin/ace.pl", "ccconfig": "/usr/local/bin/ccconfig", "SOAPsh.pl": "/usr/local/bin/SOAPsh.pl", "map": "/usr/local/bin/map", "mirrorMappings": "/usr/local/bin/mirrorMappings", "mkCSGB2312": "/usr/local/bin/mkCSGB2312", "mkmapfile": "/usr/local/bin/mkmapfile", "stubmaker.pl": "/usr/local/bin/stubmaker.pl", "chartex": "/usr/local/bin/chartex"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/perl-bio-asn1-entrezgene.
shpc-registry automated BioContainers addition for perl-bio-asn1-entrezgene
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/perl-bio-asn1-entrezgene
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-bio-asn1-entrezgene:1.73--pl5321hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/perl-bio-asn1-entrezgene/1.73--pl5321hdfd78af_3
$ module help quay.io/biocontainers/perl-bio-asn1-entrezgene/1.73--pl5321hdfd78af_3
```
...
#### perl-bio-asn1-entrezgene-shell:
...
#### perl-bio-asn1-entrezgene-inspect:
...
#### perl-bio-asn1-entrezgene-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-bio-asn1-entrezgene-inspect-deffile:
