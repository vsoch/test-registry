---
layout: container
name:  "quay.io/biocontainers/multiprocess"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:57:57.533029"
...
```bash
$ shpc install quay.io/biocontainers/multiprocess
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/multiprocess:0.70.4--py35_0
```
...
```bash
$ module load quay.io/biocontainers/multiprocess/0.70.4--py35_0
$ module help quay.io/biocontainers/multiprocess/0.70.4--py35_0
```
...
#### multiprocess-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### multiprocess-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/get_objgraph.py
$ podman run --it --rm --entrypoint /usr/local/bin/get_objgraph.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/get_objgraph.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/unpickle.py
$ podman run --it --rm --entrypoint /usr/local/bin/unpickle.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/unpickle.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
