...
updated_at: "2023-03-09 03:31:25.726063"
latest: "0.5.7--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dfast_qc:0.5.7--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dfast_qc/0.5.7--hdfd78af_0
$ module help quay.io/biocontainers/dfast_qc/0.5.7--hdfd78af_0
```
