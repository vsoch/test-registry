---
layout: container
name:  "quay.io/biocontainers/hecatomb"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:03:02.466991"
...
```bash
$ shpc install quay.io/biocontainers/hecatomb
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hecatomb:1.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hecatomb/1.1.0--hdfd78af_0
$ module help quay.io/biocontainers/hecatomb/1.1.0--hdfd78af_0
```
...
#### hecatomb-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hecatomb-inspect-deffile:
