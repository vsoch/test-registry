---
layout: container
name:  "quay.io/biocontainers/perl-string-escape"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:26:48.139931"
...
```bash
$ shpc install quay.io/biocontainers/perl-string-escape
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-string-escape:2010.002--pl5321hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/perl-string-escape/2010.002--pl5321hdfd78af_1
$ module help quay.io/biocontainers/perl-string-escape/2010.002--pl5321hdfd78af_1
```
...
#### perl-string-escape-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-string-escape-inspect-deffile:
