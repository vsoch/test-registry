...
updated_at: "2023-03-10 03:22:24.355603"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msstatsqcgui:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msstatsqcgui/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msstatsqcgui/1.18.0--r42hdfd78af_0
```
