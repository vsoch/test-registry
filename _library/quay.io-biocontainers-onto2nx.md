---
layout: container
name:  "quay.io/biocontainers/onto2nx"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:08:04.041465"
latest: "0.1.1--py_0"
...
```bash
$ shpc install quay.io/biocontainers/onto2nx
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/onto2nx:0.1.1--py_0
```
...
```bash
$ module load quay.io/biocontainers/onto2nx/0.1.1--py_0
$ module help quay.io/biocontainers/onto2nx/0.1.1--py_0
```
...
#### onto2nx-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### onto2nx-inspect-deffile:
