---
layout: container
name:  "quay.io/biocontainers/flask-bootstrap"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:17:35.828081"
...
```bash
$ shpc install quay.io/biocontainers/flask-bootstrap
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/flask-bootstrap:3.3.5.7--py36_0
```
...
```bash
$ module load quay.io/biocontainers/flask-bootstrap/3.3.5.7--py36_0
$ module help quay.io/biocontainers/flask-bootstrap/3.3.5.7--py36_0
```
...
#### flask-bootstrap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### flask-bootstrap-inspect-deffile:
