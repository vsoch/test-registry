---
layout: container
name:  "quay.io/biocontainers/biomaj"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:03:06.573142"
...
```bash
$ shpc install quay.io/biocontainers/biomaj
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/biomaj:3.0.19--py35_0
```
...
```bash
$ module load quay.io/biocontainers/biomaj/3.0.19--py35_0
$ module help quay.io/biocontainers/biomaj/3.0.19--py35_0
```
...
#### biomaj-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### biomaj-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/biomaj-cli.py
$ podman run --it --rm --entrypoint /usr/local/bin/biomaj-cli.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/biomaj-cli.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
