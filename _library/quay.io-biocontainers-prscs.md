---
layout: container
name:  "quay.io/biocontainers/prscs"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:39:30.569895"
...
```bash
$ shpc install quay.io/biocontainers/prscs
```
...
#### prscs-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### prscs-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/PRScs.py
$ podman run --it --rm --entrypoint /usr/local/bin/PRScs.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/PRScs.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gigrnd.py
$ podman run --it --rm --entrypoint /usr/local/bin/gigrnd.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gigrnd.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mcmc_gtb.py
$ podman run --it --rm --entrypoint /usr/local/bin/mcmc_gtb.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mcmc_gtb.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/parse_genet.py
$ podman run --it --rm --entrypoint /usr/local/bin/parse_genet.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/parse_genet.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
