---
layout: container
name:  "quay.io/biocontainers/bioconductor-cogeqc"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:41:37.695301"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cogeqc
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-cogeqc:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cogeqc/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cogeqc/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-cogeqc-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cogeqc-inspect-deffile:
