---
layout: container
name:  "quay.io/biocontainers/pyasp"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:06:10.506267"
latest: "1.4.3--py35_1"
...
```bash
$ shpc install quay.io/biocontainers/pyasp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyasp:1.4.3--py35_1
```
...
```bash
$ module load quay.io/biocontainers/pyasp/1.4.3--py35_1
$ module help quay.io/biocontainers/pyasp/1.4.3--py35_1
```
...
#### pyasp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyasp-inspect-deffile:
