---
layout: container
name:  "quay.io/biocontainers/bioconductor-consica"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:19:09.409221"
...
versions:
 - "1.0.0--r42hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-consica"
config: {"url": "https://biocontainers.pro/tools/bioconductor-consica", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-consica", "latest": {"1.0.0--r42hdfd78af_0": "sha256:af54f4dfdbd0d05d6be7d0f0b41d55a514db3c3d8b085c5f195873c7720c58bc"}, "tags": {"1.0.0--r42hdfd78af_0": "sha256:af54f4dfdbd0d05d6be7d0f0b41d55a514db3c3d8b085c5f195873c7720c58bc"}, "docker": "quay.io/biocontainers/bioconductor-consica", "aliases": {"installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-consica.
singularity registry hpc automated addition for bioconductor-consica
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-consica
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-consica:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-consica/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-consica/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-consica-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-consica-inspect-deffile:
