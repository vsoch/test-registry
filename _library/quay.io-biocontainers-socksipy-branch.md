---
layout: container
name:  "quay.io/biocontainers/socksipy-branch"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:30:56.380916"
latest: "1.01--py_1"
...
```bash
$ shpc install quay.io/biocontainers/socksipy-branch
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/socksipy-branch:1.01--py_1
```
...
```bash
$ module load quay.io/biocontainers/socksipy-branch/1.01--py_1
$ module help quay.io/biocontainers/socksipy-branch/1.01--py_1
```
...
#### socksipy-branch-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### socksipy-branch-inspect-deffile:
