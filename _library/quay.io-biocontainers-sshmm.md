---
layout: container
name:  "quay.io/biocontainers/sshmm"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:00:27.170700"
...
```bash
$ shpc install quay.io/biocontainers/sshmm
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/sshmm:1.0.7--py27he4fc25b_4
```
...
```bash
$ module load quay.io/biocontainers/sshmm/1.0.7--py27he4fc25b_4
$ module help quay.io/biocontainers/sshmm/1.0.7--py27he4fc25b_4
```
...
#### sshmm-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### sshmm-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/batch_seqstructhmm
$ podman run --it --rm --entrypoint /usr/local/bin/batch_seqstructhmm   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/batch_seqstructhmm   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/draw_model_graph
$ podman run --it --rm --entrypoint /usr/local/bin/draw_model_graph   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/draw_model_graph   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/train_seqstructhmm
$ podman run --it --rm --entrypoint /usr/local/bin/train_seqstructhmm   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/train_seqstructhmm   -v ${PWD} -w ${PWD} <container> -c " $@"
```
