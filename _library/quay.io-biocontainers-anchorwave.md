...
updated_at: "2023-03-09 03:02:42.587158"
...
```bash
$ shpc install quay.io/biocontainers/anchorwave:1.1.1--hd03093a_0
```
...
```bash
$ module load quay.io/biocontainers/anchorwave/1.1.1--hd03093a_0
$ module help quay.io/biocontainers/anchorwave/1.1.1--hd03093a_0
```
