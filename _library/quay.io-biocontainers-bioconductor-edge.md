...
updated_at: "2023-03-10 03:26:36.037980"
latest: "2.30.0--r42hc0cfd56_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-edge:2.30.0--r42hc0cfd56_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-edge/2.30.0--r42hc0cfd56_0
$ module help quay.io/biocontainers/bioconductor-edge/2.30.0--r42hc0cfd56_0
```
