---
layout: container
name:  "quay.io/biocontainers/bioconductor-sdams"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:29:41.995556"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sdams
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-sdams:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sdams/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sdams/1.18.0--r42hdfd78af_0
```
...
#### bioconductor-sdams-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-sdams-inspect-deffile:
