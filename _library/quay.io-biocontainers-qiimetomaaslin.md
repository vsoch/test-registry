---
layout: container
name:  "quay.io/biocontainers/qiimetomaaslin"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:57:09.926504"
latest: "1.1.0--py27_1"
...
```bash
$ shpc install quay.io/biocontainers/qiimetomaaslin
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/qiimetomaaslin:1.1.0--py27_1
```
...
```bash
$ module load quay.io/biocontainers/qiimetomaaslin/1.1.0--py27_1
$ module help quay.io/biocontainers/qiimetomaaslin/1.1.0--py27_1
```
...
#### qiimetomaaslin-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### qiimetomaaslin-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/qiimeToMaaslin.py
$ podman run --it --rm --entrypoint /usr/local/bin/qiimeToMaaslin.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/qiimeToMaaslin.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
