---
layout: container
name:  "quay.io/biocontainers/svjedi"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:16:40.921983"
...
```bash
$ shpc install quay.io/biocontainers/svjedi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/svjedi:1.1.6--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/svjedi/1.1.6--hdfd78af_1
$ module help quay.io/biocontainers/svjedi/1.1.6--hdfd78af_1
```
...
#### svjedi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### svjedi-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/svjedi.py
$ podman run --it --rm --entrypoint /usr/local/bin/svjedi.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/svjedi.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
