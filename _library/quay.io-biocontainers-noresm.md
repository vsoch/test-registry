---
layout: container
name:  "quay.io/biocontainers/noresm"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:17:54.155449"
...
```bash
$ shpc install quay.io/biocontainers/noresm
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/noresm:2.0.2--py38pl5321hbcac906_1
```
...
```bash
$ module load quay.io/biocontainers/noresm/2.0.2--py38pl5321hbcac906_1
$ module help quay.io/biocontainers/noresm/2.0.2--py38pl5321hbcac906_1
```
...
#### noresm-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### noresm-inspect-deffile:
