---
layout: container
name:  "quay.io/biocontainers/r-fda"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:15:08.526593"
...
```bash
$ shpc install quay.io/biocontainers/r-fda
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-fda:2.4.4--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-fda/2.4.4--r3.2.2_0
$ module help quay.io/biocontainers/r-fda/2.4.4--r3.2.2_0
```
...
#### r-fda-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-fda-inspect-deffile:
