---
layout: container
name:  "quay.io/biocontainers/bioconductor-gosorensen"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:58:01.856883"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gosorensen
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-gosorensen:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gosorensen/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gosorensen/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-gosorensen-inspect:
...
#### bioconductor-gosorensen-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-gosorensen-inspect-deffile:
