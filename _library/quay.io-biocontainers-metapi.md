---
layout: container
name:  "quay.io/biocontainers/metapi"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:33:37.583440"
...
```bash
$ shpc install quay.io/biocontainers/metapi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/metapi:2.4.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metapi/2.4.0--pyhdfd78af_0
$ module help quay.io/biocontainers/metapi/2.4.0--pyhdfd78af_0
```
...
#### metapi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### metapi-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/fd
$ podman run --it --rm --entrypoint /usr/local/bin/fd   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fd   -v ${PWD} -w ${PWD} <container> -c " $@"
```
