---
layout: container
name:  "quay.io/biocontainers/pyx"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:28:06.951936"
...
```bash
$ shpc install quay.io/biocontainers/pyx
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyx:0.14.1--py36_1
```
...
```bash
$ module load quay.io/biocontainers/pyx/0.14.1--py36_1
$ module help quay.io/biocontainers/pyx/0.14.1--py36_1
```
