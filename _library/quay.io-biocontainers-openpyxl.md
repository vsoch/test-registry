---
layout: container
name:  "quay.io/biocontainers/openpyxl"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:23:03.159887"
latest: "2.4.0--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/openpyxl
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/openpyxl:2.4.0--py35_0
```
...
```bash
$ module load quay.io/biocontainers/openpyxl/2.4.0--py35_0
$ module help quay.io/biocontainers/openpyxl/2.4.0--py35_0
```
...
#### openpyxl-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### openpyxl-inspect-deffile:
