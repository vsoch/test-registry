...
updated_at: "2023-03-10 03:35:07.404345"
latest: "0.24.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bismark:0.24.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bismark/0.24.0--hdfd78af_0
$ module help quay.io/biocontainers/bismark/0.24.0--hdfd78af_0
```
