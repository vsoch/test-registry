...
updated_at: "2023-03-10 03:18:21.557562"
latest: "0.0.1--hec16e2b_2"
...
```bash
$ shpc install quay.io/biocontainers/pb-dazzler:0.0.1--hec16e2b_2
```
...
```bash
$ module load quay.io/biocontainers/pb-dazzler/0.0.1--hec16e2b_2
$ module help quay.io/biocontainers/pb-dazzler/0.0.1--hec16e2b_2
```
