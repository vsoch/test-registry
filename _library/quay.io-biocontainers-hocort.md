---
layout: container
name:  "quay.io/biocontainers/hocort"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:27:33.589928"
latest: "1.1.0--py39hdfd78af_0"
...
aliases:
 ...
 - "comparegff.sh"
versions:
 - "1.1.0--py39hdfd78af_0"
description: "singularity registry hpc automated addition for hocort"
config: {"url": "https://biocontainers.pro/tools/hocort", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for hocort", "latest": {"1.1.0--py39hdfd78af_0": "sha256:03bed85cc404179c27797043cba5fbf6efb5cb198a64b31f4ebea78211dff489"}, "tags": {"1.1.0--py39hdfd78af_0": "sha256:03bed85cc404179c27797043cba5fbf6efb5cb198a64b31f4ebea78211dff489"}, "docker": "quay.io/biocontainers/hocort", "aliases": {"Xcalcmem.sh": "/usr/local/bin/Xcalcmem.sh", "bloomfilterparser.sh": "/usr/local/bin/bloomfilterparser.sh", "bwa-mem2": "/usr/local/bin/bwa-mem2", "bwa-mem2.avx": "/usr/local/bin/bwa-mem2.avx", "bwa-mem2.avx2": "/usr/local/bin/bwa-mem2.avx2", "bwa-mem2.avx512bw": "/usr/local/bin/bwa-mem2.avx512bw", "bwa-mem2.sse41": "/usr/local/bin/bwa-mem2.sse41", "bwa-mem2.sse42": "/usr/local/bin/bwa-mem2.sse42", "extract_exons.py": "/usr/local/bin/extract_exons.py", "extract_splice_sites.py": "/usr/local/bin/extract_splice_sites.py", "hisat2": "/usr/local/bin/hisat2", "hisat2-align-l": "/usr/local/bin/hisat2-align-l", "hisat2-align-s": "/usr/local/bin/hisat2-align-s", "hisat2-build": "/usr/local/bin/hisat2-build", "hisat2-build-l": "/usr/local/bin/hisat2-build-l", "hisat2-build-s": "/usr/local/bin/hisat2-build-s", "hisat2-inspect": "/usr/local/bin/hisat2-inspect", "hisat2-inspect-l": "/usr/local/bin/hisat2-inspect-l", "hisat2-inspect-s": "/usr/local/bin/hisat2-inspect-s", "hisat2_extract_exons.py": "/usr/local/bin/hisat2_extract_exons.py", "hisat2_extract_snps_haplotypes_UCSC.py": "/usr/local/bin/hisat2_extract_snps_haplotypes_UCSC.py", "hisat2_extract_snps_haplotypes_VCF.py": "/usr/local/bin/hisat2_extract_snps_haplotypes_VCF.py", "hisat2_extract_splice_sites.py": "/usr/local/bin/hisat2_extract_splice_sites.py", "hisat2_read_statistics.py": "/usr/local/bin/hisat2_read_statistics.py", "hisat2_simulate_reads.py": "/usr/local/bin/hisat2_simulate_reads.py", "hocort": "/usr/local/bin/hocort", "kraken2": "/usr/local/bin/kraken2", "kraken2-build": "/usr/local/bin/kraken2-build", "kraken2-inspect": "/usr/local/bin/kraken2-inspect", "kmutate.sh": "/usr/local/bin/kmutate.sh", "rsync-ssl": "/usr/local/bin/rsync-ssl", "runhmm.sh": "/usr/local/bin/runhmm.sh", "kmerposition.sh": "/usr/local/bin/kmerposition.sh", "reformatpb.sh": "/usr/local/bin/reformatpb.sh", "rsync": "/usr/local/bin/rsync", "summarizecoverage.sh": "/usr/local/bin/summarizecoverage.sh", "alltoall.sh": "/usr/local/bin/alltoall.sh", "analyzesketchresults.sh": "/usr/local/bin/analyzesketchresults.sh", "comparessu.sh": "/usr/local/bin/comparessu.sh", "filtersilva.sh": "/usr/local/bin/filtersilva.sh", "sketchblacklist2.sh": "/usr/local/bin/sketchblacklist2.sh", "splitribo.sh": "/usr/local/bin/splitribo.sh", "xxh128sum": "/usr/local/bin/xxh128sum", "xxh32sum": "/usr/local/bin/xxh32sum", "xxh64sum": "/usr/local/bin/xxh64sum", "addssu.sh": "/usr/local/bin/addssu.sh", "adjusthomopolymers.sh": "/usr/local/bin/adjusthomopolymers.sh", "analyzeaccession.sh": "/usr/local/bin/analyzeaccession.sh", "analyzegenes.sh": "/usr/local/bin/analyzegenes.sh", "applyvariants.sh": "/usr/local/bin/applyvariants.sh", "bbcms.sh": "/usr/local/bin/bbcms.sh", "bloomfilter.sh": "/usr/local/bin/bloomfilter.sh", "callgenes.sh": "/usr/local/bin/callgenes.sh", "comparegff.sh": "/usr/local/bin/comparegff.sh"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/hocort.
singularity registry hpc automated addition for hocort
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/hocort
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hocort:1.1.0--py39hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hocort/1.1.0--py39hdfd78af_0
$ module help quay.io/biocontainers/hocort/1.1.0--py39hdfd78af_0
```
...
#### hocort-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hocort-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/hocort
$ podman run --it --rm --entrypoint /usr/local/bin/hocort   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/hocort   -v ${PWD} -w ${PWD} <container> -c " $@"
```
