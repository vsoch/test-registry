---
layout: container
name:  "quay.io/biocontainers/mglex"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:31:10.432215"
latest: "0.2.1--py_0"
...
```bash
$ shpc install quay.io/biocontainers/mglex
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mglex:0.2.1--py_0
```
...
```bash
$ module load quay.io/biocontainers/mglex/0.2.1--py_0
$ module help quay.io/biocontainers/mglex/0.2.1--py_0
```
...
#### mglex-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mglex-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mglex-cli
$ podman run --it --rm --entrypoint /usr/local/bin/mglex-cli   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mglex-cli   -v ${PWD} -w ${PWD} <container> -c " $@"
```
