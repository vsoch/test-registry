...
updated_at: "2023-03-10 03:07:09.959543"
latest: "16.2--he881be0_1"
...
```bash
$ shpc install quay.io/biocontainers/entrez-direct:16.2--he881be0_1
```
...
```bash
$ module load quay.io/biocontainers/entrez-direct/16.2--he881be0_1
$ module help quay.io/biocontainers/entrez-direct/16.2--he881be0_1
```
