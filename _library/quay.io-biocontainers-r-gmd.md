---
layout: container
name:  "quay.io/biocontainers/r-gmd"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:28:48.616397"
...
```bash
$ shpc install quay.io/biocontainers/r-gmd
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-gmd:0.3.3--r3.3.1_1
```
...
```bash
$ module load quay.io/biocontainers/r-gmd/0.3.3--r3.3.1_1
$ module help quay.io/biocontainers/r-gmd/0.3.3--r3.3.1_1
```
...
#### r-gmd-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-gmd-inspect-deffile:
