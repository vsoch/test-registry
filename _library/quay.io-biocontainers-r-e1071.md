---
layout: container
name:  "quay.io/biocontainers/r-e1071"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:32:02.534827"
...
```bash
$ shpc install quay.io/biocontainers/r-e1071
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-e1071:1.6_8--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-e1071/1.6_8--r3.3.2_0
$ module help quay.io/biocontainers/r-e1071/1.6_8--r3.3.2_0
```
...
#### r-e1071-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-e1071-inspect-deffile:
