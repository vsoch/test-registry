---
layout: container
name:  "quay.io/biocontainers/r-trimcluster"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:22:35.273769"
...
```bash
$ shpc install quay.io/biocontainers/r-trimcluster
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-trimcluster:0.1_2--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-trimcluster/0.1_2--r3.3.2_0
$ module help quay.io/biocontainers/r-trimcluster/0.1_2--r3.3.2_0
```
...
#### r-trimcluster-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-trimcluster-inspect-deffile:
