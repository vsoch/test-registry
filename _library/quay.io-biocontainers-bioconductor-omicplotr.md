---
layout: container
name:  "quay.io/biocontainers/bioconductor-omicplotr"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:42:22.267407"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-omicplotr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-omicplotr:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-omicplotr/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-omicplotr/1.18.0--r42hdfd78af_0
```
...
#### bioconductor-omicplotr-inspect:
...
#### bioconductor-omicplotr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-omicplotr-inspect-deffile:
