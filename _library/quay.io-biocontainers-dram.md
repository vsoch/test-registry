...
updated_at: "2023-03-10 03:16:46.054970"
...
```bash
$ shpc install quay.io/biocontainers/dram:1.4.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dram/1.4.6--pyhdfd78af_0
$ module help quay.io/biocontainers/dram/1.4.6--pyhdfd78af_0
```
