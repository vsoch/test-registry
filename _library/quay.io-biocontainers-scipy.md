---
layout: container
name:  "quay.io/biocontainers/scipy"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:07:26.162916"
latest: "1.1.0"
...
```bash
$ shpc install quay.io/biocontainers/scipy
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/scipy:1.1.0
```
...
```bash
$ module load quay.io/biocontainers/scipy/1.1.0
$ module help quay.io/biocontainers/scipy/1.1.0
```
...
#### scipy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### scipy-inspect-deffile:
