---
layout: container
name:  "quay.io/biocontainers/shellescape"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:58:01.240219"
latest: "3.4.1--py_1"
...
```bash
$ shpc install quay.io/biocontainers/shellescape
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/shellescape:3.4.1--py_1
```
...
```bash
$ module load quay.io/biocontainers/shellescape/3.4.1--py_1
$ module help quay.io/biocontainers/shellescape/3.4.1--py_1
```
...
#### shellescape-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### shellescape-inspect-deffile:
