...
updated_at: "2023-03-10 03:01:46.440382"
latest: "1.0.14--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/dragonflye:1.0.14--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dragonflye/1.0.14--hdfd78af_0
$ module help quay.io/biocontainers/dragonflye/1.0.14--hdfd78af_0
```
