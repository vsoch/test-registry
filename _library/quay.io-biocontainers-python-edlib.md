...
updated_at: "2023-03-09 03:12:29.800417"
...
```bash
$ shpc install quay.io/biocontainers/python-edlib:1.3.9--py27he8a552f_0
```
...
```bash
$ module load quay.io/biocontainers/python-edlib/1.3.9--py27he8a552f_0
$ module help quay.io/biocontainers/python-edlib/1.3.9--py27he8a552f_0
```
