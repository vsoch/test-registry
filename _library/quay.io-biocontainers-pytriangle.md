---
layout: container
name:  "quay.io/biocontainers/pytriangle"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:33:24.793562"
latest: "1.0.9--py27h9801fc8_6"
...
```bash
$ shpc install quay.io/biocontainers/pytriangle
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pytriangle:1.0.9--py27h9801fc8_6
```
...
```bash
$ module load quay.io/biocontainers/pytriangle/1.0.9--py27h9801fc8_6
$ module help quay.io/biocontainers/pytriangle/1.0.9--py27h9801fc8_6
```
...
#### pytriangle-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pytriangle-inspect-deffile:
