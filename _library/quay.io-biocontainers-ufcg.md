---
layout: container
name:  "quay.io/biocontainers/ufcg"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:29:53.710409"
latest: "1.0.3c--hdfd78af_0"
...
```bash
$ module load quay.io/biocontainers/ufcg/1.0.3c--hdfd78af_0
$ module help quay.io/biocontainers/ufcg/1.0.3c--hdfd78af_0
```
...
#### ufcg-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ufcg-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ufcg
$ podman run --it --rm --entrypoint /usr/local/bin/ufcg   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ufcg   -v ${PWD} -w ${PWD} <container> -c " $@"
```
