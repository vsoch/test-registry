---
layout: container
name:  "quay.io/biocontainers/sprinkles"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:16:04.225131"
latest: "0.4.6--py35_1"
...
```bash
$ shpc install quay.io/biocontainers/sprinkles
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/sprinkles:0.4.6--py35_1
```
...
```bash
$ module load quay.io/biocontainers/sprinkles/0.4.6--py35_1
$ module help quay.io/biocontainers/sprinkles/0.4.6--py35_1
```
...
#### sprinkles-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### sprinkles-inspect-deffile:
