---
layout: container
name:  "quay.io/biocontainers/r-prroc"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:17:24.253360"
latest: "1.1--r3.3.1_0"
...
```bash
$ shpc install quay.io/biocontainers/r-prroc
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-prroc:1.1--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-prroc/1.1--r3.3.1_0
$ module help quay.io/biocontainers/r-prroc/1.1--r3.3.1_0
```
...
#### r-prroc-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-prroc-inspect-deffile:
