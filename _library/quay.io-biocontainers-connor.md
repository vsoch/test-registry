---
layout: container
name:  "quay.io/biocontainers/connor"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:32:54.582733"
latest: "0.6--py27_2"
...
```bash
$ shpc install quay.io/biocontainers/connor
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/connor:0.6--py27_2
```
...
```bash
$ module load quay.io/biocontainers/connor/0.6--py27_2
$ module help quay.io/biocontainers/connor/0.6--py27_2
```
...
#### connor-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### connor-inspect-deffile:
