---
layout: container
name:  "quay.io/biocontainers/dropbox"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:10:28.977825"
latest: "5.2.1--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/dropbox
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/dropbox:5.2.1--py36_0
```
...
```bash
$ module load quay.io/biocontainers/dropbox/5.2.1--py36_0
$ module help quay.io/biocontainers/dropbox/5.2.1--py36_0
```
...
#### dropbox-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### dropbox-inspect-deffile:
