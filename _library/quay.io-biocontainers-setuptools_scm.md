---
layout: container
name:  "quay.io/biocontainers/setuptools_scm"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:21:58.781307"
...
versions:
 - "1.11.1--py35_0"
description: "shpc-registry automated BioContainers addition for setuptools_scm"
config: {"url": "https://biocontainers.pro/tools/setuptools_scm", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for setuptools_scm", "latest": {"1.11.1--py35_0": "sha256:46296eb02f36244facd35428ba7fd6540ebd2398074628f855ebe8cd24144183"}, "tags": {"1.11.1--py35_0": "sha256:46296eb02f36244facd35428ba7fd6540ebd2398074628f855ebe8cd24144183"}, "docker": "quay.io/biocontainers/setuptools_scm", "aliases": {"easy_install-3.5": "/usr/local/bin/easy_install-3.5", "2to3-3.5": "/usr/local/bin/2to3-3.5", "idle3.5": "/usr/local/bin/idle3.5", "pydoc3.5": "/usr/local/bin/pydoc3.5", "python3.5": "/usr/local/bin/python3.5", "python3.5-config": "/usr/local/bin/python3.5-config", "python3.5m": "/usr/local/bin/python3.5m", "python3.5m-config": "/usr/local/bin/python3.5m-config", "pyvenv-3.5": "/usr/local/bin/pyvenv-3.5", "tclsh8.5": "/usr/local/bin/tclsh8.5"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/setuptools_scm.
shpc-registry automated BioContainers addition for setuptools_scm
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/setuptools_scm
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/setuptools_scm:1.11.1--py35_0
```
...
```bash
$ module load quay.io/biocontainers/setuptools_scm/1.11.1--py35_0
$ module help quay.io/biocontainers/setuptools_scm/1.11.1--py35_0
```
...
#### setuptools_scm-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### setuptools_scm-inspect-deffile:
