...
updated_at: "2023-03-09 02:56:36.304592"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-differentialregulation:1.2.0--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-differentialregulation/1.2.0--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-differentialregulation/1.2.0--r42hc247a5b_0
```
