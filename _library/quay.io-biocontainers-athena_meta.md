...
updated_at: "2023-03-09 03:25:46.361218"
latest: "1.3--py_1"
...
```bash
$ module load quay.io/biocontainers/athena_meta/1.3--py_1
$ module help quay.io/biocontainers/athena_meta/1.3--py_1
```
...
#### athena_meta-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### athena_meta-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/athena-meta
$ podman run --it --rm --entrypoint /usr/local/bin/athena-meta   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/athena-meta   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/flye-assemble
$ podman run --it --rm --entrypoint /usr/local/bin/flye-assemble   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flye-assemble   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/flye-polish
$ podman run --it --rm --entrypoint /usr/local/bin/flye-polish   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flye-polish   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/flye-repeat
$ podman run --it --rm --entrypoint /usr/local/bin/flye-repeat   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/flye-repeat   -v ${PWD} -w ${PWD} <container> -c " $@"
```
