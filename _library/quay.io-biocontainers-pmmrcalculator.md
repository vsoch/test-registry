---
layout: container
name:  "quay.io/biocontainers/pmmrcalculator"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:23:47.166443"
...
```bash
$ shpc install quay.io/biocontainers/pmmrcalculator
```
...
#### pmmrcalculator-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pmmrcalculator-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pmmrcalculator
$ podman run --it --rm --entrypoint /usr/local/bin/pmmrcalculator   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pmmrcalculator   -v ${PWD} -w ${PWD} <container> -c " $@"
```
