---
layout: container
name:  "quay.io/biocontainers/req"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:39:09.346137"
...
```bash
$ shpc install quay.io/biocontainers/req
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/req:v1.3.190304ac--1
```
...
```bash
$ module load quay.io/biocontainers/req/v1.3.190304ac--1
$ module help quay.io/biocontainers/req/v1.3.190304ac--1
```
