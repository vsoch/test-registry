---
layout: container
name:  "quay.io/biocontainers/r-noisyr"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:08:37.416036"
...
```bash
$ shpc install quay.io/biocontainers/r-noisyr
```
...
#### r-noisyr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-noisyr-inspect-deffile:
