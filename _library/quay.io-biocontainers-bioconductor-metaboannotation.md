...
updated_at: "2023-03-09 03:34:57.618622"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metaboannotation:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metaboannotation/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metaboannotation/1.2.0--r42hdfd78af_0
```
