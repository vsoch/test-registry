...
updated_at: "2023-03-10 03:40:09.176257"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gdsarray:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gdsarray/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gdsarray/1.18.0--r42hdfd78af_0
```
