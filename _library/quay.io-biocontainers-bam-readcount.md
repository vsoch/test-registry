...
updated_at: "2023-03-09 03:32:21.277344"
...
```bash
$ shpc install quay.io/biocontainers/bam-readcount
```
...
#### bam-readcount-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bam-readcount-inspect-deffile:
