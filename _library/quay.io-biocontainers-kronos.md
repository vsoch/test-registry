---
layout: container
name:  "quay.io/biocontainers/kronos"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:25:48.743244"
latest: "2.3.0--py_1"
...
```bash
$ shpc install quay.io/biocontainers/kronos
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/kronos:2.3.0--py_1
```
...
```bash
$ module load quay.io/biocontainers/kronos/2.3.0--py_1
$ module help quay.io/biocontainers/kronos/2.3.0--py_1
```
...
#### kronos-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### kronos-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/kronos
$ podman run --it --rm --entrypoint /usr/local/bin/kronos   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kronos   -v ${PWD} -w ${PWD} <container> -c " $@"
```
