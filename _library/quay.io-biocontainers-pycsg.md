---
layout: container
name:  "quay.io/biocontainers/pycsg"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:13:18.168753"
latest: "0.3.12--py_1"
...
```bash
$ shpc install quay.io/biocontainers/pycsg
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pycsg:0.3.12--py_1
```
...
```bash
$ module load quay.io/biocontainers/pycsg/0.3.12--py_1
$ module help quay.io/biocontainers/pycsg/0.3.12--py_1
```
...
#### pycsg-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pycsg-inspect-deffile:
