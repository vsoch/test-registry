---
layout: container
name:  "quay.io/biocontainers/tablet"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:32:48.894168"
latest: "1.17.08.17--1"
...
```bash
$ shpc install quay.io/biocontainers/tablet
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/tablet:1.17.08.17--1
```
...
```bash
$ module load quay.io/biocontainers/tablet/1.17.08.17--1
$ module help quay.io/biocontainers/tablet/1.17.08.17--1
```
...
#### tablet-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### tablet-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/tablet
$ podman run --it --rm --entrypoint /usr/local/bin/tablet   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/tablet   -v ${PWD} -w ${PWD} <container> -c " $@"
```
