---
layout: container
name:  "quay.io/biocontainers/perl-try-tiny-retry"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:34:40.702147"
...
```bash
$ shpc install quay.io/biocontainers/perl-try-tiny-retry
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-try-tiny-retry:0.004--pl5321hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/perl-try-tiny-retry/0.004--pl5321hdfd78af_1
$ module help quay.io/biocontainers/perl-try-tiny-retry/0.004--pl5321hdfd78af_1
```
...
#### perl-try-tiny-retry-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-try-tiny-retry-inspect-deffile:
