...
updated_at: "2023-03-09 02:57:35.694819"
latest: "0.1.35--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/easypqp:0.1.35--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/easypqp/0.1.35--pyhdfd78af_0
$ module help quay.io/biocontainers/easypqp/0.1.35--pyhdfd78af_0
```
