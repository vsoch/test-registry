---
layout: container
name:  "quay.io/biocontainers/r-dowser"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:15:15.330782"
...
```bash
$ shpc install quay.io/biocontainers/r-dowser
```
...
#### r-dowser-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-dowser-inspect-deffile:
