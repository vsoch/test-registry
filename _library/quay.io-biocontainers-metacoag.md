...
updated_at: "2023-03-10 03:21:52.423902"
...
```bash
$ shpc install quay.io/biocontainers/metacoag:1.1.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/metacoag/1.1.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/metacoag/1.1.1--pyh7cba7a3_0
```
