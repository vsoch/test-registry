...
updated_at: "2023-03-09 03:18:48.931281"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spatialfeatureexperiment:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatialfeatureexperiment/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatialfeatureexperiment/1.0.0--r42hdfd78af_0
```
