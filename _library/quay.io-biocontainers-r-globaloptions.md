---
layout: container
name:  "quay.io/biocontainers/r-globaloptions"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:28:24.025912"
...
```bash
$ shpc install quay.io/biocontainers/r-globaloptions
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-globaloptions:0.0.8--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-globaloptions/0.0.8--r3.2.2_0
$ module help quay.io/biocontainers/r-globaloptions/0.0.8--r3.2.2_0
```
...
#### r-globaloptions-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-globaloptions-inspect-deffile:
