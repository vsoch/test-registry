---
layout: container
name:  "quay.io/biocontainers/bioconductor-qualifier"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:11:18.603344"
latest: "1.29.1--r36_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qualifier
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-qualifier:1.29.1--r36_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-qualifier/1.29.1--r36_0
$ module help quay.io/biocontainers/bioconductor-qualifier/1.29.1--r36_0
```
...
#### bioconductor-qualifier-inspect:
...
#### bioconductor-qualifier-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-qualifier-inspect-deffile:
