...
updated_at: "2023-03-09 03:24:25.879958"
...
```bash
$ shpc install quay.io/biocontainers/grampa:1.3.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/grampa/1.3.1--pyhdfd78af_0
$ module help quay.io/biocontainers/grampa/1.3.1--pyhdfd78af_0
```
