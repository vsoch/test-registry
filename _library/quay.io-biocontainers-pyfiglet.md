---
layout: container
name:  "quay.io/biocontainers/pyfiglet"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:37:54.022441"
latest: "0.7.5--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/pyfiglet
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyfiglet:0.7.5--py35_0
```
...
```bash
$ module load quay.io/biocontainers/pyfiglet/0.7.5--py35_0
$ module help quay.io/biocontainers/pyfiglet/0.7.5--py35_0
```
...
#### pyfiglet-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyfiglet-inspect-deffile:
