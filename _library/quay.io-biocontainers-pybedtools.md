...
updated_at: "2023-03-10 03:06:11.552742"
...
```bash
$ shpc install quay.io/biocontainers/pybedtools:0.8.2--py36hb377018_1
```
...
```bash
$ module load quay.io/biocontainers/pybedtools/0.8.2--py36hb377018_1
$ module help quay.io/biocontainers/pybedtools/0.8.2--py36hb377018_1
```
