...
updated_at: "2023-03-10 03:38:25.158316"
...
```bash
$ shpc install quay.io/biocontainers/vrhyme:1.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/vrhyme/1.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/vrhyme/1.1.0--pyhdfd78af_0
```
