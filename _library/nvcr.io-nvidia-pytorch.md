...
updated_at: "2023-03-10 02:57:40.362939"
latest: "23.01-py3"
...
```bash
$ shpc install nvcr.io/nvidia/pytorch:23.01-py3
```
...
```bash
$ module load nvcr.io/nvidia/pytorch/23.01-py3
$ module help nvcr.io/nvidia/pytorch/23.01-py3
```
