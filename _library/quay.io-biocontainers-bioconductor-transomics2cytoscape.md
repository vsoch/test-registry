---
layout: container
name:  "quay.io/biocontainers/bioconductor-transomics2cytoscape"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:27:23.890465"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-transomics2cytoscape
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-transomics2cytoscape:1.8.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-transomics2cytoscape/1.8.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-transomics2cytoscape/1.8.0--r42hdfd78af_0
```
...
#### bioconductor-transomics2cytoscape-run:
...
#### bioconductor-transomics2cytoscape-shell:
...
#### bioconductor-transomics2cytoscape-exec:
...
#### bioconductor-transomics2cytoscape-inspect:
...
#### bioconductor-transomics2cytoscape-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-transomics2cytoscape-inspect-deffile:
