---
layout: container
name:  "quay.io/biocontainers/json_collect_data_source"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:38:43.368894"
latest: "1.0.1--2"
...
```bash
$ shpc install quay.io/biocontainers/json_collect_data_source
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/json_collect_data_source:1.0.1--2
```
...
```bash
$ module load quay.io/biocontainers/json_collect_data_source/1.0.1--2
$ module help quay.io/biocontainers/json_collect_data_source/1.0.1--2
```
...
#### json_collect_data_source-shell:
...
#### json_collect_data_source-inspect:
...
#### json_collect_data_source-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### json_collect_data_source-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/json_collect_data_source.py
$ podman run --it --rm --entrypoint /usr/local/bin/json_collect_data_source.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/json_collect_data_source.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
