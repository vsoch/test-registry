...
updated_at: "2023-03-09 03:32:34.925725"
...
```bash
$ shpc install quay.io/biocontainers/compare-reads
```
...
#### compare-reads-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### compare-reads-inspect-deffile:
