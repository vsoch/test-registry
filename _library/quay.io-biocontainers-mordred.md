---
layout: container
name:  "quay.io/biocontainers/mordred"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:07:14.186158"
latest: "1.2.0"
...
```bash
$ shpc install quay.io/biocontainers/mordred
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mordred:1.2.0
```
...
```bash
$ module load quay.io/biocontainers/mordred/1.2.0
$ module help quay.io/biocontainers/mordred/1.2.0
```
...
#### mordred-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mordred-inspect-deffile:
