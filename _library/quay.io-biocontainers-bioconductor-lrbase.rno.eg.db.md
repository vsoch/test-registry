...
updated_at: "2023-03-09 02:58:11.775363"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lrbase.rno.eg.db
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-lrbase.rno.eg.db:2.0.0--r41hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lrbase.rno.eg.db/2.0.0--r41hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lrbase.rno.eg.db/2.0.0--r41hdfd78af_0
```
...
#### bioconductor-lrbase.rno.eg.db-run:
...
#### bioconductor-lrbase.rno.eg.db-shell:
...
#### bioconductor-lrbase.rno.eg.db-exec:
...
#### bioconductor-lrbase.rno.eg.db-inspect:
...
#### bioconductor-lrbase.rno.eg.db-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-lrbase.rno.eg.db-inspect-deffile:
