---
layout: container
name:  "quay.io/biocontainers/cyordereddict"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:13:35.655443"
latest: "0.2.2--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/cyordereddict
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cyordereddict:0.2.2--py35_0
```
...
```bash
$ module load quay.io/biocontainers/cyordereddict/0.2.2--py35_0
$ module help quay.io/biocontainers/cyordereddict/0.2.2--py35_0
```
...
#### cyordereddict-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cyordereddict-inspect-deffile:
