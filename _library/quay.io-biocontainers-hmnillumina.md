...
updated_at: "2023-03-10 03:28:52.258339"
latest: "1.5.0--hd03093a_0"
...
```bash
$ shpc install quay.io/biocontainers/hmnillumina:1.5.0--hd03093a_0
```
...
```bash
$ module load quay.io/biocontainers/hmnillumina/1.5.0--hd03093a_0
$ module help quay.io/biocontainers/hmnillumina/1.5.0--hd03093a_0
```
