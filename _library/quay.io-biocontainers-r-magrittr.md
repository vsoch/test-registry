---
layout: container
name:  "quay.io/biocontainers/r-magrittr"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:22:33.878152"
latest: "1.5--r3.2.2_0"
...
```bash
$ shpc install quay.io/biocontainers/r-magrittr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-magrittr:1.5--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-magrittr/1.5--r3.2.2_0
$ module help quay.io/biocontainers/r-magrittr/1.5--r3.2.2_0
```
...
#### r-magrittr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-magrittr-inspect-deffile:
