---
layout: container
name:  "quay.io/biocontainers/perl-bio-gff3"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:02:31.751904"
...
```bash
$ shpc install quay.io/biocontainers/perl-bio-gff3
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-bio-gff3:2.0--pl5321hdfd78af_5
```
...
```bash
$ module load quay.io/biocontainers/perl-bio-gff3/2.0--pl5321hdfd78af_5
$ module help quay.io/biocontainers/perl-bio-gff3/2.0--pl5321hdfd78af_5
```
...
#### perl-bio-gff3-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-bio-gff3-inspect-deffile:
