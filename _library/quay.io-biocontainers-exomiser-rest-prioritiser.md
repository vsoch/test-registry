...
updated_at: "2023-03-09 03:32:48.276589"
latest: "12.1.0--hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/exomiser-rest-prioritiser:12.1.0--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/exomiser-rest-prioritiser/12.1.0--hdfd78af_2
$ module help quay.io/biocontainers/exomiser-rest-prioritiser/12.1.0--hdfd78af_2
```
