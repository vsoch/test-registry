---
layout: container
name:  "quay.io/biocontainers/meneco"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:12:33.548737"
latest: "1.5.2--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/meneco
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/meneco:1.5.2--py36_0
```
...
```bash
$ module load quay.io/biocontainers/meneco/1.5.2--py36_0
$ module help quay.io/biocontainers/meneco/1.5.2--py36_0
```
...
#### meneco-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### meneco-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/meneco.py
$ podman run --it --rm --entrypoint /usr/local/bin/meneco.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/meneco.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
