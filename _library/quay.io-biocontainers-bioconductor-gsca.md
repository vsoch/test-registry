...
updated_at: "2023-03-10 03:24:47.246551"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gsca:2.28.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gsca/2.28.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gsca/2.28.0--r42hdfd78af_0
```
