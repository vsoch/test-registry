...
updated_at: "2023-03-10 03:40:22.790258"
...
```bash
$ shpc install quay.io/biocontainers/parebrick:0.3.7--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/parebrick/0.3.7--pyhdfd78af_0
$ module help quay.io/biocontainers/parebrick/0.3.7--pyhdfd78af_0
```
