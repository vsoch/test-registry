---
layout: container
name:  "quay.io/biocontainers/markov_clustering"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:05:39.798742"
latest: "0.0.6--py_0"
...
```bash
$ shpc install quay.io/biocontainers/markov_clustering
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/markov_clustering:0.0.6--py_0
```
...
```bash
$ module load quay.io/biocontainers/markov_clustering/0.0.6--py_0
$ module help quay.io/biocontainers/markov_clustering/0.0.6--py_0
```
...
#### markov_clustering-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### markov_clustering-inspect-deffile:
