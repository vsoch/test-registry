---
layout: container
name:  "quay.io/biocontainers/pyqi"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:29:06.896134"
latest: "0.3.2--py27_1"
...
```bash
$ shpc install quay.io/biocontainers/pyqi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyqi:0.3.2--py27_1
```
...
```bash
$ module load quay.io/biocontainers/pyqi/0.3.2--py27_1
$ module help quay.io/biocontainers/pyqi/0.3.2--py27_1
```
...
#### pyqi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyqi-inspect-deffile:
