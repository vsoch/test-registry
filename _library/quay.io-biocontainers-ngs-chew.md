---
layout: container
name:  "quay.io/biocontainers/ngs-chew"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:19:51.010829"
...
```bash
$ shpc install quay.io/biocontainers/ngs-chew
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ngs-chew:0.8.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ngs-chew/0.8.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ngs-chew/0.8.0--pyhdfd78af_0
```
...
#### ngs-chew-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ngs-chew-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ngs-chew
$ podman run --it --rm --entrypoint /usr/local/bin/ngs-chew   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ngs-chew   -v ${PWD} -w ${PWD} <container> -c " $@"
```
