---
layout: container
name:  "quay.io/biocontainers/galaxyxml"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:22:40.418189"
latest: "0.4.14--pyh5e36f6f_0"
...
```bash
$ shpc install quay.io/biocontainers/galaxyxml
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/galaxyxml:0.4.14--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/galaxyxml/0.4.14--pyh5e36f6f_0
$ module help quay.io/biocontainers/galaxyxml/0.4.14--pyh5e36f6f_0
```
...
#### galaxyxml-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### galaxyxml-inspect-deffile:
