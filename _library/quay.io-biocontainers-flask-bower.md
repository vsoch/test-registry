---
layout: container
name:  "quay.io/biocontainers/flask-bower"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:59:02.118762"
latest: "1.3.0--py27_0"
...
```bash
$ shpc install quay.io/biocontainers/flask-bower
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/flask-bower:1.3.0--py27_0
```
...
```bash
$ module load quay.io/biocontainers/flask-bower/1.3.0--py27_0
$ module help quay.io/biocontainers/flask-bower/1.3.0--py27_0
```
...
#### flask-bower-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### flask-bower-inspect-deffile:
