...
updated_at: "2023-03-10 03:07:04.505311"
latest: "1.10.0--pl5321hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-fastx-reader:1.10.0--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-fastx-reader/1.10.0--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-fastx-reader/1.10.0--pl5321hdfd78af_0
```
