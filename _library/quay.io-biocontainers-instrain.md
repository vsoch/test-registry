...
updated_at: "2023-03-09 03:40:05.304536"
...
```bash
$ shpc install quay.io/biocontainers/instrain:1.6.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/instrain/1.6.4--pyhdfd78af_0
$ module help quay.io/biocontainers/instrain/1.6.4--pyhdfd78af_0
```
