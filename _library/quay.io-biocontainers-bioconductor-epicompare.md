---
layout: container
name:  "quay.io/biocontainers/bioconductor-epicompare"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:08:17.802392"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epicompare
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-epicompare:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epicompare/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epicompare/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-epicompare-inspect:
...
#### bioconductor-epicompare-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-epicompare-inspect-deffile:
