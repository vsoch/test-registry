---
layout: container
name:  "quay.io/biocontainers/fastdtw"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:37:55.076437"
latest: "0.2.0--py_1"
...
```bash
$ shpc install quay.io/biocontainers/fastdtw
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/fastdtw:0.2.0--py_1
```
...
```bash
$ module load quay.io/biocontainers/fastdtw/0.2.0--py_1
$ module help quay.io/biocontainers/fastdtw/0.2.0--py_1
```
...
#### fastdtw-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### fastdtw-inspect-deffile:
