---
layout: container
name:  "quay.io/biocontainers/bioconductor-mbecs"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:57:26.695456"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mbecs
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-mbecs:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mbecs/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mbecs/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-mbecs-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-mbecs-inspect-deffile:
