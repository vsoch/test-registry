---
layout: container
name:  "quay.io/biocontainers/cityhash"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:43:11.742963"
...
```bash
$ shpc install quay.io/biocontainers/cityhash
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cityhash:0.2.3.post9--py27_0
```
...
```bash
$ module load quay.io/biocontainers/cityhash/0.2.3.post9--py27_0
$ module help quay.io/biocontainers/cityhash/0.2.3.post9--py27_0
```
...
#### cityhash-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cityhash-inspect-deffile:
