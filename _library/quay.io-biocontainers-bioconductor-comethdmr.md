...
updated_at: "2023-03-10 03:36:40.786112"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-comethdmr:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-comethdmr/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-comethdmr/1.2.0--r42hdfd78af_0
```
