...
updated_at: "2023-03-10 03:19:55.854982"
...
```bash
$ shpc install quay.io/biocontainers/tajimas_d:2.0.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tajimas_d/2.0.0--pyhdfd78af_0
$ module help quay.io/biocontainers/tajimas_d/2.0.0--pyhdfd78af_0
```
