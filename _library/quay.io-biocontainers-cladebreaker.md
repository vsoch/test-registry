---
layout: container
name:  "quay.io/biocontainers/cladebreaker"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:18:35.934315"
...
```bash
$ shpc install quay.io/biocontainers/cladebreaker
```
...
#### cladebreaker-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cladebreaker-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/check_samplesheet.py
$ podman run --it --rm --entrypoint /usr/local/bin/check_samplesheet.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/check_samplesheet.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/cladebreaker
$ podman run --it --rm --entrypoint /usr/local/bin/cladebreaker   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cladebreaker   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/list_fixer.py
$ podman run --it --rm --entrypoint /usr/local/bin/list_fixer.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/list_fixer.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
