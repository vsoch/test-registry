...
updated_at: "2023-03-09 03:33:00.501172"
latest: "1.2.1--py39h9f5acd7_0"
...
```bash
$ shpc install quay.io/biocontainers/tiny-count:1.2.1--py39h9f5acd7_0
```
...
```bash
$ module load quay.io/biocontainers/tiny-count/1.2.1--py39h9f5acd7_0
$ module help quay.io/biocontainers/tiny-count/1.2.1--py39h9f5acd7_0
```
