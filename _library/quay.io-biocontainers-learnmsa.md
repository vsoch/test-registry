...
updated_at: "2023-03-09 03:29:38.242535"
...
```bash
$ shpc install quay.io/biocontainers/learnmsa:1.1.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/learnmsa/1.1.1--pyhdfd78af_0
$ module help quay.io/biocontainers/learnmsa/1.1.1--pyhdfd78af_0
```
