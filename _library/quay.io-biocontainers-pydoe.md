---
layout: container
name:  "quay.io/biocontainers/pydoe"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:27:51.500864"
latest: "0.3.8--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/pydoe
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pydoe:0.3.8--py35_0
```
...
```bash
$ module load quay.io/biocontainers/pydoe/0.3.8--py35_0
$ module help quay.io/biocontainers/pydoe/0.3.8--py35_0
```
...
#### pydoe-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pydoe-inspect-deffile:
