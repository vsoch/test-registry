---
layout: container
name:  "quay.io/biocontainers/bioconductor-missrows"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:39:21.513256"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-missrows
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-missrows:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-missrows/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-missrows/1.18.0--r42hdfd78af_0
```
...
#### bioconductor-missrows-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-missrows-inspect-deffile:
