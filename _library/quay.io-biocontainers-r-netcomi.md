---
layout: container
name:  "quay.io/biocontainers/r-netcomi"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/r-netcomi/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/r-netcomi/container.yaml"
updated_at: "2023-03-10 03:26:28.166003"
latest: "1.1.0--r42hdfd78af_1"
container_url: "https://biocontainers.pro/tools/r-netcomi"
aliases:
 - "2to3-3.11"
 - "idle3.11"
 - "pydoc3.11"
...
versions:
 - "1.1.0--r42hdfd78af_0"
 - "1.1.0--r42hdfd78af_1"
description: "singularity registry hpc automated addition for r-netcomi"
config: {"url": "https://biocontainers.pro/tools/r-netcomi", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for r-netcomi", "latest": {"1.1.0--r42hdfd78af_1": "sha256:bcfc879cc355f2f2247e27fb98226ee2ef6fca7764c5fec3742b0ae9eb472389"}, "tags": {"1.1.0--r42hdfd78af_0": "sha256:273e206a109cbb148ae2ba80bbe8fefe11d6daa1e50387e72457117810885919", "1.1.0--r42hdfd78af_1": "sha256:bcfc879cc355f2f2247e27fb98226ee2ef6fca7764c5fec3742b0ae9eb472389"}, "docker": "quay.io/biocontainers/r-netcomi", "aliases": {"2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "glpsol": "/usr/local/bin/glpsol", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "pandoc": "/usr/local/bin/pandoc", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/r-netcomi.
singularity registry hpc automated addition for r-netcomi
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/r-netcomi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-netcomi:1.1.0--r42hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/r-netcomi/1.1.0--r42hdfd78af_1
$ module help quay.io/biocontainers/r-netcomi/1.1.0--r42hdfd78af_1
```
...
#### r-netcomi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-netcomi-inspect-deffile:
