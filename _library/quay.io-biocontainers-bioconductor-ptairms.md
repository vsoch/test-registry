---
layout: container
name:  "quay.io/biocontainers/bioconductor-ptairms"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:17:35.525908"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ptairms
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ptairms:1.6.0--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ptairms/1.6.0--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-ptairms/1.6.0--r42hc247a5b_0
```
...
#### bioconductor-ptairms-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ptairms-inspect-deffile:
