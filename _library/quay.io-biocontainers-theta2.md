---
layout: container
name:  "quay.io/biocontainers/theta2"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:00:48.384362"
...
```bash
$ shpc install quay.io/biocontainers/theta2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/theta2:0.7--hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/theta2/0.7--hdfd78af_3
$ module help quay.io/biocontainers/theta2/0.7--hdfd78af_3
```
...
#### theta2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### theta2-inspect-deffile:
