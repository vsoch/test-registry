...
updated_at: "2023-03-09 03:14:24.989837"
latest: "0.0.1--py_0"
...
```bash
$ shpc install quay.io/biocontainers/extract_fasta_seq
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/extract_fasta_seq:0.0.1--py_0
```
...
```bash
$ module load quay.io/biocontainers/extract_fasta_seq/0.0.1--py_0
$ module help quay.io/biocontainers/extract_fasta_seq/0.0.1--py_0
```
...
#### extract_fasta_seq-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### extract_fasta_seq-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/extract_fasta_seq
$ podman run --it --rm --entrypoint /usr/local/bin/extract_fasta_seq   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/extract_fasta_seq   -v ${PWD} -w ${PWD} <container> -c " $@"
```
