...
updated_at: "2023-03-09 02:59:06.452182"
latest: "3.2.5.2--h2b233e7_0"
...
```bash
$ shpc install quay.io/biocontainers/regenie:3.2.5.2--h2b233e7_0
```
...
```bash
$ module load quay.io/biocontainers/regenie/3.2.5.2--h2b233e7_0
$ module help quay.io/biocontainers/regenie/3.2.5.2--h2b233e7_0
```
