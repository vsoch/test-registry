...
updated_at: "2023-03-09 03:10:43.977035"
...
```bash
$ shpc install quay.io/biocontainers/bamread:0.0.11--py39hbf8eff0_1
```
...
```bash
$ module load quay.io/biocontainers/bamread/0.0.11--py39hbf8eff0_1
$ module help quay.io/biocontainers/bamread/0.0.11--py39hbf8eff0_1
```
