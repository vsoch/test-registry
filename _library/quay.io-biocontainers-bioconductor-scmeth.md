...
updated_at: "2023-03-09 02:58:16.089592"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scmeth:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scmeth/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-scmeth/1.18.0--r42hdfd78af_0
```
