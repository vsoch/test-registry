...
updated_at: "2023-03-10 03:24:53.926130"
latest: "0.3.0--py39hbf8eff0_0"
...
```bash
$ shpc install quay.io/biocontainers/fastq-filter:0.3.0--py39hbf8eff0_0
```
...
```bash
$ module load quay.io/biocontainers/fastq-filter/0.3.0--py39hbf8eff0_0
$ module help quay.io/biocontainers/fastq-filter/0.3.0--py39hbf8eff0_0
```
