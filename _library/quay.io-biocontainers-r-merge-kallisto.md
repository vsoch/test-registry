...
updated_at: "2023-03-09 03:28:27.415947"
...
```bash
$ shpc install quay.io/biocontainers/r-merge-kallisto:0.6--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/r-merge-kallisto/0.6--hdfd78af_2
$ module help quay.io/biocontainers/r-merge-kallisto/0.6--hdfd78af_2
```
