...
updated_at: "2023-03-10 03:13:49.289618"
...
```bash
$ shpc install quay.io/biocontainers/relion:4.0.1--h70dad7d_0
```
...
```bash
$ module load quay.io/biocontainers/relion/4.0.1--h70dad7d_0
$ module help quay.io/biocontainers/relion/4.0.1--h70dad7d_0
```
