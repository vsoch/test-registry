---
layout: container
name:  "quay.io/biocontainers/bioconductor-healthycontrolspresencechecker"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:26:35.737071"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-healthycontrolspresencechecker
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-healthycontrolspresencechecker:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-healthycontrolspresencechecker/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-healthycontrolspresencechecker/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-healthycontrolspresencechecker-run:
...
#### bioconductor-healthycontrolspresencechecker-shell:
...
#### bioconductor-healthycontrolspresencechecker-exec:
...
#### bioconductor-healthycontrolspresencechecker-inspect:
...
#### bioconductor-healthycontrolspresencechecker-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-healthycontrolspresencechecker-inspect-deffile:
