---
layout: container
name:  "quay.io/biocontainers/music-deconvolution"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:06:05.797374"
latest: "0.1.1--r351_0"
...
```bash
$ shpc install quay.io/biocontainers/music-deconvolution
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/music-deconvolution:0.1.1--r351_0
```
...
```bash
$ module load quay.io/biocontainers/music-deconvolution/0.1.1--r351_0
$ module help quay.io/biocontainers/music-deconvolution/0.1.1--r351_0
```
...
#### music-deconvolution-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### music-deconvolution-inspect-deffile:
