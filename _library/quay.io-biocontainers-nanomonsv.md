...
updated_at: "2023-03-09 03:16:26.237321"
...
```bash
$ shpc install quay.io/biocontainers/nanomonsv:0.5.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanomonsv/0.5.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nanomonsv/0.5.0--pyhdfd78af_0
```
