...
updated_at: "2023-03-09 03:06:16.797177"
...
```bash
$ shpc install quay.io/biocontainers/mimseq:1.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mimseq/1.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/mimseq/1.2.1--pyhdfd78af_0
```
