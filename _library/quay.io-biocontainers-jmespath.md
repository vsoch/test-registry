---
layout: container
name:  "quay.io/biocontainers/jmespath"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:06:28.115279"
latest: "0.9.0--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/jmespath
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/jmespath:0.9.0--py36_0
```
...
```bash
$ module load quay.io/biocontainers/jmespath/0.9.0--py36_0
$ module help quay.io/biocontainers/jmespath/0.9.0--py36_0
```
...
#### jmespath-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### jmespath-inspect-deffile:
