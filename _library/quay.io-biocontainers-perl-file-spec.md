---
layout: container
name:  "quay.io/biocontainers/perl-file-spec"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:11:27.589631"
...
```bash
$ shpc install quay.io/biocontainers/perl-file-spec
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-file-spec:3.48_01--pl526_1
```
...
```bash
$ module load quay.io/biocontainers/perl-file-spec/3.48_01--pl526_1
$ module help quay.io/biocontainers/perl-file-spec/3.48_01--pl526_1
```
...
#### perl-file-spec-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-file-spec-inspect-deffile:
