---
layout: container
name:  "quay.io/biocontainers/r-tinyarray"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:00:27.813056"
latest: "2.2.9--r42h3121a25_0"
...
```bash
$ shpc install quay.io/biocontainers/r-tinyarray
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-tinyarray:2.2.9--r42h3121a25_0
```
...
```bash
$ module load quay.io/biocontainers/r-tinyarray/2.2.9--r42h3121a25_0
$ module help quay.io/biocontainers/r-tinyarray/2.2.9--r42h3121a25_0
```
...
#### r-tinyarray-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-tinyarray-inspect-deffile:
