---
layout: container
name:  "quay.io/biocontainers/perl-test-differences"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:16:33.637213"
latest: "0.67--pl526_0"
...
```bash
$ shpc install quay.io/biocontainers/perl-test-differences
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-test-differences:0.67--pl526_0
```
...
```bash
$ module load quay.io/biocontainers/perl-test-differences/0.67--pl526_0
$ module help quay.io/biocontainers/perl-test-differences/0.67--pl526_0
```
...
#### perl-test-differences-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-test-differences-inspect-deffile:
