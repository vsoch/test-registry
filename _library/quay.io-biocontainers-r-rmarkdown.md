---
layout: container
name:  "quay.io/biocontainers/r-rmarkdown"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:38:59.731395"
latest: "0.9.5--0"
...
```bash
$ shpc install quay.io/biocontainers/r-rmarkdown
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-rmarkdown:0.9.5--0
```
...
```bash
$ module load quay.io/biocontainers/r-rmarkdown/0.9.5--0
$ module help quay.io/biocontainers/r-rmarkdown/0.9.5--0
```
...
#### r-rmarkdown-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-rmarkdown-inspect-deffile:
