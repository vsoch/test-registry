---
layout: container
name:  "quay.io/biocontainers/ezclermont"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:03:06.224864"
...
```bash
$ shpc install quay.io/biocontainers/ezclermont
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ezclermont:0.7.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ezclermont/0.7.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ezclermont/0.7.0--pyhdfd78af_0
```
...
#### ezclermont-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ezclermont-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ezclermont
$ podman run --it --rm --entrypoint /usr/local/bin/ezclermont   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ezclermont   -v ${PWD} -w ${PWD} <container> -c " $@"
```
