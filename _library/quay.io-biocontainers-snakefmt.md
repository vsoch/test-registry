...
updated_at: "2023-03-09 03:36:26.487368"
...
```bash
$ shpc install quay.io/biocontainers/snakefmt:0.8.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/snakefmt/0.8.1--pyhdfd78af_0
$ module help quay.io/biocontainers/snakefmt/0.8.1--pyhdfd78af_0
```
