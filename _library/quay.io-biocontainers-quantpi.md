...
updated_at: "2023-03-10 03:38:47.326633"
latest: "0.2.0--pyh5e36f6f_0"
...
```bash
$ shpc install quay.io/biocontainers/quantpi:0.2.0--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/quantpi/0.2.0--pyh5e36f6f_0
$ module help quay.io/biocontainers/quantpi/0.2.0--pyh5e36f6f_0
```
