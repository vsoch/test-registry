---
layout: container
name:  "quay.io/biocontainers/pyvcf"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:21:41.656607"
...
```bash
$ shpc install quay.io/biocontainers/pyvcf
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyvcf:0.6.8.dev0--py35_0
```
...
```bash
$ module load quay.io/biocontainers/pyvcf/0.6.8.dev0--py35_0
$ module help quay.io/biocontainers/pyvcf/0.6.8.dev0--py35_0
```
...
#### pyvcf-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyvcf-inspect-deffile:
