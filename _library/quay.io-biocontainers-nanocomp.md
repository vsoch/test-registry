...
updated_at: "2023-03-09 03:23:58.256333"
...
```bash
$ shpc install quay.io/biocontainers/nanocomp:1.20.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nanocomp/1.20.0--pyhdfd78af_0
$ module help quay.io/biocontainers/nanocomp/1.20.0--pyhdfd78af_0
```
