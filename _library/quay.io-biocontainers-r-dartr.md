---
layout: container
name:  "quay.io/biocontainers/r-dartr"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:28:45.884324"
latest: "2.0.4--r42h3121a25_1"
...
```bash
$ shpc install quay.io/biocontainers/r-dartr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-dartr:2.0.4--r42h3121a25_1
```
...
```bash
$ module load quay.io/biocontainers/r-dartr/2.0.4--r42h3121a25_1
$ module help quay.io/biocontainers/r-dartr/2.0.4--r42h3121a25_1
```
...
#### r-dartr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-dartr-inspect-deffile:
