---
layout: container
name:  "quay.io/biocontainers/bioconductor-jaspar2022"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:36:06.542148"
latest: "0.99.7--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-jaspar2022
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-jaspar2022:0.99.7--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-jaspar2022/0.99.7--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-jaspar2022/0.99.7--r42hdfd78af_0
```
...
#### bioconductor-jaspar2022-inspect:
...
#### bioconductor-jaspar2022-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-jaspar2022-inspect-deffile:
