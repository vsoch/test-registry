...
updated_at: "2023-03-10 03:22:13.691208"
...
```bash
$ shpc install quay.io/biocontainers/itolapi:4.1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/itolapi/4.1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/itolapi/4.1.0--pyhdfd78af_0
```
