---
layout: container
name:  "quay.io/biocontainers/ashleys-qc"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:09:47.428762"
...
versions:
 - "0.2.1--pyh7cba7a3_0"
description: "singularity registry hpc automated addition for ashleys-qc"
config: {"url": "https://biocontainers.pro/tools/ashleys-qc", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for ashleys-qc", "latest": {"0.2.1--pyh7cba7a3_0": "sha256:8674a372ec9c7a2105e26fb260b8f7ac0b0e31c988bb1c7a47ba983fa34d2b5f"}, "tags": {"0.2.1--pyh7cba7a3_0": "sha256:8674a372ec9c7a2105e26fb260b8f7ac0b0e31c988bb1c7a47ba983fa34d2b5f"}, "docker": "quay.io/biocontainers/ashleys-qc", "aliases": {"ashleys": "/usr/local/bin/ashleys", "py.test": "/usr/local/bin/py.test", "pytest": "/usr/local/bin/pytest", "fonttools": "/usr/local/bin/fonttools", "pyftmerge": "/usr/local/bin/pyftmerge", "pyftsubset": "/usr/local/bin/pyftsubset", "ttx": "/usr/local/bin/ttx", "brotli": "/usr/local/bin/brotli", "f2py3.10": "/usr/local/bin/f2py3.10", "opj_compress": "/usr/local/bin/opj_compress", "opj_decompress": "/usr/local/bin/opj_decompress", "opj_dump": "/usr/local/bin/opj_dump", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1", "jpgicc": "/usr/local/bin/jpgicc", "linkicc": "/usr/local/bin/linkicc", "psicc": "/usr/local/bin/psicc", "tificc": "/usr/local/bin/tificc", "transicc": "/usr/local/bin/transicc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/ashleys-qc.
singularity registry hpc automated addition for ashleys-qc
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/ashleys-qc
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ashleys-qc:0.2.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/ashleys-qc/0.2.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/ashleys-qc/0.2.1--pyh7cba7a3_0
```
...
#### ashleys-qc-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ashleys-qc-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ashleys
$ podman run --it --rm --entrypoint /usr/local/bin/ashleys   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ashleys   -v ${PWD} -w ${PWD} <container> -c " $@"
```
