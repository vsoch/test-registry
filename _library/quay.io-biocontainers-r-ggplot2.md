---
layout: container
name:  "quay.io/biocontainers/r-ggplot2"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:09:30.245448"
...
```bash
$ shpc install quay.io/biocontainers/r-ggplot2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-ggplot2:2.2.1--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-ggplot2/2.2.1--r3.3.1_0
$ module help quay.io/biocontainers/r-ggplot2/2.2.1--r3.3.1_0
```
...
#### r-ggplot2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-ggplot2-inspect-deffile:
