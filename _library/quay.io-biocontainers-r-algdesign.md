---
layout: container
name:  "quay.io/biocontainers/r-algdesign"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:06:20.890279"
...
```bash
$ shpc install quay.io/biocontainers/r-algdesign
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-algdesign:1.1_7.3--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-algdesign/1.1_7.3--r3.3.2_0
$ module help quay.io/biocontainers/r-algdesign/1.1_7.3--r3.3.2_0
```
...
#### r-algdesign-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-algdesign-inspect-deffile:
