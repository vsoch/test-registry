---
layout: container
name:  "quay.io/biocontainers/avro-python3"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:39:27.612231"
latest: "1.9.0--py37_0"
...
```bash
$ shpc install quay.io/biocontainers/avro-python3
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/avro-python3:1.9.0--py37_0
```
...
```bash
$ module load quay.io/biocontainers/avro-python3/1.9.0--py37_0
$ module help quay.io/biocontainers/avro-python3/1.9.0--py37_0
```
...
#### avro-python3-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### avro-python3-inspect-deffile:
