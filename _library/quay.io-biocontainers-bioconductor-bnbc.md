...
updated_at: "2023-03-10 03:33:07.787328"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bnbc:1.20.0--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bnbc/1.20.0--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-bnbc/1.20.0--r42hc247a5b_0
```
