---
layout: container
name:  "quay.io/biocontainers/yanagiba"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 02:59:18.255063"
latest: "1.0.0--py_2"
...
```bash
$ shpc install quay.io/biocontainers/yanagiba
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/yanagiba:1.0.0--py_2
```
...
```bash
$ module load quay.io/biocontainers/yanagiba/1.0.0--py_2
$ module help quay.io/biocontainers/yanagiba/1.0.0--py_2
```
...
#### yanagiba-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### yanagiba-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/yanagiba
$ podman run --it --rm --entrypoint /usr/local/bin/yanagiba   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/yanagiba   -v ${PWD} -w ${PWD} <container> -c " $@"
```
