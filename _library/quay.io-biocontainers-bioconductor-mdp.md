---
layout: container
name:  "quay.io/biocontainers/bioconductor-mdp"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:01:12.104866"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mdp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-mdp:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mdp/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mdp/1.18.0--r42hdfd78af_0
```
...
#### bioconductor-mdp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-mdp-inspect-deffile:
