---
layout: container
name:  "quay.io/biocontainers/shorttracks"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:27:31.727201"
...
```bash
$ shpc install quay.io/biocontainers/shorttracks
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/shorttracks:0.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/shorttracks/0.1--hdfd78af_0
$ module help quay.io/biocontainers/shorttracks/0.1--hdfd78af_0
```
...
#### shorttracks-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### shorttracks-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/ShortTracks
$ podman run --it --rm --entrypoint /usr/local/bin/ShortTracks   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ShortTracks   -v ${PWD} -w ${PWD} <container> -c " $@"
```
