...
updated_at: "2023-03-10 03:18:02.474395"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-drawproteins:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-drawproteins/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-drawproteins/1.18.0--r42hdfd78af_0
```
