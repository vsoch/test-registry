---
layout: container
name:  "quay.io/biocontainers/bioconductor-mudata"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:14:43.348401"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mudata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-mudata:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mudata/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mudata/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-mudata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-mudata-inspect-deffile:
