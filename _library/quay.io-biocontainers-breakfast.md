---
layout: container
name:  "quay.io/biocontainers/breakfast"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:06:19.736838"
...
```bash
$ shpc install quay.io/biocontainers/breakfast
```
...
#### breakfast-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### breakfast-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/breakfast
$ podman run --it --rm --entrypoint /usr/local/bin/breakfast   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/breakfast   -v ${PWD} -w ${PWD} <container> -c " $@"
```
