...
updated_at: "2023-03-10 03:42:34.747101"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sepira:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sepira/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-sepira/1.18.0--r42hdfd78af_0
```
