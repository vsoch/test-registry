---
layout: container
name:  "quay.io/biocontainers/plotly"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:03:11.878064"
latest: "3.1.1"
...
```bash
$ shpc install quay.io/biocontainers/plotly
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/plotly:3.1.1
```
...
```bash
$ module load quay.io/biocontainers/plotly/3.1.1
$ module help quay.io/biocontainers/plotly/3.1.1
```
...
#### plotly-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### plotly-inspect-deffile:
