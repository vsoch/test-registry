---
layout: container
name:  "quay.io/biocontainers/bioconductor-netactivitydata"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:58:13.626005"
...
versions:
 - "1.0.0--r42hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-netactivitydata"
config: {"url": "https://biocontainers.pro/tools/bioconductor-netactivitydata", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-netactivitydata", "latest": {"1.0.0--r42hdfd78af_0": "sha256:86c2bd5f72a876f1ebb6787f00ed779955575a30e98cc608f9ef3f3b90a2eae1"}, "tags": {"1.0.0--r42hdfd78af_0": "sha256:86c2bd5f72a876f1ebb6787f00ed779955575a30e98cc608f9ef3f3b90a2eae1"}, "docker": "quay.io/biocontainers/bioconductor-netactivitydata", "aliases": {"installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-netactivitydata.
singularity registry hpc automated addition for bioconductor-netactivitydata
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-netactivitydata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-netactivitydata:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netactivitydata/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netactivitydata/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-netactivitydata-run:
...
#### bioconductor-netactivitydata-shell:
...
#### bioconductor-netactivitydata-exec:
...
#### bioconductor-netactivitydata-inspect:
...
#### bioconductor-netactivitydata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-netactivitydata-inspect-deffile:
