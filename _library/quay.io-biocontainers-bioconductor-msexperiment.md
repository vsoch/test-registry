---
layout: container
name:  "quay.io/biocontainers/bioconductor-msexperiment"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:17:07.614004"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msexperiment
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-msexperiment:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msexperiment/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msexperiment/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-msexperiment-shell:
...
#### bioconductor-msexperiment-exec:
...
#### bioconductor-msexperiment-inspect:
...
#### bioconductor-msexperiment-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-msexperiment-inspect-deffile:
