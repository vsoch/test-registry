---
layout: container
name:  "quay.io/biocontainers/bioconductor-umi4cats"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:19:19.045911"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-umi4cats
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-umi4cats:1.8.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-umi4cats/1.8.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-umi4cats/1.8.0--r42hdfd78af_0
```
...
#### bioconductor-umi4cats-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-umi4cats-inspect-deffile:
