---
layout: container
name:  "quay.io/biocontainers/biogridpy"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:07:44.454883"
latest: "0.1.1--py_2"
...
```bash
$ shpc install quay.io/biocontainers/biogridpy
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/biogridpy:0.1.1--py_2
```
...
```bash
$ module load quay.io/biocontainers/biogridpy/0.1.1--py_2
$ module help quay.io/biocontainers/biogridpy/0.1.1--py_2
```
...
#### biogridpy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### biogridpy-inspect-deffile:
