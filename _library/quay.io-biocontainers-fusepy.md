---
layout: container
name:  "quay.io/biocontainers/fusepy"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:14:02.953725"
latest: "2.0.4--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/fusepy
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/fusepy:2.0.4--py36_0
```
...
```bash
$ module load quay.io/biocontainers/fusepy/2.0.4--py36_0
$ module help quay.io/biocontainers/fusepy/2.0.4--py36_0
```
...
#### fusepy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### fusepy-inspect-deffile:
