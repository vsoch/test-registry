---
layout: container
name:  "quay.io/biocontainers/mergevcf"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:03:29.523989"
latest: "1.0.1--py_2"
...
```bash
$ shpc install quay.io/biocontainers/mergevcf
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mergevcf:1.0.1--py_2
```
...
```bash
$ module load quay.io/biocontainers/mergevcf/1.0.1--py_2
$ module help quay.io/biocontainers/mergevcf/1.0.1--py_2
```
...
#### mergevcf-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mergevcf-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mergevcf
$ podman run --it --rm --entrypoint /usr/local/bin/mergevcf   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mergevcf   -v ${PWD} -w ${PWD} <container> -c " $@"
```
