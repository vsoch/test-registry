...
updated_at: "2023-03-09 03:29:49.982910"
...
```bash
$ shpc install quay.io/biocontainers/virsorter:2.2.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/virsorter/2.2.4--pyhdfd78af_0
$ module help quay.io/biocontainers/virsorter/2.2.4--pyhdfd78af_0
```
