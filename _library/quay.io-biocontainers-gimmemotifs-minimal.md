---
layout: container
name:  "quay.io/biocontainers/gimmemotifs-minimal"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:28:09.427772"
latest: "0.18.0--py39h67e14b5_0"
...
aliases:
 ...
 - "xxhsum"
versions:
 - "0.18.0--py39h67e14b5_0"
description: "singularity registry hpc automated addition for gimmemotifs-minimal"
config: {"url": "https://biocontainers.pro/tools/gimmemotifs-minimal", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for gimmemotifs-minimal", "latest": {"0.18.0--py39h67e14b5_0": "sha256:5418d19012fdf808921c9ada237a7facbca7a07de7db3f578562fb051f85e97a"}, "tags": {"0.18.0--py39h67e14b5_0": "sha256:5418d19012fdf808921c9ada237a7facbca7a07de7db3f578562fb051f85e97a"}, "docker": "quay.io/biocontainers/gimmemotifs-minimal", "aliases": {"attr": "/usr/local/bin/attr", "balsam": "/usr/local/bin/balsam", "bedToGenePred": "/usr/local/bin/bedToGenePred", "combine_peaks": "/usr/local/bin/combine_peaks", "coverage_table": "/usr/local/bin/coverage_table", "csv-import": "/usr/local/bin/csv-import", "dumpsexp": "/usr/local/bin/dumpsexp", "elasticurl": "/usr/local/bin/elasticurl", "elasticurl_cpp": "/usr/local/bin/elasticurl_cpp", "elastipubsub": "/usr/local/bin/elastipubsub", "fluff": "/usr/local/bin/fluff", "genePredToBed": "/usr/local/bin/genePredToBed", "genePredToGtf": "/usr/local/bin/genePredToGtf", "genomepy": "/usr/local/bin/genomepy", "getfattr": "/usr/local/bin/getfattr", "gff3ToGenePred": "/usr/local/bin/gff3ToGenePred", "gimme": "/usr/local/bin/gimme", "gpg-error": "/usr/local/bin/gpg-error", "gpgrt-config": "/usr/local/bin/gpgrt-config", "gtfToGenePred": "/usr/local/bin/gtfToGenePred", "hmac256": "/usr/local/bin/hmac256", "htseq-count-barcodes": "/usr/local/bin/htseq-count-barcodes", "jackd": "/usr/local/bin/jackd", "lame": "/usr/local/bin/lame", "libgcrypt-config": "/usr/local/bin/libgcrypt-config", "lprodump": "/usr/local/bin/lprodump", "lrelease-pro": "/usr/local/bin/lrelease-pro", "lupdate-pro": "/usr/local/bin/lupdate-pro", "meshdebug": "/usr/local/bin/meshdebug", "mpg123": "/usr/local/bin/mpg123", "mpg123-id3dump": "/usr/local/bin/mpg123-id3dump", "mpg123-strip": "/usr/local/bin/mpg123-strip", "mpicalc": "/usr/local/bin/mpicalc", "orc-bugreport": "/usr/local/bin/orc-bugreport", "orc-memory": "/usr/local/bin/orc-memory", "orc-scan": "/usr/local/bin/orc-scan", "orcc": "/usr/local/bin/orcc", "out123": "/usr/local/bin/out123", "pa-info": "/usr/local/bin/pa-info", "pacat": "/usr/local/bin/pacat", "pacmd": "/usr/local/bin/pacmd", "pactl": "/usr/local/bin/pactl", "padsp": "/usr/local/bin/padsp", "pamon": "/usr/local/bin/pamon", "paplay": "/usr/local/bin/paplay", "parec": "/usr/local/bin/parec", "parecord": "/usr/local/bin/parecord", "pasuspender": "/usr/local/bin/pasuspender", "produce_x_platform_fuzz_corpus": "/usr/local/bin/produce_x_platform_fuzz_corpus", "pulseaudio": "/usr/local/bin/pulseaudio", "qmlformat": "/usr/local/bin/qmlformat", "qmltime": "/usr/local/bin/qmltime", "qmltyperegistrar": "/usr/local/bin/qmltyperegistrar", "qnorm": "/usr/local/bin/qnorm", "qpaeq": "/usr/local/bin/qpaeq", "run_x_platform_fuzz_corpus": "/usr/local/bin/run_x_platform_fuzz_corpus", "setfattr": "/usr/local/bin/setfattr", "sip-build": "/usr/local/bin/sip-build", "sip-distinfo": "/usr/local/bin/sip-distinfo", "sip-install": "/usr/local/bin/sip-install", "sip-module": "/usr/local/bin/sip-module", "sip-sdist": "/usr/local/bin/sip-sdist", "sip-wheel": "/usr/local/bin/sip-wheel", "timezone-dump": "/usr/local/bin/timezone-dump", "tracegen": "/usr/local/bin/tracegen", "yat2m": "/usr/local/bin/yat2m", "flac": "/usr/local/bin/flac", "metaflac": "/usr/local/bin/metaflac", "nosetests-3.9": "/usr/local/bin/nosetests-3.9", "sndfile-cmp": "/usr/local/bin/sndfile-cmp", "sndfile-concat": "/usr/local/bin/sndfile-concat", "sndfile-convert": "/usr/local/bin/sndfile-convert", "sndfile-deinterleave": "/usr/local/bin/sndfile-deinterleave", "sndfile-info": "/usr/local/bin/sndfile-info", "sndfile-interleave": "/usr/local/bin/sndfile-interleave", "sndfile-metadata-get": "/usr/local/bin/sndfile-metadata-get", "sndfile-metadata-set": "/usr/local/bin/sndfile-metadata-set", "sndfile-play": "/usr/local/bin/sndfile-play", "sndfile-salvage": "/usr/local/bin/sndfile-salvage", "orc-contents": "/usr/local/bin/orc-contents", "orc-metadata": "/usr/local/bin/orc-metadata", "orc-statistics": "/usr/local/bin/orc-statistics", "plasma-store-server": "/usr/local/bin/plasma-store-server", "plasma_store": "/usr/local/bin/plasma_store", "sha256_profile": "/usr/local/bin/sha256_profile", "xxh128sum": "/usr/local/bin/xxh128sum", "xxh32sum": "/usr/local/bin/xxh32sum", "xxh64sum": "/usr/local/bin/xxh64sum", "htseq-count": "/usr/local/bin/htseq-count", "htseq-qa": "/usr/local/bin/htseq-qa", "xxhsum": "/usr/local/bin/xxhsum"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/gimmemotifs-minimal.
singularity registry hpc automated addition for gimmemotifs-minimal
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/gimmemotifs-minimal
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/gimmemotifs-minimal:0.18.0--py39h67e14b5_0
```
...
```bash
$ module load quay.io/biocontainers/gimmemotifs-minimal/0.18.0--py39h67e14b5_0
$ module help quay.io/biocontainers/gimmemotifs-minimal/0.18.0--py39h67e14b5_0
```
...
#### gimmemotifs-minimal-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gimmemotifs-minimal-inspect-deffile:
