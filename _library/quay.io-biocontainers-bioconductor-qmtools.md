---
layout: container
name:  "quay.io/biocontainers/bioconductor-qmtools"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:24:42.705899"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-qmtools
```
...
#### bioconductor-qmtools-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-qmtools-inspect-deffile:
