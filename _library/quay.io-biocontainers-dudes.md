---
layout: container
name:  "quay.io/biocontainers/dudes"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:18:16.087510"
latest: "0.08--py_2"
...
```bash
$ shpc install quay.io/biocontainers/dudes
```
...
#### dudes-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### dudes-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/DUDes.py
$ podman run --it --rm --entrypoint /usr/local/bin/DUDes.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/DUDes.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/DUDesDB.py
$ podman run --it --rm --entrypoint /usr/local/bin/DUDesDB.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/DUDesDB.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
