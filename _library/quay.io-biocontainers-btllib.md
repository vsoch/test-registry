...
updated_at: "2023-03-10 03:05:44.641560"
latest: "1.4.10--py39hc16433a_0"
...
```bash
$ shpc install quay.io/biocontainers/btllib:1.4.10--py39hc16433a_0
```
...
```bash
$ module load quay.io/biocontainers/btllib/1.4.10--py39hc16433a_0
$ module help quay.io/biocontainers/btllib/1.4.10--py39hc16433a_0
```
