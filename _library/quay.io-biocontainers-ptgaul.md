...
updated_at: "2023-03-10 03:03:11.097402"
...
```bash
$ shpc install quay.io/biocontainers/ptgaul:1.0.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ptgaul/1.0.5--pyhdfd78af_0
$ module help quay.io/biocontainers/ptgaul/1.0.5--pyhdfd78af_0
```
