---
layout: container
name:  "quay.io/biocontainers/bioconductor-rifi"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:20:23.458913"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rifi
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-rifi:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rifi/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rifi/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-rifi-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-rifi-inspect-deffile:
