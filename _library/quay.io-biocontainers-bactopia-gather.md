...
updated_at: "2023-03-10 03:16:51.213798"
...
```bash
$ shpc install quay.io/biocontainers/bactopia-gather:1.0.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bactopia-gather/1.0.1--hdfd78af_0
$ module help quay.io/biocontainers/bactopia-gather/1.0.1--hdfd78af_0
```
