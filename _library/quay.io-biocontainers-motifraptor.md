---
layout: container
name:  "quay.io/biocontainers/motifraptor"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:19:13.462948"
...
```bash
$ shpc install quay.io/biocontainers/motifraptor
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/motifraptor:0.3.0--py36h40b2fa4_5
```
...
```bash
$ module load quay.io/biocontainers/motifraptor/0.3.0--py36h40b2fa4_5
$ module help quay.io/biocontainers/motifraptor/0.3.0--py36h40b2fa4_5
```
...
#### motifraptor-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### motifraptor-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/MotifRaptor
$ podman run --it --rm --entrypoint /usr/local/bin/MotifRaptor   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/MotifRaptor   -v ${PWD} -w ${PWD} <container> -c " $@"
```
