---
layout: container
name:  "quay.io/biocontainers/blksheep"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:07:21.137464"
latest: "0.0.7--py_0"
...
```bash
$ shpc install quay.io/biocontainers/blksheep
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/blksheep:0.0.7--py_0
```
...
```bash
$ module load quay.io/biocontainers/blksheep/0.0.7--py_0
$ module help quay.io/biocontainers/blksheep/0.0.7--py_0
```
...
#### blksheep-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### blksheep-inspect-deffile:
