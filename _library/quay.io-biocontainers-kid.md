---
layout: container
name:  "quay.io/biocontainers/kid"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:26:46.632932"
latest: "0.9.6--py27_2"
...
```bash
$ shpc install quay.io/biocontainers/kid
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/kid:0.9.6--py27_2
```
...
```bash
$ module load quay.io/biocontainers/kid/0.9.6--py27_2
$ module help quay.io/biocontainers/kid/0.9.6--py27_2
```
...
```bash
$ singularity exec <container> /usr/local/bin/kid
$ podman run --it --rm --entrypoint /usr/local/bin/kid   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kid   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/kidc
$ podman run --it --rm --entrypoint /usr/local/bin/kidc   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kidc   -v ${PWD} -w ${PWD} <container> -c " $@"
```
