---
layout: container
name:  "quay.io/biocontainers/sbt"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:22:31.333481"
latest: "0.13.12--1"
...
```bash
$ shpc install quay.io/biocontainers/sbt
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/sbt:0.13.12--1
```
...
```bash
$ module load quay.io/biocontainers/sbt/0.13.12--1
$ module help quay.io/biocontainers/sbt/0.13.12--1
```
...
```bash
$ singularity exec <container> /usr/local/bin/sbt
$ podman run --it --rm --entrypoint /usr/local/bin/sbt   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sbt   -v ${PWD} -w ${PWD} <container> -c " $@"
```
