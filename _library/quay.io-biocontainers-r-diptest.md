---
layout: container
name:  "quay.io/biocontainers/r-diptest"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:12:28.060246"
...
```bash
$ shpc install quay.io/biocontainers/r-diptest
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-diptest:0.75_7--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-diptest/0.75_7--r3.4.1_0
$ module help quay.io/biocontainers/r-diptest/0.75_7--r3.4.1_0
```
...
#### r-diptest-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-diptest-inspect-deffile:
