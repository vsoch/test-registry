---
layout: container
name:  "quay.io/biocontainers/r-caroline"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:04:38.700443"
...
```bash
$ shpc install quay.io/biocontainers/r-caroline
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-caroline:0.7.6--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-caroline/0.7.6--r3.3.1_0
$ module help quay.io/biocontainers/r-caroline/0.7.6--r3.3.1_0
```
...
#### r-caroline-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-caroline-inspect-deffile:
