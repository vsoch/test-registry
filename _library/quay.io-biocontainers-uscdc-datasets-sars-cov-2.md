---
layout: container
name:  "quay.io/biocontainers/uscdc-datasets-sars-cov-2"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:25:06.837656"
...
```bash
$ module load quay.io/biocontainers/uscdc-datasets-sars-cov-2/0.7.2--hdfd78af_0
$ module help quay.io/biocontainers/uscdc-datasets-sars-cov-2/0.7.2--hdfd78af_0
```
...
#### uscdc-datasets-sars-cov-2-shell:
...
#### uscdc-datasets-sars-cov-2-exec:
...
#### uscdc-datasets-sars-cov-2-inspect:
...
#### uscdc-datasets-sars-cov-2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### uscdc-datasets-sars-cov-2-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/GenFSGopher.pl
$ podman run --it --rm --entrypoint /usr/local/bin/GenFSGopher.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/GenFSGopher.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
```
