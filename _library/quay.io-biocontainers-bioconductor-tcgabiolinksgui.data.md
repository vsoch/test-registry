...
updated_at: "2023-03-09 03:29:12.854067"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tcgabiolinksgui.data:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tcgabiolinksgui.data/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tcgabiolinksgui.data/1.18.0--r42hdfd78af_0
```
