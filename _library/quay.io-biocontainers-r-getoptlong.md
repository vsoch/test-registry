---
layout: container
name:  "quay.io/biocontainers/r-getoptlong"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:36:48.679900"
...
```bash
$ shpc install quay.io/biocontainers/r-getoptlong
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-getoptlong:0.1.0--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-getoptlong/0.1.0--r3.2.2_0
$ module help quay.io/biocontainers/r-getoptlong/0.1.0--r3.2.2_0
```
...
#### r-getoptlong-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-getoptlong-inspect-deffile:
