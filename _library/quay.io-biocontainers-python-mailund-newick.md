---
layout: container
name:  "quay.io/biocontainers/python-mailund-newick"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:10:23.035589"
latest: "1.3--py27_1"
...
```bash
$ shpc install quay.io/biocontainers/python-mailund-newick
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/python-mailund-newick:1.3--py27_1
```
...
```bash
$ module load quay.io/biocontainers/python-mailund-newick/1.3--py27_1
$ module help quay.io/biocontainers/python-mailund-newick/1.3--py27_1
```
...
#### python-mailund-newick-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### python-mailund-newick-inspect-deffile:
