...
updated_at: "2023-03-10 03:22:44.974057"
...
```bash
$ shpc install quay.io/biocontainers/get_homologues:3.5.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/get_homologues/3.5.4--hdfd78af_0
$ module help quay.io/biocontainers/get_homologues/3.5.4--hdfd78af_0
```
