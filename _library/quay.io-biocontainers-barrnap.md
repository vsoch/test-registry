---
layout: container
name:  "quay.io/biocontainers/barrnap"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:32:55.955262"
...
versions:
 - "0.9--hdfd78af_4"
description: "shpc-registry automated BioContainers addition for barrnap"
config: {"url": "https://biocontainers.pro/tools/barrnap", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for barrnap", "latest": {"0.9--hdfd78af_4": "sha256:e018f6307a956736cb0d3b7ce2ca0bc53fb5929d52c9d843dbf369cffa1c1e99"}, "tags": {"0.9--hdfd78af_4": "sha256:e018f6307a956736cb0d3b7ce2ca0bc53fb5929d52c9d843dbf369cffa1c1e99"}, "docker": "quay.io/biocontainers/barrnap", "aliases": {"barrnap": "/usr/local/bin/barrnap", "perl5.32.0": "/usr/local/bin/perl5.32.0", "hmmpgmd_shard": "/usr/local/bin/hmmpgmd_shard", "easel": "/usr/local/bin/easel", "esl-mixdchlet": "/usr/local/bin/esl-mixdchlet", "esl-alimanip": "/usr/local/bin/esl-alimanip", "esl-alimap": "/usr/local/bin/esl-alimap", "esl-alimask": "/usr/local/bin/esl-alimask", "esl-alimerge": "/usr/local/bin/esl-alimerge", "esl-alipid": "/usr/local/bin/esl-alipid", "esl-alirev": "/usr/local/bin/esl-alirev"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/barrnap.
shpc-registry automated BioContainers addition for barrnap
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/barrnap
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/barrnap:0.9--hdfd78af_4
```
...
```bash
$ module load quay.io/biocontainers/barrnap/0.9--hdfd78af_4
$ module help quay.io/biocontainers/barrnap/0.9--hdfd78af_4
```
...
#### barrnap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### barrnap-inspect-deffile:
