...
updated_at: "2023-03-10 03:21:32.983921"
...
```bash
$ shpc install quay.io/biocontainers/kmergenie:1.7051--py39r41h2add14b_3
```
...
```bash
$ module load quay.io/biocontainers/kmergenie/1.7051--py39r41h2add14b_3
$ module help quay.io/biocontainers/kmergenie/1.7051--py39r41h2add14b_3
```
