...
updated_at: "2023-03-10 02:57:40.060905"
latest: "23.02-cuda11.8-runtime-ubuntu22.04-py3.10"
...
```bash
$ shpc install nvcr.io/nvidia/rapidsai/rapidsai:23.02-cuda11.8-runtime-ubuntu22.04-py3.10
```
...
```bash
$ module load nvcr.io/nvidia/rapidsai/rapidsai/23.02-cuda11.8-runtime-ubuntu22.04-py3.10
$ module help nvcr.io/nvidia/rapidsai/rapidsai/23.02-cuda11.8-runtime-ubuntu22.04-py3.10
```
