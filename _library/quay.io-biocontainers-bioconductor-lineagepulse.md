...
updated_at: "2023-03-10 03:43:30.845925"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-lineagepulse:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-lineagepulse/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-lineagepulse/1.18.0--r42hdfd78af_0
```
