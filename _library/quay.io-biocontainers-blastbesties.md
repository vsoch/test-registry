---
layout: container
name:  "quay.io/biocontainers/blastbesties"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:16:54.548980"
latest: "1.1.1--py_2"
...
```bash
$ shpc install quay.io/biocontainers/blastbesties
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/blastbesties:1.1.1--py_2
```
...
```bash
$ module load quay.io/biocontainers/blastbesties/1.1.1--py_2
$ module help quay.io/biocontainers/blastbesties/1.1.1--py_2
```
...
#### blastbesties-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### blastbesties-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/blastbesties
$ podman run --it --rm --entrypoint /usr/local/bin/blastbesties   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/blastbesties   -v ${PWD} -w ${PWD} <container> -c " $@"
```
