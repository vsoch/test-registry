---
layout: container
name:  "quay.io/biocontainers/perl-moosex-types-stringlike"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:09:42.442215"
...
```bash
$ shpc install quay.io/biocontainers/perl-moosex-types-stringlike
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-moosex-types-stringlike:0.003--pl526_0
```
...
```bash
$ module load quay.io/biocontainers/perl-moosex-types-stringlike/0.003--pl526_0
$ module help quay.io/biocontainers/perl-moosex-types-stringlike/0.003--pl526_0
```
...
#### perl-moosex-types-stringlike-run:
...
#### perl-moosex-types-stringlike-shell:
...
#### perl-moosex-types-stringlike-exec:
...
#### perl-moosex-types-stringlike-inspect:
...
#### perl-moosex-types-stringlike-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-moosex-types-stringlike-inspect-deffile:
