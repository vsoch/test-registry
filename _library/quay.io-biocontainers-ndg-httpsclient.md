---
layout: container
name:  "quay.io/biocontainers/ndg-httpsclient"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:44:12.499432"
latest: "0.4.2--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/ndg-httpsclient
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ndg-httpsclient:0.4.2--py36_0
```
...
```bash
$ module load quay.io/biocontainers/ndg-httpsclient/0.4.2--py36_0
$ module help quay.io/biocontainers/ndg-httpsclient/0.4.2--py36_0
```
...
#### ndg-httpsclient-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ndg-httpsclient-inspect-deffile:
