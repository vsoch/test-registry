...
updated_at: "2023-03-10 03:35:56.169953"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-seqgate:1.8.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-seqgate/1.8.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-seqgate/1.8.0--r42hdfd78af_0
```
