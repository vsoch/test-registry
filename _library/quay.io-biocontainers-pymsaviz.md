---
layout: container
name:  "quay.io/biocontainers/pymsaviz"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:14:23.053926"
...
```bash
$ shpc install quay.io/biocontainers/pymsaviz
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pymsaviz:0.2.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/pymsaviz/0.2.2--pyhdfd78af_0
$ module help quay.io/biocontainers/pymsaviz/0.2.2--pyhdfd78af_0
```
...
#### pymsaviz-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pymsaviz-inspect-deffile:
