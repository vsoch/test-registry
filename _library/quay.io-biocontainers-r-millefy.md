---
layout: container
name:  "quay.io/biocontainers/r-millefy"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:24:35.393455"
...
```bash
$ shpc install quay.io/biocontainers/r-millefy
```
...
#### r-millefy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-millefy-inspect-deffile:
