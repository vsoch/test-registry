---
layout: container
name:  "quay.io/biocontainers/r-recetox-xmsannotator"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:27:05.843558"
...
```bash
$ shpc install quay.io/biocontainers/r-recetox-xmsannotator
```
...
#### r-recetox-xmsannotator-inspect:
...
#### r-recetox-xmsannotator-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-recetox-xmsannotator-inspect-deffile:
