---
layout: container
name:  "quay.io/biocontainers/multivcfanalyzer"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 02:59:58.092398"
...
```bash
$ shpc install quay.io/biocontainers/multivcfanalyzer
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/multivcfanalyzer:0.85.2--hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/multivcfanalyzer/0.85.2--hdfd78af_1
$ module help quay.io/biocontainers/multivcfanalyzer/0.85.2--hdfd78af_1
```
...
#### multivcfanalyzer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### multivcfanalyzer-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/multivcfanalyzer
$ podman run --it --rm --entrypoint /usr/local/bin/multivcfanalyzer   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/multivcfanalyzer   -v ${PWD} -w ${PWD} <container> -c " $@"
```
