---
layout: container
name:  "quay.io/biocontainers/bioconductor-genomicinteractionnodes"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:35:30.045448"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicinteractionnodes
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-genomicinteractionnodes:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomicinteractionnodes/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomicinteractionnodes/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-genomicinteractionnodes-run:
...
#### bioconductor-genomicinteractionnodes-shell:
...
#### bioconductor-genomicinteractionnodes-exec:
...
#### bioconductor-genomicinteractionnodes-inspect:
...
#### bioconductor-genomicinteractionnodes-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-genomicinteractionnodes-inspect-deffile:
