---
layout: container
name:  "quay.io/biocontainers/bioconductor-crisprscoredata"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-crisprscoredata/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-crisprscoredata/container.yaml"
updated_at: "2023-03-10 03:21:10.456427"
latest: "1.2.0--r42hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-crisprscoredata"
aliases:
...
versions:
 - "1.2.0--r42hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-crisprscoredata"
config: {"url": "https://biocontainers.pro/tools/bioconductor-crisprscoredata", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-crisprscoredata", "latest": {"1.2.0--r42hdfd78af_0": "sha256:ab61e9a47debe626f6998ab0b2fc4041a776b9609310a64a4b7b33f5ba53b18c"}, "tags": {"1.2.0--r42hdfd78af_0": "sha256:ab61e9a47debe626f6998ab0b2fc4041a776b9609310a64a4b7b33f5ba53b18c"}, "docker": "quay.io/biocontainers/bioconductor-crisprscoredata", "aliases": {"installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-crisprscoredata.
singularity registry hpc automated addition for bioconductor-crisprscoredata
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprscoredata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprscoredata:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprscoredata/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprscoredata/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-crisprscoredata-run:
...
#### bioconductor-crisprscoredata-shell:
...
#### bioconductor-crisprscoredata-exec:
...
#### bioconductor-crisprscoredata-inspect:
...
#### bioconductor-crisprscoredata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-crisprscoredata-inspect-deffile:
