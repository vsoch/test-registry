---
layout: container
name:  "quay.io/biocontainers/bioconductor-signifinder"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:38:26.790076"
...
versions:
 - "1.0.0--r42hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-signifinder"
config: {"url": "https://biocontainers.pro/tools/bioconductor-signifinder", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-signifinder", "latest": {"1.0.0--r42hdfd78af_0": "sha256:58a7ccbd9679e6f0e14e55378d18138dd6a412001c78490570ebee04545d51ed"}, "tags": {"1.0.0--r42hdfd78af_0": "sha256:58a7ccbd9679e6f0e14e55378d18138dd6a412001c78490570ebee04545d51ed"}, "docker": "quay.io/biocontainers/bioconductor-signifinder", "aliases": {"installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "f2py3.10": "/usr/local/bin/f2py3.10", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-signifinder.
singularity registry hpc automated addition for bioconductor-signifinder
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-signifinder
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-signifinder:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-signifinder/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-signifinder/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-signifinder-shell:
...
#### bioconductor-signifinder-inspect:
...
#### bioconductor-signifinder-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-signifinder-inspect-deffile:
