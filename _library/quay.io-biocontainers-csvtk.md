...
updated_at: "2023-03-10 03:39:01.859758"
latest: "0.25.0--h9ee0642_0"
...
```bash
$ shpc install quay.io/biocontainers/csvtk:0.25.0--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/csvtk/0.25.0--h9ee0642_0
$ module help quay.io/biocontainers/csvtk/0.25.0--h9ee0642_0
```
