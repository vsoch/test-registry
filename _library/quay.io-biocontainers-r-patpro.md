---
layout: container
name:  "quay.io/biocontainers/r-patpro"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:15:39.999417"
...
```bash
$ shpc install quay.io/biocontainers/r-patpro
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-patpro:1.1.0--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-patpro/1.1.0--r3.3.1_0
$ module help quay.io/biocontainers/r-patpro/1.1.0--r3.3.1_0
```
...
#### r-patpro-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-patpro-inspect-deffile:
