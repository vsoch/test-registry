---
layout: container
name:  "quay.io/biocontainers/intemap"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:24:07.229961"
latest: "1.0--py27_1"
...
```bash
$ shpc install quay.io/biocontainers/intemap
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/intemap:1.0--py27_1
```
...
```bash
$ module load quay.io/biocontainers/intemap/1.0--py27_1
$ module help quay.io/biocontainers/intemap/1.0--py27_1
```
...
#### intemap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### intemap-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/FilterCtgCov
$ podman run --it --rm --entrypoint /usr/local/bin/FilterCtgCov   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/FilterCtgCov   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/SCFtoCTG
$ podman run --it --rm --entrypoint /usr/local/bin/SCFtoCTG   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/SCFtoCTG   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ctgvalidate
$ podman run --it --rm --entrypoint /usr/local/bin/ctgvalidate   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ctgvalidate   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/extract_fastqread
$ podman run --it --rm --entrypoint /usr/local/bin/extract_fastqread   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/extract_fastqread   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fastatrans
$ podman run --it --rm --entrypoint /usr/local/bin/fastatrans   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fastatrans   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/godnadiff_pairctg.sh
$ podman run --it --rm --entrypoint /usr/local/bin/godnadiff_pairctg.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/godnadiff_pairctg.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gomapandfilter.sh
$ podman run --it --rm --entrypoint /usr/local/bin/gomapandfilter.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gomapandfilter.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gomerge.sh
$ podman run --it --rm --entrypoint /usr/local/bin/gomerge.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gomerge.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mergeassembly
$ podman run --it --rm --entrypoint /usr/local/bin/mergeassembly   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mergeassembly   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mergefastq-p
$ podman run --it --rm --entrypoint /usr/local/bin/mergefastq-p   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mergefastq-p   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mergeprocess.sh
$ podman run --it --rm --entrypoint /usr/local/bin/mergeprocess.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mergeprocess.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ompi-submit
$ podman run --it --rm --entrypoint /usr/local/bin/ompi-submit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ompi-submit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/orte-submit
$ podman run --it --rm --entrypoint /usr/local/bin/orte-submit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/orte-submit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/puncsamfile.sh
$ podman run --it --rm --entrypoint /usr/local/bin/puncsamfile.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/puncsamfile.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/runInteMAP.py
$ podman run --it --rm --entrypoint /usr/local/bin/runInteMAP.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/runInteMAP.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/runabyss.py
$ podman run --it --rm --entrypoint /usr/local/bin/runabyss.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/runabyss.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/runcabog.py
$ podman run --it --rm --entrypoint /usr/local/bin/runcabog.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/runcabog.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/runerrcor.py
$ podman run --it --rm --entrypoint /usr/local/bin/runerrcor.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/runerrcor.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/runquake.py
$ podman run --it --rm --entrypoint /usr/local/bin/runquake.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/runquake.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/runrfh.py
$ podman run --it --rm --entrypoint /usr/local/bin/runrfh.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/runrfh.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
