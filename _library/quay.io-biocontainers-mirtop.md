---
layout: container
name:  "quay.io/biocontainers/mirtop"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:13:15.654381"
...
```bash
$ shpc install quay.io/biocontainers/mirtop
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mirtop:0.4.25--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/mirtop/0.4.25--pyh5e36f6f_0
$ module help quay.io/biocontainers/mirtop/0.4.25--pyh5e36f6f_0
```
...
#### mirtop-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mirtop-inspect-deffile:
