---
layout: container
name:  "quay.io/biocontainers/rlpipes"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:24:11.657418"
...
```bash
$ module load quay.io/biocontainers/rlpipes/0.9.3--pyh5e36f6f_0
$ module help quay.io/biocontainers/rlpipes/0.9.3--pyh5e36f6f_0
```
...
#### rlpipes-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rlpipes-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/RLPipes
$ podman run --it --rm --entrypoint /usr/local/bin/RLPipes   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/RLPipes   -v ${PWD} -w ${PWD} <container> -c " $@"
```
