---
layout: container
name:  "quay.io/biocontainers/r-ngsplot"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/r-ngsplot/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/r-ngsplot/container.yaml"
updated_at: "2023-03-10 03:25:40.280366"
latest: "2.63--hdfd78af_7"
container_url: "https://biocontainers.pro/tools/r-ngsplot"
aliases:
 - "ExtractGName.R"
 - "alt_reg_cufflinks"
 - "alter2bed.pl"
...
```bash
$ module load quay.io/biocontainers/r-ngsplot/2.63--hdfd78af_7
$ module help quay.io/biocontainers/r-ngsplot/2.63--hdfd78af_7
```
...
#### r-ngsplot-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-ngsplot-inspect-deffile:
