---
layout: container
name:  "quay.io/biocontainers/r-ic10trainingdata"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:37:44.128460"
...
```bash
$ shpc install quay.io/biocontainers/r-ic10trainingdata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-ic10trainingdata:1.0.1--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-ic10trainingdata/1.0.1--r3.4.1_0
$ module help quay.io/biocontainers/r-ic10trainingdata/1.0.1--r3.4.1_0
```
...
#### r-ic10trainingdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-ic10trainingdata-inspect-deffile:
