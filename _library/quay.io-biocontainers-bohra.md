...
updated_at: "2023-03-10 03:44:29.443774"
latest: "1.2.20--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bohra:1.2.20--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bohra/1.2.20--pyhdfd78af_0
$ module help quay.io/biocontainers/bohra/1.2.20--pyhdfd78af_0
```
