...
updated_at: "2023-03-09 03:38:56.793915"
latest: "1.0.2--h1aed7a7_0"
...
```bash
$ shpc install quay.io/biocontainers/flexserv:1.0.2--h1aed7a7_0
```
...
```bash
$ module load quay.io/biocontainers/flexserv/1.0.2--h1aed7a7_0
$ module help quay.io/biocontainers/flexserv/1.0.2--h1aed7a7_0
```
