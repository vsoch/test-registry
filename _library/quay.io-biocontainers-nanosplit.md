---
layout: container
name:  "quay.io/biocontainers/nanosplit"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:42:01.014255"
latest: "0.1.4--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/nanosplit
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/nanosplit:0.1.4--py36_0
```
...
```bash
$ module load quay.io/biocontainers/nanosplit/0.1.4--py36_0
$ module help quay.io/biocontainers/nanosplit/0.1.4--py36_0
```
...
#### nanosplit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### nanosplit-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/NanoSplit
$ podman run --it --rm --entrypoint /usr/local/bin/NanoSplit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/NanoSplit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
