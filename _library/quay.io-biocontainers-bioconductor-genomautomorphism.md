---
layout: container
name:  "quay.io/biocontainers/bioconductor-genomautomorphism"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:07:29.864437"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-genomautomorphism
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-genomautomorphism:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-genomautomorphism/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-genomautomorphism/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-genomautomorphism-run:
...
#### bioconductor-genomautomorphism-shell:
...
#### bioconductor-genomautomorphism-exec:
...
#### bioconductor-genomautomorphism-inspect:
...
#### bioconductor-genomautomorphism-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-genomautomorphism-inspect-deffile:
