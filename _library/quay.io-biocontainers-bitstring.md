---
layout: container
name:  "quay.io/biocontainers/bitstring"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:15:06.638211"
latest: "3.1.5--py35_1"
...
```bash
$ shpc install quay.io/biocontainers/bitstring
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bitstring:3.1.5--py35_1
```
...
```bash
$ module load quay.io/biocontainers/bitstring/3.1.5--py35_1
$ module help quay.io/biocontainers/bitstring/3.1.5--py35_1
```
...
#### bitstring-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bitstring-inspect-deffile:
