---
layout: container
name:  "quay.io/biocontainers/keepalive"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:20:06.154208"
latest: "0.5--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/keepalive
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/keepalive:0.5--py35_0
```
...
```bash
$ module load quay.io/biocontainers/keepalive/0.5--py35_0
$ module help quay.io/biocontainers/keepalive/0.5--py35_0
```
...
#### keepalive-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### keepalive-inspect-deffile:
