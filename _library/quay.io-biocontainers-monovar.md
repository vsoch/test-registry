---
layout: container
name:  "quay.io/biocontainers/monovar"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:15:40.916185"
latest: "v0.0.1--2"
...
```bash
$ shpc install quay.io/biocontainers/monovar
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/monovar:v0.0.1--2
```
...
```bash
$ module load quay.io/biocontainers/monovar/v0.0.1--2
$ module help quay.io/biocontainers/monovar/v0.0.1--2
```
...
#### monovar-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### monovar-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/monovar
$ podman run --it --rm --entrypoint /usr/local/bin/monovar   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/monovar   -v ${PWD} -w ${PWD} <container> -c " $@"
```
