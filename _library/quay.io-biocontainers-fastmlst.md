...
updated_at: "2023-03-10 03:02:30.155095"
...
config: {"url": "https://biocontainers.pro/tools/fastmlst", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for fastmlst", "latest": {"0.0.15--pyhdfd78af_0": "sha256:a4e3fafe0b295e9e6dcabb60a2ad9e22b38a2476502a8f20735333a6f5cc7595"}, "tags": {"0.0.9--py_0": "sha256:cc131ee6bc0b619e22e8ceb8bef435cf764a29f07751726b5db3f83e618cbdbf", "0.0.15--pyhdfd78af_0": "sha256:a4e3fafe0b295e9e6dcabb60a2ad9e22b38a2476502a8f20735333a6f5cc7595"}, "docker": "quay.io/biocontainers/fastmlst", "aliases": {"fastmlst": "/usr/local/bin/fastmlst", "test_pcre": "/usr/local/bin/test_pcre", "blastdbcp": "/usr/local/bin/blastdbcp", "gene_info_reader": "/usr/local/bin/gene_info_reader", "seqdb_demo": "/usr/local/bin/seqdb_demo", "seqdb_perf": "/usr/local/bin/seqdb_perf", "seedtop": "/usr/local/bin/seedtop", "tqdm": "/usr/local/bin/tqdm", "run_with_lock": "/usr/local/bin/run_with_lock", "f2py3.8": "/usr/local/bin/f2py3.8", "blast_formatter": "/usr/local/bin/blast_formatter"}}
---
...
```bash
$ shpc install quay.io/biocontainers/fastmlst:0.0.15--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fastmlst/0.0.15--pyhdfd78af_0
$ module help quay.io/biocontainers/fastmlst/0.0.15--pyhdfd78af_0
```
