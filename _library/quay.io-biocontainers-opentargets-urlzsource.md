...
updated_at: "2023-03-09 03:18:28.225204"
...
```bash
$ shpc install quay.io/biocontainers/opentargets-urlzsource
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/opentargets-urlzsource:1.0.0--pyh864c0ab_0
```
...
```bash
$ module load quay.io/biocontainers/opentargets-urlzsource/1.0.0--pyh864c0ab_0
$ module help quay.io/biocontainers/opentargets-urlzsource/1.0.0--pyh864c0ab_0
```
...
#### opentargets-urlzsource-inspect:
...
#### opentargets-urlzsource-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### opentargets-urlzsource-inspect-deffile:
