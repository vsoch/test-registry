---
layout: container
name:  "quay.io/biocontainers/r-prettyunits"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:08:38.081086"
...
```bash
$ shpc install quay.io/biocontainers/r-prettyunits
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-prettyunits:1.0.2--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-prettyunits/1.0.2--r3.3.1_0
$ module help quay.io/biocontainers/r-prettyunits/1.0.2--r3.3.1_0
```
...
#### r-prettyunits-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-prettyunits-inspect-deffile:
