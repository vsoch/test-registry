---
layout: container
name:  "quay.io/biocontainers/rpy2"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:12:51.405255"
latest: "2.9.4"
...
```bash
$ shpc install quay.io/biocontainers/rpy2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/rpy2:2.9.4
```
...
```bash
$ module load quay.io/biocontainers/rpy2/2.9.4
$ module help quay.io/biocontainers/rpy2/2.9.4
```
...
#### rpy2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rpy2-inspect-deffile:
