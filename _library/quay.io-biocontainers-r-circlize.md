---
layout: container
name:  "quay.io/biocontainers/r-circlize"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:36:34.538465"
...
```bash
$ shpc install quay.io/biocontainers/r-circlize
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-circlize:0.3.3--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-circlize/0.3.3--r3.2.2_0
$ module help quay.io/biocontainers/r-circlize/0.3.3--r3.2.2_0
```
...
#### r-circlize-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-circlize-inspect-deffile:
