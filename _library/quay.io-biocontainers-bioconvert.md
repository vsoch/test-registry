...
updated_at: "2023-03-09 02:59:13.871471"
...
```bash
$ shpc install quay.io/biocontainers/bioconvert:0.6.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconvert/0.6.3--pyhdfd78af_0
$ module help quay.io/biocontainers/bioconvert/0.6.3--pyhdfd78af_0
```
