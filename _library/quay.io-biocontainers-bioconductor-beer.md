---
layout: container
name:  "quay.io/biocontainers/bioconductor-beer"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:17:57.624983"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-beer
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-beer:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-beer/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-beer/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-beer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-beer-inspect-deffile:
