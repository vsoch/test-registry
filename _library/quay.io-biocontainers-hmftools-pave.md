---
layout: container
name:  "quay.io/biocontainers/hmftools-pave"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:32:18.162537"
...
```bash
$ shpc install quay.io/biocontainers/hmftools-pave
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/hmftools-pave:1.4.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/hmftools-pave/1.4.1--hdfd78af_0
$ module help quay.io/biocontainers/hmftools-pave/1.4.1--hdfd78af_0
```
...
#### hmftools-pave-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### hmftools-pave-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pave
$ podman run --it --rm --entrypoint /usr/local/bin/pave   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pave   -v ${PWD} -w ${PWD} <container> -c " $@"
```
