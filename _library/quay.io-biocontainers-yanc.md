---
layout: container
name:  "quay.io/biocontainers/yanc"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:42:43.241681"
latest: "0.3.3--py36_1"
...
```bash
$ shpc install quay.io/biocontainers/yanc
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/yanc:0.3.3--py36_1
```
...
```bash
$ module load quay.io/biocontainers/yanc/0.3.3--py36_1
$ module help quay.io/biocontainers/yanc/0.3.3--py36_1
```
...
#### yanc-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### yanc-inspect-deffile:
