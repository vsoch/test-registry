---
layout: container
name:  "quay.io/biocontainers/mygene"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:12:07.757446"
...
```bash
$ shpc install quay.io/biocontainers/mygene
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mygene:3.2.2--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/mygene/3.2.2--pyh5e36f6f_0
$ module help quay.io/biocontainers/mygene/3.2.2--pyh5e36f6f_0
```
...
#### mygene-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mygene-inspect-deffile:
