---
layout: container
name:  "quay.io/biocontainers/polymutt"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:10:15.148700"
latest: "0.18--0"
...
versions:
 - "0.18--0"
description: "shpc-registry automated BioContainers addition for polymutt"
config: {"url": "https://biocontainers.pro/tools/polymutt", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for polymutt", "latest": {"0.18--0": "sha256:e545be8a99aeaa3e4a383e77dc10b36e194577958a6ab243896b135049792481"}, "tags": {"0.18--0": "sha256:e545be8a99aeaa3e4a383e77dc10b36e194577958a6ab243896b135049792481"}, "docker": "quay.io/biocontainers/polymutt", "aliases": {"bugpoint": "/usr/local/bin/bugpoint", "c-index-test": "/usr/local/bin/c-index-test", "clang": "/usr/local/bin/clang", "clang++": "/usr/local/bin/clang++", "clang-4.0": "/usr/local/bin/clang-4.0", "clang-check": "/usr/local/bin/clang-check", "clang-cl": "/usr/local/bin/clang-cl", "clang-cpp": "/usr/local/bin/clang-cpp", "clang-format": "/usr/local/bin/clang-format", "clang-import-test": "/usr/local/bin/clang-import-test", "clang-offload-bundler": "/usr/local/bin/clang-offload-bundler", "git-clang-format": "/usr/local/bin/git-clang-format", "llc": "/usr/local/bin/llc", "lli": "/usr/local/bin/lli", "llvm-ar": "/usr/local/bin/llvm-ar", "llvm-as": "/usr/local/bin/llvm-as", "llvm-bcanalyzer": "/usr/local/bin/llvm-bcanalyzer", "llvm-c-test": "/usr/local/bin/llvm-c-test", "llvm-cat": "/usr/local/bin/llvm-cat", "llvm-config": "/usr/local/bin/llvm-config", "llvm-cov": "/usr/local/bin/llvm-cov", "llvm-cxxdump": "/usr/local/bin/llvm-cxxdump", "llvm-cxxfilt": "/usr/local/bin/llvm-cxxfilt", "llvm-diff": "/usr/local/bin/llvm-diff", "llvm-dis": "/usr/local/bin/llvm-dis", "llvm-dsymutil": "/usr/local/bin/llvm-dsymutil", "llvm-dwarfdump": "/usr/local/bin/llvm-dwarfdump", "llvm-dwp": "/usr/local/bin/llvm-dwp", "llvm-extract": "/usr/local/bin/llvm-extract", "llvm-lib": "/usr/local/bin/llvm-lib", "llvm-link": "/usr/local/bin/llvm-link", "llvm-lto": "/usr/local/bin/llvm-lto", "llvm-lto2": "/usr/local/bin/llvm-lto2", "llvm-mc": "/usr/local/bin/llvm-mc", "llvm-mcmarkup": "/usr/local/bin/llvm-mcmarkup", "llvm-modextract": "/usr/local/bin/llvm-modextract", "llvm-nm": "/usr/local/bin/llvm-nm", "llvm-objdump": "/usr/local/bin/llvm-objdump", "llvm-opt-report": "/usr/local/bin/llvm-opt-report", "llvm-pdbdump": "/usr/local/bin/llvm-pdbdump", "llvm-profdata": "/usr/local/bin/llvm-profdata", "llvm-ranlib": "/usr/local/bin/llvm-ranlib", "llvm-readobj": "/usr/local/bin/llvm-readobj", "llvm-rtdyld": "/usr/local/bin/llvm-rtdyld", "llvm-size": "/usr/local/bin/llvm-size", "llvm-split": "/usr/local/bin/llvm-split", "llvm-stress": "/usr/local/bin/llvm-stress", "llvm-strings": "/usr/local/bin/llvm-strings", "llvm-symbolizer": "/usr/local/bin/llvm-symbolizer", "llvm-tblgen": "/usr/local/bin/llvm-tblgen", "llvm-xray": "/usr/local/bin/llvm-xray", "obj2yaml": "/usr/local/bin/obj2yaml", "opt": "/usr/local/bin/opt", "polymutt": "/usr/local/bin/polymutt", "sancov": "/usr/local/bin/sancov", "sanstats": "/usr/local/bin/sanstats", "scan-build": "/usr/local/bin/scan-build", "scan-view": "/usr/local/bin/scan-view", "verify-uselistorder": "/usr/local/bin/verify-uselistorder", "yaml2obj": "/usr/local/bin/yaml2obj"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/polymutt.
shpc-registry automated BioContainers addition for polymutt
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/polymutt
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/polymutt:0.18--0
```
...
```bash
$ module load quay.io/biocontainers/polymutt/0.18--0
$ module help quay.io/biocontainers/polymutt/0.18--0
```
...
#### polymutt-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### polymutt-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/clang-4.0
$ podman run --it --rm --entrypoint /usr/local/bin/clang-4.0   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/clang-4.0   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/llvm-pdbdump
$ podman run --it --rm --entrypoint /usr/local/bin/llvm-pdbdump   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/llvm-pdbdump   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/polymutt
$ podman run --it --rm --entrypoint /usr/local/bin/polymutt   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/polymutt   -v ${PWD} -w ${PWD} <container> -c " $@"
```
