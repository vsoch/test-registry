---
layout: container
name:  "quay.io/biocontainers/mitoz"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:02:13.429871"
latest: "3.5--pypl5321hdfd78af_0"
...
aliases:
 ...
 - "megahit_toolkit"
versions:
 - "3.5--pypl5321hdfd78af_0"
description: "singularity registry hpc automated addition for mitoz"
config: {"url": "https://biocontainers.pro/tools/mitoz", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for mitoz", "latest": {"3.5--pypl5321hdfd78af_0": "sha256:19a0070bc18537fd73ea3327709cab94e978aeb0f0bd6bf03a4a896f23b8e589"}, "tags": {"3.5--pypl5321hdfd78af_0": "sha256:19a0070bc18537fd73ea3327709cab94e978aeb0f0bd6bf03a4a896f23b8e589"}, "docker": "quay.io/biocontainers/mitoz", "aliases": {"RNAmultifold": "/usr/local/bin/RNAmultifold", "TMalign": "/usr/local/bin/TMalign", "attr": "/usr/local/bin/attr", "balsam": "/usr/local/bin/balsam", "coronaspades.py": "/usr/local/bin/coronaspades.py", "dba": "/usr/local/bin/dba", "dnal": "/usr/local/bin/dnal", "dumpsexp": "/usr/local/bin/dumpsexp", "estwise": "/usr/local/bin/estwise", "estwisedb": "/usr/local/bin/estwisedb", "genewise": "/usr/local/bin/genewise", "genewisedb": "/usr/local/bin/genewisedb", "getfattr": "/usr/local/bin/getfattr", "gpg-error": "/usr/local/bin/gpg-error", "gpgrt-config": "/usr/local/bin/gpgrt-config", "hmac256": "/usr/local/bin/hmac256", "hmmc2": "/usr/local/bin/hmmc2", "hmmerfm-exactmatch": "/usr/local/bin/hmmerfm-exactmatch", "jackd": "/usr/local/bin/jackd", "lame": "/usr/local/bin/lame", "libgcrypt-config": "/usr/local/bin/libgcrypt-config", "lprodump": "/usr/local/bin/lprodump", "lrelease-pro": "/usr/local/bin/lrelease-pro", "lupdate-pro": "/usr/local/bin/lupdate-pro", "make_pscores.pl": "/usr/local/bin/make_pscores.pl", "meshdebug": "/usr/local/bin/meshdebug", "metaplasmidspades.py": "/usr/local/bin/metaplasmidspades.py", "metaviralspades.py": "/usr/local/bin/metaviralspades.py", "mitoz": "/usr/local/bin/mitoz", "mitoz-tools": "/usr/local/bin/mitoz-tools", "mpg123": "/usr/local/bin/mpg123", "mpg123-id3dump": "/usr/local/bin/mpg123-id3dump", "mpg123-strip": "/usr/local/bin/mpg123-strip", "mpicalc": "/usr/local/bin/mpicalc", "orc-bugreport": "/usr/local/bin/orc-bugreport", "orcc": "/usr/local/bin/orcc", "out123": "/usr/local/bin/out123", "pa-info": "/usr/local/bin/pa-info", "pacat": "/usr/local/bin/pacat", "pacmd": "/usr/local/bin/pacmd", "pactl": "/usr/local/bin/pactl", "padsp": "/usr/local/bin/padsp", "pamon": "/usr/local/bin/pamon", "paplay": "/usr/local/bin/paplay", "parec": "/usr/local/bin/parec", "parecord": "/usr/local/bin/parecord", "pasuspender": "/usr/local/bin/pasuspender", "pl2bat.pl": "/usr/local/bin/pl2bat.pl", "poa": "/usr/local/bin/poa", "promoterwise": "/usr/local/bin/promoterwise", "psw": "/usr/local/bin/psw", "pswdb": "/usr/local/bin/pswdb", "pulseaudio": "/usr/local/bin/pulseaudio", "qmlformat": "/usr/local/bin/qmlformat", "qmltime": "/usr/local/bin/qmltime", "qmltyperegistrar": "/usr/local/bin/qmltyperegistrar", "qpaeq": "/usr/local/bin/qpaeq", "rnaviralspades.py": "/usr/local/bin/rnaviralspades.py", "scanwise": "/usr/local/bin/scanwise", "scanwise_server": "/usr/local/bin/scanwise_server", "setfattr": "/usr/local/bin/setfattr", "sip-build": "/usr/local/bin/sip-build", "sip-distinfo": "/usr/local/bin/sip-distinfo", "sip-install": "/usr/local/bin/sip-install", "sip-module": "/usr/local/bin/sip-module", "sip-sdist": "/usr/local/bin/sip-sdist", "sip-wheel": "/usr/local/bin/sip-wheel", "tracegen": "/usr/local/bin/tracegen", "yat2m": "/usr/local/bin/yat2m", "clustalo": "/usr/local/bin/clustalo", "flac": "/usr/local/bin/flac", "megahit_core": "/usr/local/bin/megahit_core", "megahit_core_no_hw_accel": "/usr/local/bin/megahit_core_no_hw_accel", "megahit_core_popcnt": "/usr/local/bin/megahit_core_popcnt", "metaflac": "/usr/local/bin/metaflac", "sndfile-cmp": "/usr/local/bin/sndfile-cmp", "sndfile-concat": "/usr/local/bin/sndfile-concat", "sndfile-convert": "/usr/local/bin/sndfile-convert", "sndfile-deinterleave": "/usr/local/bin/sndfile-deinterleave", "sndfile-info": "/usr/local/bin/sndfile-info", "sndfile-interleave": "/usr/local/bin/sndfile-interleave", "sndfile-metadata-get": "/usr/local/bin/sndfile-metadata-get", "sndfile-metadata-set": "/usr/local/bin/sndfile-metadata-set", "sndfile-play": "/usr/local/bin/sndfile-play", "sndfile-salvage": "/usr/local/bin/sndfile-salvage", "circos": "/usr/local/bin/circos", "circos.exe": "/usr/local/bin/circos.exe", "compile.bat": "/usr/local/bin/compile.bat", "compile.make": "/usr/local/bin/compile.make", "fastp": "/usr/local/bin/fastp", "gddiag": "/usr/local/bin/gddiag", "list.modules": "/usr/local/bin/list.modules", "megahit": "/usr/local/bin/megahit", "megahit_toolkit": "/usr/local/bin/megahit_toolkit"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/mitoz.
singularity registry hpc automated addition for mitoz
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/mitoz
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mitoz:3.5--pypl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mitoz/3.5--pypl5321hdfd78af_0
$ module help quay.io/biocontainers/mitoz/3.5--pypl5321hdfd78af_0
```
...
#### mitoz-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mitoz-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/mitoz
$ podman run --it --rm --entrypoint /usr/local/bin/mitoz   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mitoz   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mitoz-tools
$ podman run --it --rm --entrypoint /usr/local/bin/mitoz-tools   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mitoz-tools   -v ${PWD} -w ${PWD} <container> -c " $@"
```
