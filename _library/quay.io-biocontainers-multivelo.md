---
layout: container
name:  "quay.io/biocontainers/multivelo"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:29:48.762243"
...
```bash
$ shpc install quay.io/biocontainers/multivelo
```
...
#### multivelo-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### multivelo-inspect-deffile:
