...
updated_at: "2023-03-10 03:42:12.581989"
...
```bash
$ module load quay.io/biocontainers/wally/0.5.8--h2af1cb8_1
$ module help quay.io/biocontainers/wally/0.5.8--h2af1cb8_1
```
...
#### wally-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### wally-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/wally
$ podman run --it --rm --entrypoint /usr/local/bin/wally   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/wally   -v ${PWD} -w ${PWD} <container> -c " $@"
```
