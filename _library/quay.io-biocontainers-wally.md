...
updated_at: "2023-03-09 03:39:42.201921"
latest: "0.5.8--ha41ced6_0"
...
```bash
$ shpc install quay.io/biocontainers/wally:0.5.8--ha41ced6_0
```
...
```bash
$ module load quay.io/biocontainers/wally/0.5.8--ha41ced6_0
$ module help quay.io/biocontainers/wally/0.5.8--ha41ced6_0
```
