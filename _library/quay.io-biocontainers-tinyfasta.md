---
layout: container
name:  "quay.io/biocontainers/tinyfasta"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:38:18.738544"
latest: "0.1.0--py_0"
...
```bash
$ shpc install quay.io/biocontainers/tinyfasta
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/tinyfasta:0.1.0--py_0
```
...
```bash
$ module load quay.io/biocontainers/tinyfasta/0.1.0--py_0
$ module help quay.io/biocontainers/tinyfasta/0.1.0--py_0
```
...
#### tinyfasta-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### tinyfasta-inspect-deffile:
