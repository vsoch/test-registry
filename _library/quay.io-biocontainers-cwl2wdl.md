---
layout: container
name:  "quay.io/biocontainers/cwl2wdl"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:09:48.676625"
...
```bash
$ shpc install quay.io/biocontainers/cwl2wdl
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cwl2wdl:0.1dev44--py_2
```
...
```bash
$ module load quay.io/biocontainers/cwl2wdl/0.1dev44--py_2
$ module help quay.io/biocontainers/cwl2wdl/0.1dev44--py_2
```
...
#### cwl2wdl-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cwl2wdl-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cwl2wdl
$ podman run --it --rm --entrypoint /usr/local/bin/cwl2wdl   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cwl2wdl   -v ${PWD} -w ${PWD} <container> -c " $@"
```
