---
layout: container
name:  "quay.io/biocontainers/taeper"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:35:20.797417"
latest: "0.1.0--py_2"
...
```bash
$ shpc install quay.io/biocontainers/taeper
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/taeper:0.1.0--py_2
```
...
```bash
$ module load quay.io/biocontainers/taeper/0.1.0--py_2
$ module help quay.io/biocontainers/taeper/0.1.0--py_2
```
...
#### taeper-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### taeper-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/taeper
$ podman run --it --rm --entrypoint /usr/local/bin/taeper   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/taeper   -v ${PWD} -w ${PWD} <container> -c " $@"
```
