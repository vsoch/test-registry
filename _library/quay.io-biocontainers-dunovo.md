...
updated_at: "2023-03-09 03:05:28.205549"
...
```bash
$ shpc install quay.io/biocontainers/dunovo:3.0.2--hec16e2b_1
```
...
```bash
$ module load quay.io/biocontainers/dunovo/3.0.2--hec16e2b_1
$ module help quay.io/biocontainers/dunovo/3.0.2--hec16e2b_1
```
