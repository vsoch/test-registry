---
layout: container
name:  "quay.io/biocontainers/pytest-workflow"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:24:43.618151"
latest: "1.2.0--py_0"
...
```bash
$ shpc install quay.io/biocontainers/pytest-workflow
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pytest-workflow:1.2.0--py_0
```
...
```bash
$ module load quay.io/biocontainers/pytest-workflow/1.2.0--py_0
$ module help quay.io/biocontainers/pytest-workflow/1.2.0--py_0
```
...
#### pytest-workflow-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pytest-workflow-inspect-deffile:
