---
layout: container
name:  "quay.io/biocontainers/r-nozzle.r1"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:35:06.276223"
...
```bash
$ shpc install quay.io/biocontainers/r-nozzle.r1
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-nozzle.r1:1.1_1--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-nozzle.r1/1.1_1--r3.2.2_0
$ module help quay.io/biocontainers/r-nozzle.r1/1.1_1--r3.2.2_0
```
...
#### r-nozzle.r1-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-nozzle.r1-inspect-deffile:
