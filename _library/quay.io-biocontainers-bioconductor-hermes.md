---
layout: container
name:  "quay.io/biocontainers/bioconductor-hermes"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:21:22.023101"
...
versions:
 - "1.2.0--r42hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-hermes"
config: {"url": "https://biocontainers.pro/tools/bioconductor-hermes", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-hermes", "latest": {"1.2.0--r42hdfd78af_0": "sha256:d0114e87b36438014071a76d0c65b409c8df13c11c8e2c277db9806ad8278cd4"}, "tags": {"1.2.0--r42hdfd78af_0": "sha256:d0114e87b36438014071a76d0c65b409c8df13c11c8e2c277db9806ad8278cd4"}, "docker": "quay.io/biocontainers/bioconductor-hermes", "aliases": {"installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-hermes.
singularity registry hpc automated addition for bioconductor-hermes
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-hermes
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-hermes:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hermes/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hermes/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-hermes-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-hermes-inspect-deffile:
