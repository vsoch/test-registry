---
layout: container
name:  "quay.io/biocontainers/kipoi-conda"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:06:05.441594"
latest: "0.1.6--py_0"
...
```bash
$ shpc install quay.io/biocontainers/kipoi-conda
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/kipoi-conda:0.1.6--py_0
```
...
```bash
$ module load quay.io/biocontainers/kipoi-conda/0.1.6--py_0
$ module help quay.io/biocontainers/kipoi-conda/0.1.6--py_0
```
...
#### kipoi-conda-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### kipoi-conda-inspect-deffile:
