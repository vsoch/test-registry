...
updated_at: "2023-03-10 03:23:02.549171"
...
```bash
$ shpc install quay.io/biocontainers/conus:1.0--hec16e2b_3
```
...
```bash
$ module load quay.io/biocontainers/conus/1.0--hec16e2b_3
$ module help quay.io/biocontainers/conus/1.0--hec16e2b_3
```
