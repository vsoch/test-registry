...
updated_at: "2023-03-09 03:12:53.739318"
...
```bash
$ shpc install quay.io/biocontainers/biobb_common:3.9.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_common/3.9.0--pyhdfd78af_0
$ module help quay.io/biocontainers/biobb_common/3.9.0--pyhdfd78af_0
```
