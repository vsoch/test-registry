---
layout: container
name:  "quay.io/biocontainers/tabview"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:35:37.115940"
...
```bash
$ shpc install quay.io/biocontainers/tabview
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/tabview:1.4.3--pyh4bbf42b_0
```
...
```bash
$ module load quay.io/biocontainers/tabview/1.4.3--pyh4bbf42b_0
$ module help quay.io/biocontainers/tabview/1.4.3--pyh4bbf42b_0
```
...
#### tabview-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### tabview-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/tabview
$ podman run --it --rm --entrypoint /usr/local/bin/tabview   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/tabview   -v ${PWD} -w ${PWD} <container> -c " $@"
```
