---
layout: container
name:  "quay.io/biocontainers/r-xnomial"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:13:12.647168"
latest: "1.0.4--0"
...
```bash
$ shpc install quay.io/biocontainers/r-xnomial
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-xnomial:1.0.4--0
```
...
```bash
$ module load quay.io/biocontainers/r-xnomial/1.0.4--0
$ module help quay.io/biocontainers/r-xnomial/1.0.4--0
```
...
#### r-xnomial-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-xnomial-inspect-deffile:
