---
layout: container
name:  "quay.io/biocontainers/cluster-picker"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:34:44.996750"
latest: "1.2.3--1"
...
```bash
$ shpc install quay.io/biocontainers/cluster-picker
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cluster-picker:1.2.3--1
```
...
```bash
$ module load quay.io/biocontainers/cluster-picker/1.2.3--1
$ module help quay.io/biocontainers/cluster-picker/1.2.3--1
```
...
#### cluster-picker-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cluster-picker-inspect-deffile:
