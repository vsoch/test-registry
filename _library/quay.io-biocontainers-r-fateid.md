---
layout: container
name:  "quay.io/biocontainers/r-fateid"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:31:41.384823"
...
```bash
$ shpc install quay.io/biocontainers/r-fateid
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-fateid:0.1.8--r36h6115d3f_0
```
...
```bash
$ module load quay.io/biocontainers/r-fateid/0.1.8--r36h6115d3f_0
$ module help quay.io/biocontainers/r-fateid/0.1.8--r36h6115d3f_0
```
...
#### r-fateid-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-fateid-inspect-deffile:
