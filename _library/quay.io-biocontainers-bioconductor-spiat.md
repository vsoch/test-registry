...
updated_at: "2023-03-09 03:30:16.615330"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spiat:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spiat/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spiat/1.0.0--r42hdfd78af_0
```
