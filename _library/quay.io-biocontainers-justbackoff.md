---
layout: container
name:  "quay.io/biocontainers/justbackoff"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:29:08.828987"
latest: "0.4.0--py_1"
...
```bash
$ shpc install quay.io/biocontainers/justbackoff
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/justbackoff:0.4.0--py_1
```
...
```bash
$ module load quay.io/biocontainers/justbackoff/0.4.0--py_1
$ module help quay.io/biocontainers/justbackoff/0.4.0--py_1
```
...
#### justbackoff-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### justbackoff-inspect-deffile:
