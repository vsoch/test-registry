---
layout: container
name:  "quay.io/biocontainers/perl-bio-db-embl"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/perl-bio-db-embl/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/perl-bio-db-embl/container.yaml"
updated_at: "2023-03-10 03:32:52.921578"
latest: "1.7.4--pl5321hdfd78af_0"
container_url: "https://biocontainers.pro/tools/perl-bio-db-embl"
aliases:
 - "bp_aacomp"
 - "bp_bioflat_index"
 - "bp_biogetseq"
...
description: "shpc-registry automated BioContainers addition for perl-bio-db-embl"
config: {"url": "https://biocontainers.pro/tools/perl-bio-db-embl", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for perl-bio-db-embl", "latest": {"1.7.4--pl5321hdfd78af_0": "sha256:bd83bdc8830e9e596b9a08b50d137bb21e748986efad5cdf5530e9fa98e549b7"}, "tags": {"1.7.4--pl5321hdfd78af_0": "sha256:bd83bdc8830e9e596b9a08b50d137bb21e748986efad5cdf5530e9fa98e549b7"}, "docker": "quay.io/biocontainers/perl-bio-db-embl", "aliases": {"bp_aacomp": "/usr/local/bin/bp_aacomp", "bp_bioflat_index": "/usr/local/bin/bp_bioflat_index", "bp_biogetseq": "/usr/local/bin/bp_biogetseq", "bp_dbsplit": "/usr/local/bin/bp_dbsplit", "bp_extract_feature_seq": "/usr/local/bin/bp_extract_feature_seq", "bp_fastam9_to_table": "/usr/local/bin/bp_fastam9_to_table", "bp_fetch": "/usr/local/bin/bp_fetch", "bp_filter_search": "/usr/local/bin/bp_filter_search", "bp_find-blast-matches": "/usr/local/bin/bp_find-blast-matches", "bp_gccalc": "/usr/local/bin/bp_gccalc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/perl-bio-db-embl.
shpc-registry automated BioContainers addition for perl-bio-db-embl
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/perl-bio-db-embl
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-bio-db-embl:1.7.4--pl5321hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/perl-bio-db-embl/1.7.4--pl5321hdfd78af_0
$ module help quay.io/biocontainers/perl-bio-db-embl/1.7.4--pl5321hdfd78af_0
```
...
#### perl-bio-db-embl-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-bio-db-embl-inspect-deffile:
