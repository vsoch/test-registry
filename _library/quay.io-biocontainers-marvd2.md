...
updated_at: "2023-03-09 03:34:46.543043"
...
```bash
$ shpc install quay.io/biocontainers/marvd2:0.11.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/marvd2/0.11.3--pyhdfd78af_0
$ module help quay.io/biocontainers/marvd2/0.11.3--pyhdfd78af_0
```
