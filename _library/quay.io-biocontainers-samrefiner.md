...
updated_at: "2023-03-09 03:31:38.281036"
...
```bash
$ shpc install quay.io/biocontainers/samrefiner:1.4--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/samrefiner/1.4--pyhdfd78af_0
$ module help quay.io/biocontainers/samrefiner/1.4--pyhdfd78af_0
```
