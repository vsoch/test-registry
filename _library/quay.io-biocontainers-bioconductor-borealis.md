---
layout: container
name:  "quay.io/biocontainers/bioconductor-borealis"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:06:29.671800"
...
versions:
 - "1.2.0--r42hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-borealis"
config: {"url": "https://biocontainers.pro/tools/bioconductor-borealis", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-borealis", "latest": {"1.2.0--r42hdfd78af_0": "sha256:be32856db44f40d3cda8c4d5ec16760e329419174e398e8c85a58aa782a86372"}, "tags": {"1.2.0--r42hdfd78af_0": "sha256:be32856db44f40d3cda8c4d5ec16760e329419174e398e8c85a58aa782a86372"}, "docker": "quay.io/biocontainers/bioconductor-borealis", "aliases": {"installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-borealis.
singularity registry hpc automated addition for bioconductor-borealis
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-borealis
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-borealis:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-borealis/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-borealis/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-borealis-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-borealis-inspect-deffile:
