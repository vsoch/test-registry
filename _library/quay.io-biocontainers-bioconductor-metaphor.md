---
layout: container
name:  "quay.io/biocontainers/bioconductor-metaphor"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:23:31.910128"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metaphor
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-metaphor:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metaphor/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metaphor/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-metaphor-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-metaphor-inspect-deffile:
