---
layout: container
name:  "quay.io/biocontainers/bioconductor-sccomp"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:16:12.789393"
latest: "1.1.0--r42hc247a5b_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sccomp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-sccomp:1.1.0--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sccomp/1.1.0--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-sccomp/1.1.0--r42hc247a5b_0
```
...
#### bioconductor-sccomp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-sccomp-inspect-deffile:
