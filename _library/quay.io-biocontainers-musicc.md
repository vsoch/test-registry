---
layout: container
name:  "quay.io/biocontainers/musicc"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:27:58.886304"
latest: "1.0.4--py_0"
...
```bash
$ shpc install quay.io/biocontainers/musicc
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/musicc:1.0.4--py_0
```
...
```bash
$ module load quay.io/biocontainers/musicc/1.0.4--py_0
$ module help quay.io/biocontainers/musicc/1.0.4--py_0
```
...
#### musicc-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### musicc-inspect-deffile:
