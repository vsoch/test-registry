---
layout: container
name:  "quay.io/biocontainers/savana"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:31:56.485056"
...
```bash
$ shpc install quay.io/biocontainers/savana
```
...
#### savana-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### savana-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/savana
$ podman run --it --rm --entrypoint /usr/local/bin/savana   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/savana   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/savana-validation
$ podman run --it --rm --entrypoint /usr/local/bin/savana-validation   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/savana-validation   -v ${PWD} -w ${PWD} <container> -c " $@"
```
