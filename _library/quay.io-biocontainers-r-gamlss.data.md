---
layout: container
name:  "quay.io/biocontainers/r-gamlss.data"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:00:49.936500"
...
```bash
$ shpc install quay.io/biocontainers/r-gamlss.data
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-gamlss.data:5.0_0--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-gamlss.data/5.0_0--r3.3.2_0
$ module help quay.io/biocontainers/r-gamlss.data/5.0_0--r3.3.2_0
```
...
#### r-gamlss.data-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-gamlss.data-inspect-deffile:
