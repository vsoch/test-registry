...
updated_at: "2023-03-09 02:58:36.155860"
...
```bash
$ shpc install quay.io/biocontainers/iphop:1.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/iphop/1.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/iphop/1.2.0--pyhdfd78af_0
```
