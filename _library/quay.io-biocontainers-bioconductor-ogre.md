---
layout: container
name:  "quay.io/biocontainers/bioconductor-ogre"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:16:45.826964"
...
versions:
 - "1.2.0--r42hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-ogre"
config: {"url": "https://biocontainers.pro/tools/bioconductor-ogre", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-ogre", "latest": {"1.2.0--r42hdfd78af_0": "sha256:dd57e43fbca24d72b47394cc62613bd48862089ba9c4ab3ecae542cfaf784e6a"}, "tags": {"1.2.0--r42hdfd78af_0": "sha256:dd57e43fbca24d72b47394cc62613bd48862089ba9c4ab3ecae542cfaf784e6a"}, "docker": "quay.io/biocontainers/bioconductor-ogre", "aliases": {"installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-ogre.
singularity registry hpc automated addition for bioconductor-ogre
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-ogre
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ogre:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ogre/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ogre/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-ogre-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ogre-inspect-deffile:
