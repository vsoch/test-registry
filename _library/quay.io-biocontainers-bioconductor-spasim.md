...
updated_at: "2023-03-10 03:35:06.792831"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-spasim:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spasim/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spasim/1.0.0--r42hdfd78af_0
```
