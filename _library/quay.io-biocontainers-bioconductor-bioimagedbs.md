...
updated_at: "2023-03-10 03:05:06.035019"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-bioimagedbs:1.6.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-bioimagedbs/1.6.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-bioimagedbs/1.6.0--r42hdfd78af_0
```
