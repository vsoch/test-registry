...
updated_at: "2023-03-09 03:13:58.774770"
...
```bash
$ shpc install quay.io/biocontainers/tbpore:0.4.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/tbpore/0.4.1--pyhdfd78af_0
$ module help quay.io/biocontainers/tbpore/0.4.1--pyhdfd78af_0
```
