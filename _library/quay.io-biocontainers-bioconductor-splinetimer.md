...
updated_at: "2023-03-09 03:39:41.243295"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-splinetimer:1.26.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-splinetimer/1.26.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-splinetimer/1.26.0--r42hdfd78af_0
```
