---
layout: container
name:  "quay.io/biocontainers/bioconductor-metabinr"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:05:00.643207"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-metabinr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-metabinr:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-metabinr/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-metabinr/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-metabinr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-metabinr-inspect-deffile:
