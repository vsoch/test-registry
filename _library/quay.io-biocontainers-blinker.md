---
layout: container
name:  "quay.io/biocontainers/blinker"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:22:02.146319"
latest: "1.4--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/blinker
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/blinker:1.4--py35_0
```
...
```bash
$ module load quay.io/biocontainers/blinker/1.4--py35_0
$ module help quay.io/biocontainers/blinker/1.4--py35_0
```
...
#### blinker-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### blinker-inspect-deffile:
