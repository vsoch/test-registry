---
layout: container
name:  "quay.io/biocontainers/gevent"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:31:24.039399"
...
```bash
$ shpc install quay.io/biocontainers/gevent
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/gevent:1.1rc4--py35_0
```
...
```bash
$ module load quay.io/biocontainers/gevent/1.1rc4--py35_0
$ module help quay.io/biocontainers/gevent/1.1rc4--py35_0
```
...
#### gevent-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gevent-inspect-deffile:
