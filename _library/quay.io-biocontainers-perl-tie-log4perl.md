---
layout: container
name:  "quay.io/biocontainers/perl-tie-log4perl"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:24:31.759806"
...
```bash
$ shpc install quay.io/biocontainers/perl-tie-log4perl
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-tie-log4perl:0.1--pl5321hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/perl-tie-log4perl/0.1--pl5321hdfd78af_2
$ module help quay.io/biocontainers/perl-tie-log4perl/0.1--pl5321hdfd78af_2
```
...
#### perl-tie-log4perl-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-tie-log4perl-inspect-deffile:
