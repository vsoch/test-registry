...
updated_at: "2023-03-09 03:39:08.394874"
...
```bash
$ shpc install quay.io/biocontainers/minute:0.2.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/minute/0.2.0--pyhdfd78af_0
$ module help quay.io/biocontainers/minute/0.2.0--pyhdfd78af_0
```
