...
updated_at: "2023-03-10 03:27:29.053877"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-raresim:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-raresim/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-raresim/1.2.0--r42hdfd78af_0
```
