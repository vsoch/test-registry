---
layout: container
name:  "quay.io/biocontainers/coprarna"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:22:21.600948"
...
```bash
$ module load quay.io/biocontainers/coprarna/2.1.4--hdfd78af_0
$ module help quay.io/biocontainers/coprarna/2.1.4--hdfd78af_0
```
...
#### coprarna-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### coprarna-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/CopraRNA2.pl
$ podman run --it --rm --entrypoint /usr/local/bin/CopraRNA2.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/CopraRNA2.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/IntaRNA_1ui.pl
$ podman run --it --rm --entrypoint /usr/local/bin/IntaRNA_1ui.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/IntaRNA_1ui.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/IntaRNA_up_1ui.pl
$ podman run --it --rm --entrypoint /usr/local/bin/IntaRNA_up_1ui.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/IntaRNA_up_1ui.pl   -v ${PWD} -w ${PWD} <container> -c " $@"
```
