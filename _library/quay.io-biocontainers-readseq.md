---
layout: container
name:  "quay.io/biocontainers/readseq"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:03:36.507639"
latest: "2.1.30--1"
...
```bash
$ shpc install quay.io/biocontainers/readseq
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/readseq:2.1.30--1
```
...
```bash
$ module load quay.io/biocontainers/readseq/2.1.30--1
$ module help quay.io/biocontainers/readseq/2.1.30--1
```
...
#### readseq-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### readseq-inspect-deffile:
