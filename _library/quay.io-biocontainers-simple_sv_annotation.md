---
layout: container
name:  "quay.io/biocontainers/simple_sv_annotation"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 02:59:44.103801"
...
```bash
$ shpc install quay.io/biocontainers/simple_sv_annotation
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/simple_sv_annotation:2019.02.18--py_0
```
...
```bash
$ module load quay.io/biocontainers/simple_sv_annotation/2019.02.18--py_0
$ module help quay.io/biocontainers/simple_sv_annotation/2019.02.18--py_0
```
...
#### simple_sv_annotation-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### simple_sv_annotation-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/simple_sv_annotation.py
$ podman run --it --rm --entrypoint /usr/local/bin/simple_sv_annotation.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/simple_sv_annotation.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
