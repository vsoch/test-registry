---
layout: container
name:  "quay.io/biocontainers/macse"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:10:10.637933"
...
```bash
$ shpc install quay.io/biocontainers/macse
```
...
#### macse-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### macse-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/macse
$ podman run --it --rm --entrypoint /usr/local/bin/macse   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/macse   -v ${PWD} -w ${PWD} <container> -c " $@"
```
