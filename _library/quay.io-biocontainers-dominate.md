---
layout: container
name:  "quay.io/biocontainers/dominate"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:34:35.555692"
...
```bash
$ shpc install quay.io/biocontainers/dominate
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/dominate:2.1.16--py36_0
```
...
```bash
$ module load quay.io/biocontainers/dominate/2.1.16--py36_0
$ module help quay.io/biocontainers/dominate/2.1.16--py36_0
```
...
#### dominate-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### dominate-inspect-deffile:
