---
layout: container
name:  "quay.io/biocontainers/python-consensuscore2"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:27:31.101162"
latest: "3.4.1--py27_0"
...
```bash
$ shpc install quay.io/biocontainers/python-consensuscore2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/python-consensuscore2:3.4.1--py27_0
```
...
```bash
$ module load quay.io/biocontainers/python-consensuscore2/3.4.1--py27_0
$ module help quay.io/biocontainers/python-consensuscore2/3.4.1--py27_0
```
...
#### python-consensuscore2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### python-consensuscore2-inspect-deffile:
