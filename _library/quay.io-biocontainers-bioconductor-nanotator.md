...
updated_at: "2023-03-10 03:16:36.057226"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-nanotator:1.14.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-nanotator/1.14.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-nanotator/1.14.0--r42hdfd78af_0
```
