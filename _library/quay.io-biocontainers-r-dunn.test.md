---
layout: container
name:  "quay.io/biocontainers/r-dunn.test"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:18:24.276108"
...
```bash
$ shpc install quay.io/biocontainers/r-dunn.test
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-dunn.test:1.3.1--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-dunn.test/1.3.1--r3.2.2_0
$ module help quay.io/biocontainers/r-dunn.test/1.3.1--r3.2.2_0
```
...
#### r-dunn.test-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-dunn.test-inspect-deffile:
