...
updated_at: "2023-03-10 03:36:49.290755"
...
```bash
$ shpc install quay.io/biocontainers/strling:0.5.1--h8a6b41c_3
```
...
```bash
$ module load quay.io/biocontainers/strling/0.5.1--h8a6b41c_3
$ module help quay.io/biocontainers/strling/0.5.1--h8a6b41c_3
```
