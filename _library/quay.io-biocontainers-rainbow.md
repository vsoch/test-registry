...
updated_at: "2023-03-09 03:39:55.307031"
latest: "2.0.4--hec16e2b_7"
...
```bash
$ shpc install quay.io/biocontainers/rainbow:2.0.4--hec16e2b_7
```
...
```bash
$ module load quay.io/biocontainers/rainbow/2.0.4--hec16e2b_7
$ module help quay.io/biocontainers/rainbow/2.0.4--hec16e2b_7
```
