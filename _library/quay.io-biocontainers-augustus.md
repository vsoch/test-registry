---
layout: container
name:  "quay.io/biocontainers/augustus"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:10:06.737033"
...
```bash
$ shpc install quay.io/biocontainers/augustus
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/augustus:3.5.0--pl5321hf46c7bb_1
```
...
```bash
$ module load quay.io/biocontainers/augustus/3.5.0--pl5321hf46c7bb_1
$ module help quay.io/biocontainers/augustus/3.5.0--pl5321hf46c7bb_1
```
...
#### augustus-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### augustus-inspect-deffile:
