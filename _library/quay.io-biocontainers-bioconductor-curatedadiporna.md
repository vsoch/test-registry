...
updated_at: "2023-03-09 03:03:46.638069"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-curatedadiporna:1.14.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-curatedadiporna/1.14.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-curatedadiporna/1.14.0--r42hdfd78af_0
```
