---
layout: container
name:  "quay.io/biocontainers/r-rismed"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:17:20.606334"
...
```bash
$ shpc install quay.io/biocontainers/r-rismed
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-rismed:2.1.7--r40h6115d3f_2
```
...
```bash
$ module load quay.io/biocontainers/r-rismed/2.1.7--r40h6115d3f_2
$ module help quay.io/biocontainers/r-rismed/2.1.7--r40h6115d3f_2
```
...
#### r-rismed-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-rismed-inspect-deffile:
