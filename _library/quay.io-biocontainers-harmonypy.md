---
layout: container
name:  "quay.io/biocontainers/harmonypy"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:08:53.942660"
...
```bash
$ shpc install quay.io/biocontainers/harmonypy
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/harmonypy:0.0.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/harmonypy/0.0.6--pyhdfd78af_0
$ module help quay.io/biocontainers/harmonypy/0.0.6--pyhdfd78af_0
```
...
#### harmonypy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### harmonypy-inspect-deffile:
