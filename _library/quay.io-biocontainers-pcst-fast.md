---
layout: container
name:  "quay.io/biocontainers/pcst-fast"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:39:39.140851"
...
config: {"url": "https://biocontainers.pro/tools/pcst-fast", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for pcst-fast", "latest": {"1.0.8--py36h2ad2d48_1": "sha256:a7573139b4c0938f808d4ede1fc153d6ba49ebf0f11a13f0380e4716c5f10eab"}, "tags": {"1.0.8--py36h2ad2d48_1": "sha256:a7573139b4c0938f808d4ede1fc153d6ba49ebf0f11a13f0380e4716c5f10eab"}, "docker": "quay.io/biocontainers/pcst-fast", "aliases": {"pybind11-config": "/usr/local/bin/pybind11-config", "2to3-3.6": "/usr/local/bin/2to3-3.6", "idle3.6": "/usr/local/bin/idle3.6", "pydoc3.6": "/usr/local/bin/pydoc3.6", "python3.6": "/usr/local/bin/python3.6", "python3.6-config": "/usr/local/bin/python3.6-config", "python3.6m": "/usr/local/bin/python3.6m", "python3.6m-config": "/usr/local/bin/python3.6m-config", "pyvenv-3.6": "/usr/local/bin/pyvenv-3.6", "pyvenv": "/usr/local/bin/pyvenv"}}
---
...
```bash
$ shpc install quay.io/biocontainers/pcst-fast
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pcst-fast:1.0.8--py36h2ad2d48_1
```
...
```bash
$ module load quay.io/biocontainers/pcst-fast/1.0.8--py36h2ad2d48_1
$ module help quay.io/biocontainers/pcst-fast/1.0.8--py36h2ad2d48_1
```
...
#### pcst-fast-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pcst-fast-inspect-deffile:
