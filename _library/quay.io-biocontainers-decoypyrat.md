---
layout: container
name:  "quay.io/biocontainers/decoypyrat"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:10:01.447967"
latest: "1.0.1--py_0"
...
```bash
$ shpc install quay.io/biocontainers/decoypyrat
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/decoypyrat:1.0.1--py_0
```
...
```bash
$ module load quay.io/biocontainers/decoypyrat/1.0.1--py_0
$ module help quay.io/biocontainers/decoypyrat/1.0.1--py_0
```
...
#### decoypyrat-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### decoypyrat-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/decoypyrat
$ podman run --it --rm --entrypoint /usr/local/bin/decoypyrat   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/decoypyrat   -v ${PWD} -w ${PWD} <container> -c " $@"
```
