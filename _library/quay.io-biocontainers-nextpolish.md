...
updated_at: "2023-03-10 03:12:45.359284"
latest: "1.4.1--py310h7132678_0"
...
```bash
$ shpc install quay.io/biocontainers/nextpolish:1.4.1--py310h7132678_0
```
...
```bash
$ module load quay.io/biocontainers/nextpolish/1.4.1--py310h7132678_0
$ module help quay.io/biocontainers/nextpolish/1.4.1--py310h7132678_0
```
