---
layout: container
name:  "quay.io/biocontainers/represent"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:28:56.395389"
latest: "1.5.1--py_2"
...
```bash
$ shpc install quay.io/biocontainers/represent
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/represent:1.5.1--py_2
```
...
```bash
$ module load quay.io/biocontainers/represent/1.5.1--py_2
$ module help quay.io/biocontainers/represent/1.5.1--py_2
```
...
#### represent-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### represent-inspect-deffile:
