---
layout: container
name:  "quay.io/biocontainers/m-party"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:30:31.529437"
...
versions:
 - "0.2.2--hdfd78af_0"
description: "singularity registry hpc automated addition for m-party"
config: {"url": "https://biocontainers.pro/tools/m-party", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for m-party", "latest": {"0.2.2--hdfd78af_0": "sha256:83269e576dc7ad79d145f860f8316973bdee0bb38aee2a8c41b1bcf393b8f411"}, "tags": {"0.2.2--hdfd78af_0": "sha256:83269e576dc7ad79d145f860f8316973bdee0bb38aee2a8c41b1bcf393b8f411"}, "docker": "quay.io/biocontainers/m-party", "aliases": {"CDHIT_parser.py": "/usr/local/bin/CDHIT_parser.py", "CDHIT_seq_download.py": "/usr/local/bin/CDHIT_seq_download.py", "DrawGram.jar": "/usr/local/bin/DrawGram.jar", "DrawTree.jar": "/usr/local/bin/DrawTree.jar", "TMalign": "/usr/local/bin/TMalign", "TMscore": "/usr/local/bin/TMscore", "UPIMAPI_parser.py": "/usr/local/bin/UPIMAPI_parser.py", "add_cluster_per_thresh.py": "/usr/local/bin/add_cluster_per_thresh.py", "bstats": "/usr/local/bin/bstats", "bundle": "/usr/local/bin/bundle", "bundler": "/usr/local/bin/bundler", "clique": "/usr/local/bin/clique", "comppair": "/usr/local/bin/comppair", "consense": "/usr/local/bin/consense", "contml": "/usr/local/bin/contml", "contrast": "/usr/local/bin/contrast", "conus_compare": "/usr/local/bin/conus_compare", "conus_train": "/usr/local/bin/conus_train", "dca": "/usr/local/bin/dca", "dialign-tx": "/usr/local/bin/dialign-tx", "dnacomp": "/usr/local/bin/dnacomp", "dnadist": "/usr/local/bin/dnadist", "dnainvar": "/usr/local/bin/dnainvar", "dnaml": "/usr/local/bin/dnaml", "dnamlk": "/usr/local/bin/dnamlk", "dnamove": "/usr/local/bin/dnamove", "dnapars": "/usr/local/bin/dnapars", "dnapenny": "/usr/local/bin/dnapenny", "docker_run.py": "/usr/local/bin/docker_run.py", "dollop": "/usr/local/bin/dollop", "dolmove": "/usr/local/bin/dolmove", "dolpenny": "/usr/local/bin/dolpenny", "drawgram": "/usr/local/bin/drawgram", "drawgram_gui": "/usr/local/bin/drawgram_gui", "drawtree": "/usr/local/bin/drawtree", "drawtree_gui": "/usr/local/bin/drawtree_gui", "dunamai": "/usr/local/bin/dunamai", "fakealigner": "/usr/local/bin/fakealigner", "faketree": "/usr/local/bin/faketree", "fasttreeMP": "/usr/local/bin/fasttreeMP", "firefox": "/usr/local/bin/firefox", "fitch": "/usr/local/bin/fitch", "geckodriver": "/usr/local/bin/geckodriver", "gendist": "/usr/local/bin/gendist", "hmm_process.py": "/usr/local/bin/hmm_process.py", "hmm_vali.py": "/usr/local/bin/hmm_vali.py", "hmmeralign": "/usr/local/bin/hmmeralign", "hmmerbuild": "/usr/local/bin/hmmerbuild", "hmmsearch_run.py": "/usr/local/bin/hmmsearch_run.py", "hyperopt-mongo-worker": "/usr/local/bin/hyperopt-mongo-worker", "kalign": "/usr/local/bin/kalign", "kitsch": "/usr/local/bin/kitsch", "m-party": "/usr/local/bin/m-party", "make_pscores.pl": "/usr/local/bin/make_pscores.pl", "matplotlib": "/usr/local/bin/matplotlib", "mix": "/usr/local/bin/mix", "move": "/usr/local/bin/move", "mustang": "/usr/local/bin/mustang", "neighbor": "/usr/local/bin/neighbor", "opal.jar": "/usr/local/bin/opal.jar", "pModel": "/usr/local/bin/pModel", "padaligner": "/usr/local/bin/padaligner", "pars": "/usr/local/bin/pars", "penny": "/usr/local/bin/penny", "phylip": "/usr/local/bin/phylip", "poa": "/usr/local/bin/poa", "probcons": "/usr/local/bin/probcons", "probconsRNA": "/usr/local/bin/probconsRNA", "proml": "/usr/local/bin/proml", "promlk": "/usr/local/bin/promlk", "protdist": "/usr/local/bin/protdist", "protpars": "/usr/local/bin/protpars", "racc": "/usr/local/bin/racc", "randtree": "/usr/local/bin/randtree", "raxml": "/usr/local/bin/raxml", "raxmlp": "/usr/local/bin/raxmlp", "rbs": "/usr/local/bin/rbs", "rdbg": "/usr/local/bin/rdbg", "restdist": "/usr/local/bin/restdist", "restml": "/usr/local/bin/restml", "retree": "/usr/local/bin/retree", "run_pasta.py": "/usr/local/bin/run_pasta.py", "run_pasta_gui.py": "/usr/local/bin/run_pasta_gui.py", "run_seqtools.py": "/usr/local/bin/run_seqtools.py", "sap": "/usr/local/bin/sap", "scalar": "/usr/local/bin/scalar", "scompare": "/usr/local/bin/scompare", "seq_download.py": "/usr/local/bin/seq_download.py", "seqboot": "/usr/local/bin/seqboot", "sfold": "/usr/local/bin/sfold", "snakemake_util.py": "/usr/local/bin/snakemake_util.py", "strain_ml": "/usr/local/bin/strain_ml", "t_coffee_run.py": "/usr/local/bin/t_coffee_run.py", "treedist": "/usr/local/bin/treedist", "typeprof": "/usr/local/bin/typeprof", "upimapi.py": "/usr/local/bin/upimapi.py", "clustalo": "/usr/local/bin/clustalo", "gdbm_dump": "/usr/local/bin/gdbm_dump", "gdbm_load": "/usr/local/bin/gdbm_load", "gdbmtool": "/usr/local/bin/gdbmtool", "prank": "/usr/local/bin/prank", "stone": "/usr/local/bin/stone", "plac_runner.py": "/usr/local/bin/plac_runner.py", "yte": "/usr/local/bin/yte", "bl2seq": "/usr/local/bin/bl2seq", "blastall": "/usr/local/bin/blastall", "blastclust": "/usr/local/bin/blastclust", "blastpgp": "/usr/local/bin/blastpgp", "copymat": "/usr/local/bin/copymat", "fastacmd": "/usr/local/bin/fastacmd", "formatdb": "/usr/local/bin/formatdb", "formatrpsdb": "/usr/local/bin/formatrpsdb", "git": "/usr/local/bin/git", "git-cvsserver": "/usr/local/bin/git-cvsserver", "git-receive-pack": "/usr/local/bin/git-receive-pack", "git-shell": "/usr/local/bin/git-shell", "git-upload-archive": "/usr/local/bin/git-upload-archive", "git-upload-pack": "/usr/local/bin/git-upload-pack", "gitk": "/usr/local/bin/gitk", "impala": "/usr/local/bin/impala", "makemat": "/usr/local/bin/makemat"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/m-party.
singularity registry hpc automated addition for m-party
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/m-party
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/m-party:0.2.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/m-party/0.2.2--hdfd78af_0
$ module help quay.io/biocontainers/m-party/0.2.2--hdfd78af_0
```
...
#### m-party-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### m-party-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/add_cluster_per_thresh.py
$ podman run --it --rm --entrypoint /usr/local/bin/add_cluster_per_thresh.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/add_cluster_per_thresh.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/m-party
$ podman run --it --rm --entrypoint /usr/local/bin/m-party   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/m-party   -v ${PWD} -w ${PWD} <container> -c " $@"
```
