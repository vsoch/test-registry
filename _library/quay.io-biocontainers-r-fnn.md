---
layout: container
name:  "quay.io/biocontainers/r-fnn"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:12:14.010005"
latest: "1.1--r3.4.1_0"
...
```bash
$ shpc install quay.io/biocontainers/r-fnn
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-fnn:1.1--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-fnn/1.1--r3.4.1_0
$ module help quay.io/biocontainers/r-fnn/1.1--r3.4.1_0
```
...
#### r-fnn-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-fnn-inspect-deffile:
