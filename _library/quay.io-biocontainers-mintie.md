...
updated_at: "2023-03-10 03:18:48.243344"
...
```bash
$ shpc install quay.io/biocontainers/mintie:0.4.2--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/mintie/0.4.2--hdfd78af_0
$ module help quay.io/biocontainers/mintie/0.4.2--hdfd78af_0
```
