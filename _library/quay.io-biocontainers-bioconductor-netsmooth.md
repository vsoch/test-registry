---
layout: container
name:  "quay.io/biocontainers/bioconductor-netsmooth"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:41:21.035223"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-netsmooth
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-netsmooth:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-netsmooth/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-netsmooth/1.18.0--r42hdfd78af_0
```
...
#### bioconductor-netsmooth-inspect:
...
#### bioconductor-netsmooth-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-netsmooth-inspect-deffile:
