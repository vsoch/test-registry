---
layout: container
name:  "quay.io/biocontainers/pytables"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:00:30.958817"
latest: "3.4.4"
...
```bash
$ shpc install quay.io/biocontainers/pytables
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pytables:3.4.4
```
...
```bash
$ module load quay.io/biocontainers/pytables/3.4.4
$ module help quay.io/biocontainers/pytables/3.4.4
```
...
#### pytables-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pytables-inspect-deffile:
