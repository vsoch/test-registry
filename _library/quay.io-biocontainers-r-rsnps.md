---
layout: container
name:  "quay.io/biocontainers/r-rsnps"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:01:51.866167"
...
```bash
$ shpc install quay.io/biocontainers/r-rsnps
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-rsnps:0.3.0--r40h6115d3f_2
```
...
```bash
$ module load quay.io/biocontainers/r-rsnps/0.3.0--r40h6115d3f_2
$ module help quay.io/biocontainers/r-rsnps/0.3.0--r40h6115d3f_2
```
...
#### r-rsnps-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-rsnps-inspect-deffile:
