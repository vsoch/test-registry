---
layout: container
name:  "quay.io/biocontainers/aniso8601"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:26:36.361497"
latest: "1.1.0--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/aniso8601
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/aniso8601:1.1.0--py36_0
```
...
```bash
$ module load quay.io/biocontainers/aniso8601/1.1.0--py36_0
$ module help quay.io/biocontainers/aniso8601/1.1.0--py36_0
```
...
#### aniso8601-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### aniso8601-inspect-deffile:
