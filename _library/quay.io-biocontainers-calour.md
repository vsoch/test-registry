---
layout: container
name:  "quay.io/biocontainers/calour"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:02:39.809748"
...
```bash
$ shpc install quay.io/biocontainers/calour
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/calour:2020.8.6--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/calour/2020.8.6--pyhdfd78af_0
$ module help quay.io/biocontainers/calour/2020.8.6--pyhdfd78af_0
```
...
#### calour-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### calour-inspect-deffile:
