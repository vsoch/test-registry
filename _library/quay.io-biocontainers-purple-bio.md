---
layout: container
name:  "quay.io/biocontainers/purple-bio"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:30:56.312126"
latest: "0.4.2.5--py_0"
...
```bash
$ shpc install quay.io/biocontainers/purple-bio
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/purple-bio:0.4.2.5--py_0
```
...
```bash
$ module load quay.io/biocontainers/purple-bio/0.4.2.5--py_0
$ module help quay.io/biocontainers/purple-bio/0.4.2.5--py_0
```
...
#### purple-bio-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### purple-bio-inspect-deffile:
