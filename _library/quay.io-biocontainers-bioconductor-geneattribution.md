...
updated_at: "2023-03-10 03:21:25.085199"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-geneattribution:1.24.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-geneattribution/1.24.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-geneattribution/1.24.0--r42hdfd78af_0
```
