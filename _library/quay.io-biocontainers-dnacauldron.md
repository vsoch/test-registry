...
updated_at: "2023-03-09 03:14:52.936717"
latest: "2.0.7--pyh5e36f6f_0"
...
```bash
$ shpc install quay.io/biocontainers/dnacauldron:2.0.7--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/dnacauldron/2.0.7--pyh5e36f6f_0
$ module help quay.io/biocontainers/dnacauldron/2.0.7--pyh5e36f6f_0
```
