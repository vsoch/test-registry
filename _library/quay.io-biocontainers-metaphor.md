...
updated_at: "2023-03-09 03:12:39.262399"
...
```bash
$ shpc install quay.io/biocontainers/metaphor:1.7.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metaphor/1.7.3--pyhdfd78af_0
$ module help quay.io/biocontainers/metaphor/1.7.3--pyhdfd78af_0
```
