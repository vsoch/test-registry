---
layout: container
name:  "quay.io/biocontainers/wtforms-components"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:28:33.419063"
...
```bash
$ shpc install quay.io/biocontainers/wtforms-components
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/wtforms-components:0.10.0--py36_0
```
...
```bash
$ module load quay.io/biocontainers/wtforms-components/0.10.0--py36_0
$ module help quay.io/biocontainers/wtforms-components/0.10.0--py36_0
```
...
#### wtforms-components-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### wtforms-components-inspect-deffile:
