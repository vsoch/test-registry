---
layout: container
name:  "quay.io/biocontainers/perl-cpan-meta-yaml"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:38:10.573489"
...
```bash
$ shpc install quay.io/biocontainers/perl-cpan-meta-yaml
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-cpan-meta-yaml:0.018--pl526_0
```
...
```bash
$ module load quay.io/biocontainers/perl-cpan-meta-yaml/0.018--pl526_0
$ module help quay.io/biocontainers/perl-cpan-meta-yaml/0.018--pl526_0
```
...
#### perl-cpan-meta-yaml-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-cpan-meta-yaml-inspect-deffile:
