---
layout: container
name:  "quay.io/biocontainers/snpsift"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:27:12.367001"
...
```bash
$ shpc install quay.io/biocontainers/snpsift
```
...
#### snpsift-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### snpsift-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/SnpSift
$ podman run --it --rm --entrypoint /usr/local/bin/SnpSift   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/SnpSift   -v ${PWD} -w ${PWD} <container> -c " $@"
```
