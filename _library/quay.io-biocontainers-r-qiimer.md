---
layout: container
name:  "quay.io/biocontainers/r-qiimer"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:07:16.606431"
...
```bash
$ shpc install quay.io/biocontainers/r-qiimer
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-qiimer:0.9.4--r3.4.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-qiimer/0.9.4--r3.4.1_0
$ module help quay.io/biocontainers/r-qiimer/0.9.4--r3.4.1_0
```
...
#### r-qiimer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-qiimer-inspect-deffile:
