---
layout: container
name:  "quay.io/biocontainers/r-fitdistrplus"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:03:05.908291"
...
```bash
$ shpc install quay.io/biocontainers/r-fitdistrplus
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-fitdistrplus:1.0_6--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-fitdistrplus/1.0_6--r3.2.2_0
$ module help quay.io/biocontainers/r-fitdistrplus/1.0_6--r3.2.2_0
```
...
#### r-fitdistrplus-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-fitdistrplus-inspect-deffile:
