...
updated_at: "2023-03-10 03:30:19.401591"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-trna:1.16.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-trna/1.16.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-trna/1.16.0--r42hdfd78af_0
```
