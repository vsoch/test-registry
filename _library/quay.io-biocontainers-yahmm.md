...
updated_at: "2023-03-09 03:24:55.854079"
...
```bash
$ shpc install quay.io/biocontainers/yahmm:1.1.3--py37h8902056_7
```
...
```bash
$ module load quay.io/biocontainers/yahmm/1.1.3--py37h8902056_7
$ module help quay.io/biocontainers/yahmm/1.1.3--py37h8902056_7
```
