---
layout: container
name:  "quay.io/biocontainers/pyroe"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:28:20.070493"
...
```bash
$ shpc install quay.io/biocontainers/pyroe
```
...
#### pyroe-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyroe-inspect-deffile:
