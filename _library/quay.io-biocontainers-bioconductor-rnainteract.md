---
layout: container
name:  "quay.io/biocontainers/bioconductor-rnainteract"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:34:20.037658"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rnainteract
```
...
#### bioconductor-rnainteract-shell:
...
#### bioconductor-rnainteract-inspect:
...
#### bioconductor-rnainteract-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-rnainteract-inspect-deffile:
