---
layout: container
name:  "quay.io/biocontainers/netifaces"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:39:09.969627"
...
```bash
$ shpc install quay.io/biocontainers/netifaces
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/netifaces:0.10.4--py36_1
```
...
```bash
$ module load quay.io/biocontainers/netifaces/0.10.4--py36_1
$ module help quay.io/biocontainers/netifaces/0.10.4--py36_1
```
...
#### netifaces-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### netifaces-inspect-deffile:
