---
layout: container
name:  "quay.io/biocontainers/conduit-assembler"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:18:41.499977"
...
versions:
 - "0.1.2--h14cfee4_1"
description: "shpc-registry automated BioContainers addition for conduit-assembler"
config: {"url": "https://biocontainers.pro/tools/conduit-assembler", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for conduit-assembler", "latest": {"0.1.2--h14cfee4_1": "sha256:b98582dad27b3e5d6460babd00e13135a3165699bc714d83c4be4940128bac30"}, "tags": {"0.1.2--h14cfee4_1": "sha256:b98582dad27b3e5d6460babd00e13135a3165699bc714d83c4be4940128bac30"}, "docker": "quay.io/biocontainers/conduit-assembler", "aliases": {"conduit": "/usr/local/bin/conduit", "conduitUtils": "/usr/local/bin/conduitUtils", "perl5.32.0": "/usr/local/bin/perl5.32.0", "bowtie2": "/usr/local/bin/bowtie2", "bowtie2-align-l": "/usr/local/bin/bowtie2-align-l", "bowtie2-align-s": "/usr/local/bin/bowtie2-align-s", "bowtie2-build": "/usr/local/bin/bowtie2-build", "bowtie2-build-l": "/usr/local/bin/bowtie2-build-l", "bowtie2-build-s": "/usr/local/bin/bowtie2-build-s", "bowtie2-inspect": "/usr/local/bin/bowtie2-inspect", "bowtie2-inspect-l": "/usr/local/bin/bowtie2-inspect-l", "bowtie2-inspect-s": "/usr/local/bin/bowtie2-inspect-s"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/conduit-assembler.
shpc-registry automated BioContainers addition for conduit-assembler
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/conduit-assembler
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/conduit-assembler:0.1.2--h14cfee4_1
```
...
```bash
$ module load quay.io/biocontainers/conduit-assembler/0.1.2--h14cfee4_1
$ module help quay.io/biocontainers/conduit-assembler/0.1.2--h14cfee4_1
```
...
#### conduit-assembler-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### conduit-assembler-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/conduit
$ podman run --it --rm --entrypoint /usr/local/bin/conduit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/conduit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/conduitUtils
$ podman run --it --rm --entrypoint /usr/local/bin/conduitUtils   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/conduitUtils   -v ${PWD} -w ${PWD} <container> -c " $@"
```
