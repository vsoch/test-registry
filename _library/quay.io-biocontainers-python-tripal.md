---
layout: container
name:  "quay.io/biocontainers/python-tripal"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:07:20.526459"
latest: "3.2.1--py_0"
...
```bash
$ shpc install quay.io/biocontainers/python-tripal
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/python-tripal:3.2.1--py_0
```
...
```bash
$ module load quay.io/biocontainers/python-tripal/3.2.1--py_0
$ module help quay.io/biocontainers/python-tripal/3.2.1--py_0
```
...
#### python-tripal-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### python-tripal-inspect-deffile:
