---
layout: container
name:  "quay.io/biocontainers/scitrack"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:16:15.598659"
...
```bash
$ shpc install quay.io/biocontainers/scitrack
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/scitrack:2021.5.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/scitrack/2021.5.3--pyhdfd78af_0
$ module help quay.io/biocontainers/scitrack/2021.5.3--pyhdfd78af_0
```
...
#### scitrack-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### scitrack-inspect-deffile:
