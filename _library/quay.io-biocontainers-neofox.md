---
layout: container
name:  "quay.io/biocontainers/neofox"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:10:33.639264"
...
```bash
$ shpc install quay.io/biocontainers/neofox
```
...
#### neofox-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### neofox-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/neofox
$ podman run --it --rm --entrypoint /usr/local/bin/neofox   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/neofox   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/neofox-configure
$ podman run --it --rm --entrypoint /usr/local/bin/neofox-configure   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/neofox-configure   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/neofox-epitope
$ podman run --it --rm --entrypoint /usr/local/bin/neofox-epitope   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/neofox-epitope   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/protoc-gen-grpclib_python
$ podman run --it --rm --entrypoint /usr/local/bin/protoc-gen-grpclib_python   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/protoc-gen-grpclib_python   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/protoc-gen-python_betterproto
$ podman run --it --rm --entrypoint /usr/local/bin/protoc-gen-python_betterproto   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/protoc-gen-python_betterproto   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/protoc-gen-python_grpc
$ podman run --it --rm --entrypoint /usr/local/bin/protoc-gen-python_grpc   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/protoc-gen-python_grpc   -v ${PWD} -w ${PWD} <container> -c " $@"
```
