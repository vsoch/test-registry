...
updated_at: "2023-03-09 03:14:53.555267"
...
```bash
$ shpc install quay.io/biocontainers/smudgeplot:0.2.5--py38r41hbff2b2d_0
```
...
```bash
$ module load quay.io/biocontainers/smudgeplot/0.2.5--py38r41hbff2b2d_0
$ module help quay.io/biocontainers/smudgeplot/0.2.5--py38r41hbff2b2d_0
```
