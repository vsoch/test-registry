---
layout: container
name:  "quay.io/biocontainers/joblib"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:15:41.241747"
latest: "0.9.3--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/joblib
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/joblib:0.9.3--py36_0
```
...
```bash
$ module load quay.io/biocontainers/joblib/0.9.3--py36_0
$ module help quay.io/biocontainers/joblib/0.9.3--py36_0
```
...
#### joblib-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### joblib-inspect-deffile:
