...
updated_at: "2023-03-09 03:13:49.377287"
latest: "0.7.1--h4a94de4_0"
...
```bash
$ shpc install quay.io/biocontainers/nf-test:0.7.1--h4a94de4_0
```
...
```bash
$ module load quay.io/biocontainers/nf-test/0.7.1--h4a94de4_0
$ module help quay.io/biocontainers/nf-test/0.7.1--h4a94de4_0
```
