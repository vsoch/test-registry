---
layout: container
name:  "quay.io/biocontainers/fgsv"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:30:33.387210"
...
```bash
$ shpc install quay.io/biocontainers/fgsv
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/fgsv:0.0.1--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgsv/0.0.1--hdfd78af_0
$ module help quay.io/biocontainers/fgsv/0.0.1--hdfd78af_0
```
...
#### fgsv-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### fgsv-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/fgsv
$ podman run --it --rm --entrypoint /usr/local/bin/fgsv   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fgsv   -v ${PWD} -w ${PWD} <container> -c " $@"
```
