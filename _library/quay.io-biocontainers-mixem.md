---
layout: container
name:  "quay.io/biocontainers/mixem"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:25:00.883250"
...
```bash
$ shpc install quay.io/biocontainers/mixem
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mixem:0.1.4--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/mixem/0.1.4--pyh5e36f6f_0
$ module help quay.io/biocontainers/mixem/0.1.4--pyh5e36f6f_0
```
...
#### mixem-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mixem-inspect-deffile:
