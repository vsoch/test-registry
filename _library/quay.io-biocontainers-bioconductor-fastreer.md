---
layout: container
name:  "quay.io/biocontainers/bioconductor-fastreer"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:18:36.565941"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-fastreer
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-fastreer:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-fastreer/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-fastreer/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-fastreer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-fastreer-inspect-deffile:
