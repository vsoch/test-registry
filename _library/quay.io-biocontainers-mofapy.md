---
layout: container
name:  "quay.io/biocontainers/mofapy"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:35:21.661328"
latest: "1.2--py_1"
...
```bash
$ shpc install quay.io/biocontainers/mofapy
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/mofapy:1.2--py_1
```
...
```bash
$ module load quay.io/biocontainers/mofapy/1.2--py_1
$ module help quay.io/biocontainers/mofapy/1.2--py_1
```
...
#### mofapy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### mofapy-inspect-deffile:
