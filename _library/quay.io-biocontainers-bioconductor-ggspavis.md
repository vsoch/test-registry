---
layout: container
name:  "quay.io/biocontainers/bioconductor-ggspavis"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:05:54.600655"
...
config: {"url": "https://biocontainers.pro/tools/bioconductor-ggspavis", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for bioconductor-ggspavis", "latest": {"1.4.0--r42hdfd78af_0": "sha256:01b7aec1a9955992be9cf5c634c444d5b8c23d19d9858030d23e5aaf5bd49a8e"}, "tags": {"1.0.0--r41hdfd78af_0": "sha256:e727994d062f2b42a8e95dd154a7113415e708db084425fd44c86b359d912c02", "1.4.0--r42hdfd78af_0": "sha256:01b7aec1a9955992be9cf5c634c444d5b8c23d19d9858030d23e5aaf5bd49a8e"}, "docker": "quay.io/biocontainers/bioconductor-ggspavis", "aliases": {"x86_64-conda-linux-gnu-pkg-config": "/usr/local/bin/x86_64-conda-linux-gnu-pkg-config", "Magick++-config": "/usr/local/bin/Magick++-config", "MagickCore-config": "/usr/local/bin/MagickCore-config", "MagickWand-config": "/usr/local/bin/MagickWand-config", "animate": "/usr/local/bin/animate", "composite": "/usr/local/bin/composite", "conjure": "/usr/local/bin/conjure", "convert": "/usr/local/bin/convert", "display": "/usr/local/bin/display", "identify": "/usr/local/bin/identify"}}
---
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ggspavis
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ggspavis:1.4.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ggspavis/1.4.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ggspavis/1.4.0--r42hdfd78af_0
```
...
#### bioconductor-ggspavis-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ggspavis-inspect-deffile:
