---
layout: container
name:  "quay.io/biocontainers/lcfit"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:42:06.544021"
...
```bash
$ shpc install quay.io/biocontainers/lcfit
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/lcfit:0.5--h20b91ae_3
```
...
```bash
$ module load quay.io/biocontainers/lcfit/0.5--h20b91ae_3
$ module help quay.io/biocontainers/lcfit/0.5--h20b91ae_3
```
...
#### lcfit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### lcfit-inspect-deffile:
