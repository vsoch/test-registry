...
updated_at: "2023-03-10 03:18:29.134243"
latest: "1.7.1--py39hbf8eff0_1"
...
```bash
$ shpc install quay.io/biocontainers/pegasuspy:1.7.1--py39hbf8eff0_1
```
...
```bash
$ module load quay.io/biocontainers/pegasuspy/1.7.1--py39hbf8eff0_1
$ module help quay.io/biocontainers/pegasuspy/1.7.1--py39hbf8eff0_1
```
