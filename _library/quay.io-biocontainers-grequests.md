---
layout: container
name:  "quay.io/biocontainers/grequests"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:07:36.298739"
latest: "0.3.0--py36_1"
...
```bash
$ shpc install quay.io/biocontainers/grequests
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/grequests:0.3.0--py36_1
```
...
```bash
$ module load quay.io/biocontainers/grequests/0.3.0--py36_1
$ module help quay.io/biocontainers/grequests/0.3.0--py36_1
```
...
#### grequests-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### grequests-inspect-deffile:
