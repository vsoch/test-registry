...
updated_at: "2023-03-10 03:44:02.792687"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-stjoincount:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-stjoincount/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-stjoincount/1.0.0--r42hdfd78af_0
```
