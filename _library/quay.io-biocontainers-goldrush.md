...
updated_at: "2023-03-09 03:33:36.631905"
latest: "1.0.2--py39h243b37b_0"
...
```bash
$ shpc install quay.io/biocontainers/goldrush:1.0.2--py39h243b37b_0
```
...
```bash
$ module load quay.io/biocontainers/goldrush/1.0.2--py39h243b37b_0
$ module help quay.io/biocontainers/goldrush/1.0.2--py39h243b37b_0
```
