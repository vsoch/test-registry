...
updated_at: "2023-03-09 03:12:01.781766"
latest: "1.5.5--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-shinyngs:1.5.5--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-shinyngs/1.5.5--r42hdfd78af_0
$ module help quay.io/biocontainers/r-shinyngs/1.5.5--r42hdfd78af_0
```
