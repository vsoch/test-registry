---
layout: container
name:  "quay.io/biocontainers/r-fail"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:33:52.751824"
latest: "1.3--r3.2.2_0"
...
```bash
$ shpc install quay.io/biocontainers/r-fail
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-fail:1.3--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-fail/1.3--r3.2.2_0
$ module help quay.io/biocontainers/r-fail/1.3--r3.2.2_0
```
...
#### r-fail-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-fail-inspect-deffile:
