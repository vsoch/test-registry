---
layout: container
name:  "quay.io/biocontainers/r-gprofiler"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:37:45.367843"
...
```bash
$ shpc install quay.io/biocontainers/r-gprofiler
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-gprofiler:0.6.1--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-gprofiler/0.6.1--r3.3.1_0
$ module help quay.io/biocontainers/r-gprofiler/0.6.1--r3.3.1_0
```
...
#### r-gprofiler-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-gprofiler-inspect-deffile:
