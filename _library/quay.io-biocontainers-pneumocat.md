---
layout: container
name:  "quay.io/biocontainers/pneumocat"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:41:25.977290"
latest: "1.2--3"
...
```bash
$ shpc install quay.io/biocontainers/pneumocat
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pneumocat:1.2--3
```
...
```bash
$ module load quay.io/biocontainers/pneumocat/1.2--3
$ module help quay.io/biocontainers/pneumocat/1.2--3
```
...
#### pneumocat-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pneumocat-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/PneumoCaT.py
$ podman run --it --rm --entrypoint /usr/local/bin/PneumoCaT.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/PneumoCaT.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
