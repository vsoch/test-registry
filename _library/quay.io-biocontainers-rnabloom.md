...
updated_at: "2023-03-10 03:26:16.338627"
...
```bash
$ shpc install quay.io/biocontainers/rnabloom:2.0.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rnabloom/2.0.0--hdfd78af_0
$ module help quay.io/biocontainers/rnabloom/2.0.0--hdfd78af_0
```
