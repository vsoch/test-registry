---
layout: container
name:  "quay.io/biocontainers/haptools"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:33:26.009006"
...
```bash
$ shpc install quay.io/biocontainers/haptools
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/haptools:0.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/haptools/0.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/haptools/0.1.3--pyhdfd78af_0
```
...
#### haptools-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### haptools-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/haptools
$ podman run --it --rm --entrypoint /usr/local/bin/haptools   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/haptools   -v ${PWD} -w ${PWD} <container> -c " $@"
```
