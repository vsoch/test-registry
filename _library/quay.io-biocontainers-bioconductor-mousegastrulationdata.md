---
layout: container
name:  "quay.io/biocontainers/bioconductor-mousegastrulationdata"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:31:20.391710"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mousegastrulationdata
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-mousegastrulationdata:1.12.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-mousegastrulationdata/1.12.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-mousegastrulationdata/1.12.0--r42hdfd78af_0
```
...
#### bioconductor-mousegastrulationdata-run:
...
#### bioconductor-mousegastrulationdata-shell:
...
#### bioconductor-mousegastrulationdata-exec:
...
#### bioconductor-mousegastrulationdata-inspect:
...
#### bioconductor-mousegastrulationdata-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-mousegastrulationdata-inspect-deffile:
