---
layout: container
name:  "quay.io/biocontainers/bioconductor-octad.db"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:07:13.278393"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-octad.db
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-octad.db:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-octad.db/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-octad.db/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-octad.db-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-octad.db-inspect-deffile:
