...
updated_at: "2023-03-10 03:21:59.420697"
...
```bash
$ shpc install quay.io/biocontainers/ddocent:2.9.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ddocent/2.9.4--hdfd78af_0
$ module help quay.io/biocontainers/ddocent/2.9.4--hdfd78af_0
```
