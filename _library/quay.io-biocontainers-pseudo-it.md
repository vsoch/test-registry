---
layout: container
name:  "quay.io/biocontainers/pseudo-it"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:14:44.596508"
...
```bash
$ shpc install quay.io/biocontainers/pseudo-it
```
...
#### pseudo-it-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pseudo-it-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/pseudo_it.py
$ podman run --it --rm --entrypoint /usr/local/bin/pseudo_it.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pseudo_it.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
