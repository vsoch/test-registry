---
layout: container
name:  "quay.io/biocontainers/bioconductor-mouse430a2cdf"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:27:41.442482"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-mouse430a2cdf
```
...
#### bioconductor-mouse430a2cdf-run:
...
#### bioconductor-mouse430a2cdf-shell:
...
#### bioconductor-mouse430a2cdf-exec:
...
#### bioconductor-mouse430a2cdf-inspect:
...
#### bioconductor-mouse430a2cdf-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-mouse430a2cdf-inspect-deffile:
