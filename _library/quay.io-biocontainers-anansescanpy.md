---
layout: container
name:  "quay.io/biocontainers/anansescanpy"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:18:00.347858"
...
```bash
$ shpc install quay.io/biocontainers/anansescanpy
```
...
#### anansescanpy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### anansescanpy-inspect-deffile:
