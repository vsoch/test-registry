---
layout: container
name:  "quay.io/biocontainers/pymot"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:27:14.184311"
...
```bash
$ shpc install quay.io/biocontainers/pymot
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pymot:13.09.2016--py_2
```
...
```bash
$ module load quay.io/biocontainers/pymot/13.09.2016--py_2
$ module help quay.io/biocontainers/pymot/13.09.2016--py_2
```
...
#### pymot-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pymot-inspect-deffile:
