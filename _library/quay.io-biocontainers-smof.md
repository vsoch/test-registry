---
layout: container
name:  "quay.io/biocontainers/smof"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:10:43.432065"
...
```bash
$ shpc install quay.io/biocontainers/smof
```
...
#### smof-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### smof-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/smof
$ podman run --it --rm --entrypoint /usr/local/bin/smof   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/smof   -v ${PWD} -w ${PWD} <container> -c " $@"
```
