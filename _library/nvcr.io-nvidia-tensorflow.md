...
updated_at: "2023-03-10 02:57:40.962649"
latest: "23.01-tf2-py3"
...
```bash
$ shpc install nvcr.io/nvidia/tensorflow:23.01-tf2-py3
```
...
```bash
$ module load nvcr.io/nvidia/tensorflow/23.01-tf2-py3
$ module help nvcr.io/nvidia/tensorflow/23.01-tf2-py3
```
