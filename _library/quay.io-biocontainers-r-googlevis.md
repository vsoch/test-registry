---
layout: container
name:  "quay.io/biocontainers/r-googlevis"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:02:11.597933"
...
```bash
$ shpc install quay.io/biocontainers/r-googlevis
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-googlevis:0.5.10--r3.2.2_1
```
...
```bash
$ module load quay.io/biocontainers/r-googlevis/0.5.10--r3.2.2_1
$ module help quay.io/biocontainers/r-googlevis/0.5.10--r3.2.2_1
```
...
#### r-googlevis-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-googlevis-inspect-deffile:
