...
updated_at: "2023-03-10 03:31:08.283658"
...
```bash
$ shpc install quay.io/biocontainers/hmnfusion:1.2.6--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/hmnfusion/1.2.6--pyh7cba7a3_0
$ module help quay.io/biocontainers/hmnfusion/1.2.6--pyh7cba7a3_0
```
