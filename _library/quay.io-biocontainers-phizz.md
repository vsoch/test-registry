---
layout: container
name:  "quay.io/biocontainers/phizz"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:24:54.579197"
latest: "0.2.3--py_0"
...
```bash
$ shpc install quay.io/biocontainers/phizz
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/phizz:0.2.3--py_0
```
...
```bash
$ module load quay.io/biocontainers/phizz/0.2.3--py_0
$ module help quay.io/biocontainers/phizz/0.2.3--py_0
```
...
#### phizz-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### phizz-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/phizz
$ podman run --it --rm --entrypoint /usr/local/bin/phizz   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/phizz   -v ${PWD} -w ${PWD} <container> -c " $@"
```
