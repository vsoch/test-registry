---
layout: container
name:  "quay.io/biocontainers/intervals"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:39:37.132872"
latest: "0.6.0--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/intervals
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/intervals:0.6.0--py36_0
```
...
```bash
$ module load quay.io/biocontainers/intervals/0.6.0--py36_0
$ module help quay.io/biocontainers/intervals/0.6.0--py36_0
```
...
#### intervals-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### intervals-inspect-deffile:
