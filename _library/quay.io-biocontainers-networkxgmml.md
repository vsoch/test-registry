---
layout: container
name:  "quay.io/biocontainers/networkxgmml"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:27:38.463960"
latest: "0.1.6--py_2"
...
```bash
$ shpc install quay.io/biocontainers/networkxgmml
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/networkxgmml:0.1.6--py_2
```
...
```bash
$ module load quay.io/biocontainers/networkxgmml/0.1.6--py_2
$ module help quay.io/biocontainers/networkxgmml/0.1.6--py_2
```
...
#### networkxgmml-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### networkxgmml-inspect-deffile:
