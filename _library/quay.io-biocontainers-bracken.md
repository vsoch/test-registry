...
updated_at: "2023-03-09 03:01:53.731172"
...
```bash
$ shpc install quay.io/biocontainers/bracken:2.6.2--py39hc16433a_0
```
...
```bash
$ module load quay.io/biocontainers/bracken/2.6.2--py39hc16433a_0
$ module help quay.io/biocontainers/bracken/2.6.2--py39hc16433a_0
```
