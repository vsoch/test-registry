...
updated_at: "2023-03-09 03:17:29.345092"
latest: "2.23--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/lotus2:2.23--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/lotus2/2.23--hdfd78af_0
$ module help quay.io/biocontainers/lotus2/2.23--hdfd78af_0
```
