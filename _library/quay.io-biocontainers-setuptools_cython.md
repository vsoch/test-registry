---
layout: container
name:  "quay.io/biocontainers/setuptools_cython"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:02:03.976203"
...
```bash
$ shpc install quay.io/biocontainers/setuptools_cython
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/setuptools_cython:0.2.1--pyh864c0ab_4
```
...
```bash
$ module load quay.io/biocontainers/setuptools_cython/0.2.1--pyh864c0ab_4
$ module help quay.io/biocontainers/setuptools_cython/0.2.1--pyh864c0ab_4
```
...
#### setuptools_cython-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### setuptools_cython-inspect-deffile:
