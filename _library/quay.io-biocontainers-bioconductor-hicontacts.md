---
layout: container
name:  "quay.io/biocontainers/bioconductor-hicontacts"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:07:16.610333"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-hicontacts
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-hicontacts:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-hicontacts/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-hicontacts/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-hicontacts-inspect:
...
#### bioconductor-hicontacts-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-hicontacts-inspect-deffile:
