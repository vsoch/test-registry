---
layout: container
name:  "quay.io/biocontainers/megapath-nano"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:06:23.112501"
latest: "2--hee3b9ab_0"
...
```bash
$ module load quay.io/biocontainers/megapath-nano/2--hee3b9ab_0
$ module help quay.io/biocontainers/megapath-nano/2--hee3b9ab_0
```
...
#### megapath-nano-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### megapath-nano-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/megapath_nano.py
$ podman run --it --rm --entrypoint /usr/local/bin/megapath_nano.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/megapath_nano.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/megapath_nano_amr.py
$ podman run --it --rm --entrypoint /usr/local/bin/megapath_nano_amr.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/megapath_nano_amr.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
