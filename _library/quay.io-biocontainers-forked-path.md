---
layout: container
name:  "quay.io/biocontainers/forked-path"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:28:36.099107"
latest: "0.2.3--py27_2"
...
```bash
$ shpc install quay.io/biocontainers/forked-path
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/forked-path:0.2.3--py27_2
```
...
```bash
$ module load quay.io/biocontainers/forked-path/0.2.3--py27_2
$ module help quay.io/biocontainers/forked-path/0.2.3--py27_2
```
...
#### forked-path-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### forked-path-inspect-deffile:
