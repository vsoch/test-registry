...
updated_at: "2023-03-09 03:34:05.148730"
latest: "3.0.7--pyh5e36f6f_0"
...
```bash
$ shpc install quay.io/biocontainers/dbcan:3.0.7--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/dbcan/3.0.7--pyh5e36f6f_0
$ module help quay.io/biocontainers/dbcan/3.0.7--pyh5e36f6f_0
```
