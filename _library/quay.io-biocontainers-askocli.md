---
layout: container
name:  "quay.io/biocontainers/askocli"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:34:44.073639"
latest: "0.5--py_0"
...
```bash
$ shpc install quay.io/biocontainers/askocli
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/askocli:0.5--py_0
```
...
```bash
$ module load quay.io/biocontainers/askocli/0.5--py_0
$ module help quay.io/biocontainers/askocli/0.5--py_0
```
...
#### askocli-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### askocli-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/askocli
$ podman run --it --rm --entrypoint /usr/local/bin/askocli   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/askocli   -v ${PWD} -w ${PWD} <container> -c " $@"
```
