...
updated_at: "2023-03-10 03:02:58.957265"
latest: "1.3.8--py39h6935b12_0"
...
```bash
$ shpc install quay.io/biocontainers/ntlink:1.3.8--py39h6935b12_0
```
...
```bash
$ module load quay.io/biocontainers/ntlink/1.3.8--py39h6935b12_0
$ module help quay.io/biocontainers/ntlink/1.3.8--py39h6935b12_0
```
