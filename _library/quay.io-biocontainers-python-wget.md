---
layout: container
name:  "quay.io/biocontainers/python-wget"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:31:12.687002"
latest: "3.2--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/python-wget
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/python-wget:3.2--py36_0
```
...
```bash
$ module load quay.io/biocontainers/python-wget/3.2--py36_0
$ module help quay.io/biocontainers/python-wget/3.2--py36_0
```
...
#### python-wget-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### python-wget-inspect-deffile:
