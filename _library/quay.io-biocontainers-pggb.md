...
updated_at: "2023-03-10 02:59:26.129690"
latest: "0.5.3--hdfd78af_2"
...
```bash
$ shpc install quay.io/biocontainers/pggb:0.5.3--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/pggb/0.5.3--hdfd78af_2
$ module help quay.io/biocontainers/pggb/0.5.3--hdfd78af_2
```
