---
layout: container
name:  "quay.io/biocontainers/suds-jurko"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:56:55.387147"
latest: "0.6--py36_1"
...
```bash
$ shpc install quay.io/biocontainers/suds-jurko
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/suds-jurko:0.6--py36_1
```
...
```bash
$ module load quay.io/biocontainers/suds-jurko/0.6--py36_1
$ module help quay.io/biocontainers/suds-jurko/0.6--py36_1
```
...
#### suds-jurko-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### suds-jurko-inspect-deffile:
