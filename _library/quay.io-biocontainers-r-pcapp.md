---
layout: container
name:  "quay.io/biocontainers/r-pcapp"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:19:50.706725"
...
```bash
$ shpc install quay.io/biocontainers/r-pcapp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-pcapp:1.9_60--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-pcapp/1.9_60--r3.2.2_0
$ module help quay.io/biocontainers/r-pcapp/1.9_60--r3.2.2_0
```
...
#### r-pcapp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-pcapp-inspect-deffile:
