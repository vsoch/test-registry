...
updated_at: "2023-03-10 03:33:54.868753"
latest: "1.1.0--h7132678_3"
...
```bash
$ shpc install quay.io/biocontainers/super_distance:1.1.0--h7132678_3
```
...
```bash
$ module load quay.io/biocontainers/super_distance/1.1.0--h7132678_3
$ module help quay.io/biocontainers/super_distance/1.1.0--h7132678_3
```
