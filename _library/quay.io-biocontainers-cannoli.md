---
layout: container
name:  "quay.io/biocontainers/cannoli"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:29:50.604431"
...
```bash
$ shpc install quay.io/biocontainers/cannoli
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cannoli:1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cannoli/1.0--hdfd78af_0
$ module help quay.io/biocontainers/cannoli/1.0--hdfd78af_0
```
...
#### cannoli-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cannoli-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cannoli-shell
$ podman run --it --rm --entrypoint /usr/local/bin/cannoli-shell   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cannoli-shell   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/cannoli-submit
$ podman run --it --rm --entrypoint /usr/local/bin/cannoli-submit   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cannoli-submit   -v ${PWD} -w ${PWD} <container> -c " $@"
```
