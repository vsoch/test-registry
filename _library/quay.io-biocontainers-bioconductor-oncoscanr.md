---
layout: container
name:  "quay.io/biocontainers/bioconductor-oncoscanr"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:01:24.594225"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-oncoscanr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-oncoscanr:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-oncoscanr/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-oncoscanr/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-oncoscanr-inspect:
...
#### bioconductor-oncoscanr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-oncoscanr-inspect-deffile:
