---
layout: container
name:  "quay.io/biocontainers/arrow"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:29:07.198901"
latest: "0.7.0--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/arrow
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/arrow:0.7.0--py36_0
```
...
```bash
$ module load quay.io/biocontainers/arrow/0.7.0--py36_0
$ module help quay.io/biocontainers/arrow/0.7.0--py36_0
```
...
#### arrow-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### arrow-inspect-deffile:
