---
layout: container
name:  "quay.io/biocontainers/r-matrixeqtl"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:01:23.986840"
...
```bash
$ shpc install quay.io/biocontainers/r-matrixeqtl
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-matrixeqtl:2.1.1--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-matrixeqtl/2.1.1--r3.3.1_0
$ module help quay.io/biocontainers/r-matrixeqtl/2.1.1--r3.3.1_0
```
...
#### r-matrixeqtl-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-matrixeqtl-inspect-deffile:
