...
updated_at: "2023-03-10 03:34:22.468960"
latest: "0.5.4--py310h1425a21_0"
...
```bash
$ shpc install quay.io/biocontainers/cooltools:0.5.4--py310h1425a21_0
```
...
```bash
$ module load quay.io/biocontainers/cooltools/0.5.4--py310h1425a21_0
$ module help quay.io/biocontainers/cooltools/0.5.4--py310h1425a21_0
```
