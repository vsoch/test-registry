---
layout: container
name:  "quay.io/biocontainers/r-kaos"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:01:09.233580"
...
```bash
$ shpc install quay.io/biocontainers/r-kaos
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-kaos:0.1.0--r351h6115d3f_0
```
...
```bash
$ module load quay.io/biocontainers/r-kaos/0.1.0--r351h6115d3f_0
$ module help quay.io/biocontainers/r-kaos/0.1.0--r351h6115d3f_0
```
...
#### r-kaos-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-kaos-inspect-deffile:
