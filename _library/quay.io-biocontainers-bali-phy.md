...
updated_at: "2023-03-10 03:02:31.982352"
...
```bash
$ shpc install quay.io/biocontainers/bali-phy:3.6.0--py310h3bbb02d_1
```
...
```bash
$ module load quay.io/biocontainers/bali-phy/3.6.0--py310h3bbb02d_1
$ module help quay.io/biocontainers/bali-phy/3.6.0--py310h3bbb02d_1
```
