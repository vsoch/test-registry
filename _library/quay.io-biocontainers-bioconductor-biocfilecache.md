...
updated_at: "2023-03-09 03:31:29.498933"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-biocfilecache:2.6.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-biocfilecache/2.6.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-biocfilecache/2.6.0--r42hdfd78af_0
```
