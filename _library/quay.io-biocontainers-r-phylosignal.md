---
layout: container
name:  "quay.io/biocontainers/r-phylosignal"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:19:22.450583"
...
```bash
$ shpc install quay.io/biocontainers/r-phylosignal
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-phylosignal:1.2--r351h29659fb_3
```
...
```bash
$ module load quay.io/biocontainers/r-phylosignal/1.2--r351h29659fb_3
$ module help quay.io/biocontainers/r-phylosignal/1.2--r351h29659fb_3
```
...
#### r-phylosignal-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-phylosignal-inspect-deffile:
