...
updated_at: "2023-03-10 03:40:17.333971"
...
```bash
$ shpc install quay.io/biocontainers/genewalk:1.5.3--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/genewalk/1.5.3--pyh5e36f6f_0
$ module help quay.io/biocontainers/genewalk/1.5.3--pyh5e36f6f_0
```
