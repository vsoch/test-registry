...
updated_at: "2023-03-09 02:57:02.831675"
...
```bash
$ shpc install quay.io/biocontainers/drep:3.4.2--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/drep/3.4.2--pyhdfd78af_0
$ module help quay.io/biocontainers/drep/3.4.2--pyhdfd78af_0
```
