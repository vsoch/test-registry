---
layout: container
name:  "quay.io/biocontainers/bioconductor-findit2"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:03:03.253924"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-findit2
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-findit2:1.4.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-findit2/1.4.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-findit2/1.4.0--r42hdfd78af_0
```
...
#### bioconductor-findit2-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-findit2-inspect-deffile:
