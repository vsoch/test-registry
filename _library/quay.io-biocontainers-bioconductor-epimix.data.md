---
layout: container
name:  "quay.io/biocontainers/bioconductor-epimix.data"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:30:51.347714"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-epimix.data
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-epimix.data:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-epimix.data/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-epimix.data/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-epimix.data-shell:
...
#### bioconductor-epimix.data-inspect:
...
#### bioconductor-epimix.data-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-epimix.data-inspect-deffile:
