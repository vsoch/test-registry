...
updated_at: "2023-03-10 03:26:30.589246"
latest: "1.18.2--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phantasus:1.18.2--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phantasus/1.18.2--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phantasus/1.18.2--r42hdfd78af_0
```
