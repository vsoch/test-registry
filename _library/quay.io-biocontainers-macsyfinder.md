...
updated_at: "2023-03-10 03:19:19.764739"
latest: "2.1--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/macsyfinder:2.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/macsyfinder/2.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/macsyfinder/2.1--pyh7cba7a3_0
```
