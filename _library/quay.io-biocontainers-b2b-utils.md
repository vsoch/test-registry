---
layout: container
name:  "quay.io/biocontainers/b2b-utils"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/b2b-utils/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/b2b-utils/container.yaml"
updated_at: "2023-03-10 03:14:03.882652"
latest: "0.018--pl5321h9ee0642_0"
container_url: "https://biocontainers.pro/tools/b2b-utils"
aliases:
 - "DrawGram.jar"
 - "DrawTree.jar"
 - "TMalign"
 ...
 - "formatdb"
versions:
 - "0.018--pl5321h9ee0642_0"
description: "singularity registry hpc automated addition for b2b-utils"
config: {"url": "https://biocontainers.pro/tools/b2b-utils", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for b2b-utils", "latest": {"0.018--pl5321h9ee0642_0": "sha256:ad243a21e5b7f913c38581ad68cca07c63418f40d7aa356434335bd07d3290b1"}, "tags": {"0.018--pl5321h9ee0642_0": "sha256:ad243a21e5b7f913c38581ad68cca07c63418f40d7aa356434335bd07d3290b1"}, "docker": "quay.io/biocontainers/b2b-utils", "aliases": {"DrawGram.jar": "/usr/local/bin/DrawGram.jar", "DrawTree.jar": "/usr/local/bin/DrawTree.jar", "TMalign": "/usr/local/bin/TMalign", "TMscore": "/usr/local/bin/TMscore", "attr": "/usr/local/bin/attr", "balsam": "/usr/local/bin/balsam", "bam2consensus": "/usr/local/bin/bam2consensus", "bgzip.pl": "/usr/local/bin/bgzip.pl", "blast2diamond": "/usr/local/bin/blast2diamond", "boot2frac": "/usr/local/bin/boot2frac", "bstats": "/usr/local/bin/bstats", "bundle": "/usr/local/bin/bundle", "bundler": "/usr/local/bin/bundler", "clique": "/usr/local/bin/clique", "comppair": "/usr/local/bin/comppair", "consense": "/usr/local/bin/consense", "contml": "/usr/local/bin/contml", "contrast": "/usr/local/bin/contrast", "conus_compare": "/usr/local/bin/conus_compare", "conus_train": "/usr/local/bin/conus_train", "dca": "/usr/local/bin/dca", "decode_sam_flag": "/usr/local/bin/decode_sam_flag", "dialign-tx": "/usr/local/bin/dialign-tx", "dnacomp": "/usr/local/bin/dnacomp", "dnadist": "/usr/local/bin/dnadist", "dnainvar": "/usr/local/bin/dnainvar", "dnaml": "/usr/local/bin/dnaml", "dnamlk": "/usr/local/bin/dnamlk", "dnamove": "/usr/local/bin/dnamove", "dnapars": "/usr/local/bin/dnapars", "dnapenny": "/usr/local/bin/dnapenny", "dollop": "/usr/local/bin/dollop", "dolmove": "/usr/local/bin/dolmove", "dolpenny": "/usr/local/bin/dolpenny", "drawgram": "/usr/local/bin/drawgram", "drawgram_gui": "/usr/local/bin/drawgram_gui", "drawtree": "/usr/local/bin/drawtree", "drawtree_gui": "/usr/local/bin/drawtree_gui", "dumpsexp": "/usr/local/bin/dumpsexp", "fakealigner": "/usr/local/bin/fakealigner", "faketree": "/usr/local/bin/faketree", "famsa": "/usr/local/bin/famsa", "fasta2nexus": "/usr/local/bin/fasta2nexus", "fasta2phylip": "/usr/local/bin/fasta2phylip", "fasttreeMP": "/usr/local/bin/fasttreeMP", "fitch": "/usr/local/bin/fitch", "fq_deinterleave": "/usr/local/bin/fq_deinterleave", "fq_interleave": "/usr/local/bin/fq_interleave", "frag_lens": "/usr/local/bin/frag_lens", "gb2fasta": "/usr/local/bin/gb2fasta", "gendist": "/usr/local/bin/gendist", "getfattr": "/usr/local/bin/getfattr", "gpg-error": "/usr/local/bin/gpg-error", "gpgrt-config": "/usr/local/bin/gpgrt-config", "guess_ill_instrument": "/usr/local/bin/guess_ill_instrument", "hmac256": "/usr/local/bin/hmac256", "hmmeralign": "/usr/local/bin/hmmeralign", "hmmerbuild": "/usr/local/bin/hmmerbuild", "hwloc-annotate": "/usr/local/bin/hwloc-annotate", "hwloc-bind": "/usr/local/bin/hwloc-bind", "hwloc-calc": "/usr/local/bin/hwloc-calc", "hwloc-compress-dir": "/usr/local/bin/hwloc-compress-dir", "hwloc-diff": "/usr/local/bin/hwloc-diff", "hwloc-distrib": "/usr/local/bin/hwloc-distrib", "hwloc-gather-cpuid": "/usr/local/bin/hwloc-gather-cpuid", "hwloc-gather-topology": "/usr/local/bin/hwloc-gather-topology", "hwloc-info": "/usr/local/bin/hwloc-info", "hwloc-ls": "/usr/local/bin/hwloc-ls", "hwloc-patch": "/usr/local/bin/hwloc-patch", "hwloc-ps": "/usr/local/bin/hwloc-ps", "hyperopt-mongo-worker": "/usr/local/bin/hyperopt-mongo-worker", "jackd": "/usr/local/bin/jackd", "kalign": "/usr/local/bin/kalign", "kitsch": "/usr/local/bin/kitsch", "lame": "/usr/local/bin/lame", "libgcrypt-config": "/usr/local/bin/libgcrypt-config", "lprodump": "/usr/local/bin/lprodump", "lrelease-pro": "/usr/local/bin/lrelease-pro", "lstopo": "/usr/local/bin/lstopo", "lstopo-no-graphics": "/usr/local/bin/lstopo-no-graphics", "lupdate-pro": "/usr/local/bin/lupdate-pro", "make_pscores.pl": "/usr/local/bin/make_pscores.pl", "matplotlib": "/usr/local/bin/matplotlib", "meshdebug": "/usr/local/bin/meshdebug", "minimeta": "/usr/local/bin/minimeta", "mix": "/usr/local/bin/mix", "move": "/usr/local/bin/move", "mpg123": "/usr/local/bin/mpg123", "mpg123-id3dump": "/usr/local/bin/mpg123-id3dump", "mpg123-strip": "/usr/local/bin/mpg123-strip", "mpicalc": "/usr/local/bin/mpicalc", "mustang": "/usr/local/bin/mustang", "ncbi_blast_update": "/usr/local/bin/ncbi_blast_update", "neighbor": "/usr/local/bin/neighbor", "opal.jar": "/usr/local/bin/opal.jar", "orc-bugreport": "/usr/local/bin/orc-bugreport", "orcc": "/usr/local/bin/orcc", "out123": "/usr/local/bin/out123", "pModel": "/usr/local/bin/pModel", "pa-info": "/usr/local/bin/pa-info", "pacat": "/usr/local/bin/pacat", "pacmd": "/usr/local/bin/pacmd", "pactl": "/usr/local/bin/pactl", "padaligner": "/usr/local/bin/padaligner", "padsp": "/usr/local/bin/padsp", "pamon": "/usr/local/bin/pamon", "paplay": "/usr/local/bin/paplay", "parec": "/usr/local/bin/parec", "parecord": "/usr/local/bin/parecord", "pars": "/usr/local/bin/pars", "pasuspender": "/usr/local/bin/pasuspender", "penny": "/usr/local/bin/penny", "phylip": "/usr/local/bin/phylip", "poa": "/usr/local/bin/poa", "probcons": "/usr/local/bin/probcons", "probconsRNA": "/usr/local/bin/probconsRNA", "proml": "/usr/local/bin/proml", "promlk": "/usr/local/bin/promlk", "protdist": "/usr/local/bin/protdist", "protpars": "/usr/local/bin/protpars", "pulseaudio": "/usr/local/bin/pulseaudio", "qbin": "/usr/local/bin/qbin", "qmlformat": "/usr/local/bin/qmlformat", "qmltime": "/usr/local/bin/qmltime", "qmltyperegistrar": "/usr/local/bin/qmltyperegistrar", "qpaeq": "/usr/local/bin/qpaeq", "racc": "/usr/local/bin/racc", "randtree": "/usr/local/bin/randtree", "raxml": "/usr/local/bin/raxml", "raxmlp": "/usr/local/bin/raxmlp", "rbs": "/usr/local/bin/rbs", "rdbg": "/usr/local/bin/rdbg", "restdist": "/usr/local/bin/restdist", "restml": "/usr/local/bin/restml", "retree": "/usr/local/bin/retree", "rm_chim": "/usr/local/bin/rm_chim", "rm_gaps": "/usr/local/bin/rm_gaps", "run_pasta.py": "/usr/local/bin/run_pasta.py", "run_pasta_gui.py": "/usr/local/bin/run_pasta_gui.py", "run_seqtools.py": "/usr/local/bin/run_seqtools.py", "sap": "/usr/local/bin/sap", "scompare": "/usr/local/bin/scompare", "seq_diff": "/usr/local/bin/seq_diff", "seqboot": "/usr/local/bin/seqboot", "setfattr": "/usr/local/bin/setfattr", "sfold": "/usr/local/bin/sfold", "shrink_bedgraph": "/usr/local/bin/shrink_bedgraph", "sip-build": "/usr/local/bin/sip-build", "sip-distinfo": "/usr/local/bin/sip-distinfo", "sip-install": "/usr/local/bin/sip-install", "sip-module": "/usr/local/bin/sip-module", "sip-sdist": "/usr/local/bin/sip-sdist", "sip-wheel": "/usr/local/bin/sip-wheel", "strain_ml": "/usr/local/bin/strain_ml", "summarize_assembly": "/usr/local/bin/summarize_assembly", "sync_reads": "/usr/local/bin/sync_reads", "tracegen": "/usr/local/bin/tracegen", "treedist": "/usr/local/bin/treedist", "typeprof": "/usr/local/bin/typeprof", "uc": "/usr/local/bin/uc", "yat2m": "/usr/local/bin/yat2m", "clustalo": "/usr/local/bin/clustalo", "flac": "/usr/local/bin/flac", "gdbm_dump": "/usr/local/bin/gdbm_dump", "gdbm_load": "/usr/local/bin/gdbm_load", "gdbmtool": "/usr/local/bin/gdbmtool", "metaflac": "/usr/local/bin/metaflac", "prank": "/usr/local/bin/prank", "sndfile-cmp": "/usr/local/bin/sndfile-cmp", "sndfile-concat": "/usr/local/bin/sndfile-concat", "sndfile-convert": "/usr/local/bin/sndfile-convert", "sndfile-deinterleave": "/usr/local/bin/sndfile-deinterleave", "sndfile-info": "/usr/local/bin/sndfile-info", "sndfile-interleave": "/usr/local/bin/sndfile-interleave", "sndfile-metadata-get": "/usr/local/bin/sndfile-metadata-get", "sndfile-metadata-set": "/usr/local/bin/sndfile-metadata-set", "sndfile-play": "/usr/local/bin/sndfile-play", "sndfile-salvage": "/usr/local/bin/sndfile-salvage", "aec": "/usr/local/bin/aec", "bl2seq": "/usr/local/bin/bl2seq", "blastall": "/usr/local/bin/blastall", "blastclust": "/usr/local/bin/blastclust", "blastpgp": "/usr/local/bin/blastpgp", "copymat": "/usr/local/bin/copymat", "fastacmd": "/usr/local/bin/fastacmd", "formatdb": "/usr/local/bin/formatdb"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/b2b-utils.
singularity registry hpc automated addition for b2b-utils
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/b2b-utils
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/b2b-utils:0.018--pl5321h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/b2b-utils/0.018--pl5321h9ee0642_0
$ module help quay.io/biocontainers/b2b-utils/0.018--pl5321h9ee0642_0
```
...
#### b2b-utils-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### b2b-utils-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bam2consensus
$ podman run --it --rm --entrypoint /usr/local/bin/bam2consensus   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bam2consensus   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/blast2diamond
$ podman run --it --rm --entrypoint /usr/local/bin/blast2diamond   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/blast2diamond   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/boot2frac
$ podman run --it --rm --entrypoint /usr/local/bin/boot2frac   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/boot2frac   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/decode_sam_flag
$ podman run --it --rm --entrypoint /usr/local/bin/decode_sam_flag   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/decode_sam_flag   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fasta2nexus
$ podman run --it --rm --entrypoint /usr/local/bin/fasta2nexus   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fasta2nexus   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fasta2phylip
$ podman run --it --rm --entrypoint /usr/local/bin/fasta2phylip   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fasta2phylip   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fq_deinterleave
$ podman run --it --rm --entrypoint /usr/local/bin/fq_deinterleave   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fq_deinterleave   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fq_interleave
$ podman run --it --rm --entrypoint /usr/local/bin/fq_interleave   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fq_interleave   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/frag_lens
$ podman run --it --rm --entrypoint /usr/local/bin/frag_lens   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/frag_lens   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gb2fasta
$ podman run --it --rm --entrypoint /usr/local/bin/gb2fasta   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gb2fasta   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/guess_ill_instrument
$ podman run --it --rm --entrypoint /usr/local/bin/guess_ill_instrument   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/guess_ill_instrument   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/minimeta
$ podman run --it --rm --entrypoint /usr/local/bin/minimeta   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/minimeta   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/ncbi_blast_update
$ podman run --it --rm --entrypoint /usr/local/bin/ncbi_blast_update   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/ncbi_blast_update   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/qbin
$ podman run --it --rm --entrypoint /usr/local/bin/qbin   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/qbin   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/rm_chim
$ podman run --it --rm --entrypoint /usr/local/bin/rm_chim   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/rm_chim   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/rm_gaps
$ podman run --it --rm --entrypoint /usr/local/bin/rm_gaps   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/rm_gaps   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/seq_diff
$ podman run --it --rm --entrypoint /usr/local/bin/seq_diff   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/seq_diff   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/shrink_bedgraph
$ podman run --it --rm --entrypoint /usr/local/bin/shrink_bedgraph   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/shrink_bedgraph   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/summarize_assembly
$ podman run --it --rm --entrypoint /usr/local/bin/summarize_assembly   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/summarize_assembly   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/sync_reads
$ podman run --it --rm --entrypoint /usr/local/bin/sync_reads   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sync_reads   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/uc
$ podman run --it --rm --entrypoint /usr/local/bin/uc   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/uc   -v ${PWD} -w ${PWD} <container> -c " $@"
```
