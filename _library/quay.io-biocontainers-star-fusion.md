...
updated_at: "2023-03-10 03:29:14.776646"
latest: "1.12.0--hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/star-fusion:1.12.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/star-fusion/1.12.0--hdfd78af_0
$ module help quay.io/biocontainers/star-fusion/1.12.0--hdfd78af_0
```
