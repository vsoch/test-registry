---
layout: container
name:  "quay.io/biocontainers/r-biom"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:42:07.108805"
...
```bash
$ shpc install quay.io/biocontainers/r-biom
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-biom:0.3.12--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-biom/0.3.12--r3.2.2_0
$ module help quay.io/biocontainers/r-biom/0.3.12--r3.2.2_0
```
...
#### r-biom-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-biom-inspect-deffile:
