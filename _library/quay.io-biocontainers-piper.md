...
updated_at: "2023-03-09 03:05:01.262203"
...
```bash
$ shpc install quay.io/biocontainers/piper:0.12.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/piper/0.12.3--pyhdfd78af_0
$ module help quay.io/biocontainers/piper/0.12.3--pyhdfd78af_0
```
