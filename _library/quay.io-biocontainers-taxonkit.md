...
updated_at: "2023-03-09 03:29:20.276307"
...
```bash
$ shpc install quay.io/biocontainers/taxonkit:0.14.1--h9ee0642_0
```
...
```bash
$ module load quay.io/biocontainers/taxonkit/0.14.1--h9ee0642_0
$ module help quay.io/biocontainers/taxonkit/0.14.1--h9ee0642_0
```
