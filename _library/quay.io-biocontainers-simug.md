---
layout: container
name:  "quay.io/biocontainers/simug"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:15:54.736684"
...
```bash
$ shpc install quay.io/biocontainers/simug
```
...
#### simug-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### simug-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/simuG
$ podman run --it --rm --entrypoint /usr/local/bin/simuG   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/simuG   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/vcf2model
$ podman run --it --rm --entrypoint /usr/local/bin/vcf2model   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/vcf2model   -v ${PWD} -w ${PWD} <container> -c " $@"
```
