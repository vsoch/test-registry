---
layout: container
name:  "quay.io/biocontainers/geodl"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:40:43.423195"
latest: "1.0b5.1--py_1"
...
```bash
$ shpc install quay.io/biocontainers/geodl
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/geodl:1.0b5.1--py_1
```
...
```bash
$ module load quay.io/biocontainers/geodl/1.0b5.1--py_1
$ module help quay.io/biocontainers/geodl/1.0b5.1--py_1
```
...
#### geodl-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### geodl-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/geoDL
$ podman run --it --rm --entrypoint /usr/local/bin/geoDL   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/geoDL   -v ${PWD} -w ${PWD} <container> -c " $@"
```
