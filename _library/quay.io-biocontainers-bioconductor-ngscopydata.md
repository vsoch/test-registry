...
updated_at: "2023-03-09 03:29:09.137565"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-ngscopydata:1.17.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ngscopydata/1.17.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ngscopydata/1.17.0--r42hdfd78af_0
```
