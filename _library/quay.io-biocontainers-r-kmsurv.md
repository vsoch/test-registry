---
layout: container
name:  "quay.io/biocontainers/r-kmsurv"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:34:31.862675"
...
```bash
$ shpc install quay.io/biocontainers/r-kmsurv
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-kmsurv:0.1_5--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-kmsurv/0.1_5--r3.3.2_0
$ module help quay.io/biocontainers/r-kmsurv/0.1_5--r3.3.2_0
```
...
#### r-kmsurv-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-kmsurv-inspect-deffile:
