---
layout: container
name:  "quay.io/biocontainers/r-knitr"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:33:22.649100"
latest: "1.12.3--0"
...
```bash
$ shpc install quay.io/biocontainers/r-knitr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-knitr:1.12.3--0
```
...
```bash
$ module load quay.io/biocontainers/r-knitr/1.12.3--0
$ module help quay.io/biocontainers/r-knitr/1.12.3--0
```
...
#### r-knitr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-knitr-inspect-deffile:
