---
layout: container
name:  "quay.io/biocontainers/bioconductor-statial"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:09:35.419222"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-statial
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-statial:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-statial/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-statial/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-statial-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-statial-inspect-deffile:
