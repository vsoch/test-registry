---
layout: container
name:  "quay.io/biocontainers/bioconductor-vsclust"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:33:47.615146"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-vsclust
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-vsclust:1.0.0--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vsclust/1.0.0--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-vsclust/1.0.0--r42hc247a5b_0
```
...
#### bioconductor-vsclust-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-vsclust-inspect-deffile:
