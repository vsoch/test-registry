...
updated_at: "2023-03-10 03:33:09.910835"
...
```bash
$ shpc install quay.io/biocontainers/zdb:1.0.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/zdb/1.0.4--hdfd78af_0
$ module help quay.io/biocontainers/zdb/1.0.4--hdfd78af_0
```
