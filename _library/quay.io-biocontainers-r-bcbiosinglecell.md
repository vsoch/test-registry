...
updated_at: "2023-03-10 03:23:59.609738"
latest: "0.6.3--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-bcbiosinglecell:0.6.3--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-bcbiosinglecell/0.6.3--r42hdfd78af_0
$ module help quay.io/biocontainers/r-bcbiosinglecell/0.6.3--r42hdfd78af_0
```
