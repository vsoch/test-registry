---
layout: container
name:  "quay.io/biocontainers/taxtastic"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:42:03.165646"
...
```bash
$ shpc install quay.io/biocontainers/taxtastic
```
...
#### taxtastic-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### taxtastic-inspect-deffile:
