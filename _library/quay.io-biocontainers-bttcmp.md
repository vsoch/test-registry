---
layout: container
name:  "quay.io/biocontainers/bttcmp"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:42:33.232136"
latest: "1.0.3--0"
...
```bash
$ shpc install quay.io/biocontainers/bttcmp
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bttcmp:1.0.3--0
```
...
```bash
$ module load quay.io/biocontainers/bttcmp/1.0.3--0
$ module help quay.io/biocontainers/bttcmp/1.0.3--0
```
...
#### bttcmp-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bttcmp-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bttcmp
$ podman run --it --rm --entrypoint /usr/local/bin/bttcmp   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bttcmp   -v ${PWD} -w ${PWD} <container> -c " $@"
```
