---
layout: container
name:  "quay.io/biocontainers/snaptools"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:20:59.212889"
...
versions:
 - "1.4.8--pyh864c0ab_1"
description: "shpc-registry automated BioContainers addition for snaptools"
config: {"url": "https://biocontainers.pro/tools/snaptools", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for snaptools", "latest": {"1.4.8--pyh864c0ab_1": "sha256:f0647a31ab0433d0e8cae9594eec275fba414868adfe6784c105958371619c01"}, "tags": {"1.4.8--pyh864c0ab_1": "sha256:f0647a31ab0433d0e8cae9594eec275fba414868adfe6784c105958371619c01"}, "docker": "quay.io/biocontainers/snaptools", "aliases": {"community": "/usr/local/bin/community", "snaptools": "/usr/local/bin/snaptools", "intersection_matrix.py": "/usr/local/bin/intersection_matrix.py", "intron_exon_reads.py": "/usr/local/bin/intron_exon_reads.py", "pbt_plotting_example.py": "/usr/local/bin/pbt_plotting_example.py", "peak_pie.py": "/usr/local/bin/peak_pie.py", "pybedtools": "/usr/local/bin/pybedtools", "venn_gchart.py": "/usr/local/bin/venn_gchart.py", "venn_mpl.py": "/usr/local/bin/venn_mpl.py", "annotate.py": "/usr/local/bin/annotate.py", "futurize": "/usr/local/bin/futurize", "pasteurize": "/usr/local/bin/pasteurize"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/snaptools.
shpc-registry automated BioContainers addition for snaptools
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/snaptools
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/snaptools:1.4.8--pyh864c0ab_1
```
...
```bash
$ module load quay.io/biocontainers/snaptools/1.4.8--pyh864c0ab_1
$ module help quay.io/biocontainers/snaptools/1.4.8--pyh864c0ab_1
```
...
#### snaptools-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### snaptools-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/snaptools
$ podman run --it --rm --entrypoint /usr/local/bin/snaptools   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/snaptools   -v ${PWD} -w ${PWD} <container> -c " $@"
```
