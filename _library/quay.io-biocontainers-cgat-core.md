---
layout: container
name:  "quay.io/biocontainers/cgat-core"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:08:28.680695"
latest: "0.5.14--py_0"
...
```bash
$ shpc install quay.io/biocontainers/cgat-core
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cgat-core:0.5.14--py_0
```
...
```bash
$ module load quay.io/biocontainers/cgat-core/0.5.14--py_0
$ module help quay.io/biocontainers/cgat-core/0.5.14--py_0
```
...
#### cgat-core-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cgat-core-inspect-deffile:
