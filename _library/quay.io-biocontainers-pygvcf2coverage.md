---
layout: container
name:  "quay.io/biocontainers/pygvcf2coverage"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:21:13.525482"
latest: "0.2--py_0"
...
```bash
$ shpc install quay.io/biocontainers/pygvcf2coverage
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pygvcf2coverage:0.2--py_0
```
...
```bash
$ module load quay.io/biocontainers/pygvcf2coverage/0.2--py_0
$ module help quay.io/biocontainers/pygvcf2coverage/0.2--py_0
```
...
#### pygvcf2coverage-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pygvcf2coverage-inspect-deffile:
