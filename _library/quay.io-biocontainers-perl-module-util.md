---
layout: container
name:  "quay.io/biocontainers/perl-module-util"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:03:10.491311"
...
```bash
$ shpc install quay.io/biocontainers/perl-module-util
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-module-util:1.09--pl5321hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/perl-module-util/1.09--pl5321hdfd78af_1
$ module help quay.io/biocontainers/perl-module-util/1.09--pl5321hdfd78af_1
```
...
#### perl-module-util-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-module-util-inspect-deffile:
