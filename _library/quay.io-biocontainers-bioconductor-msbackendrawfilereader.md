...
updated_at: "2023-03-09 03:37:39.781926"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msbackendrawfilereader:1.4.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msbackendrawfilereader/1.4.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-msbackendrawfilereader/1.4.0--r42hdfd78af_0
```
