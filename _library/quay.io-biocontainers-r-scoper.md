---
layout: container
name:  "quay.io/biocontainers/r-scoper"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:00:25.709243"
...
```bash
$ shpc install quay.io/biocontainers/r-scoper
```
...
#### r-scoper-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-scoper-inspect-deffile:
