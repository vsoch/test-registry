---
layout: container
name:  "quay.io/biocontainers/bioconductor-gskb"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:03:00.234628"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gskb
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-gskb:1.22.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gskb/1.22.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-gskb/1.22.0--r40hdfd78af_1
```
...
#### bioconductor-gskb-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-gskb-inspect-deffile:
