---
layout: container
name:  "quay.io/biocontainers/screamingbackpack"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:36:22.419168"
latest: "0.2.333--py_1"
...
```bash
$ shpc install quay.io/biocontainers/screamingbackpack
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/screamingbackpack:0.2.333--py_1
```
...
```bash
$ module load quay.io/biocontainers/screamingbackpack/0.2.333--py_1
$ module help quay.io/biocontainers/screamingbackpack/0.2.333--py_1
```
...
#### screamingbackpack-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### screamingbackpack-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/screamingBackpack
$ podman run --it --rm --entrypoint /usr/local/bin/screamingBackpack   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/screamingBackpack   -v ${PWD} -w ${PWD} <container> -c " $@"
```
