...
updated_at: "2023-03-10 03:22:29.816063"
latest: "0.12.0--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/geofetch:0.12.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/geofetch/0.12.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/geofetch/0.12.0--pyh7cba7a3_0
```
