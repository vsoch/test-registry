...
updated_at: "2023-03-09 03:35:49.233870"
...
```bash
$ shpc install quay.io/biocontainers/phate:1.0.10--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phate/1.0.10--pyhdfd78af_0
$ module help quay.io/biocontainers/phate/1.0.10--pyhdfd78af_0
```
