...
updated_at: "2023-03-10 03:26:20.575688"
...
```bash
$ shpc install quay.io/biocontainers/insurveyor:1.0.2--h9f5acd7_0
```
...
```bash
$ module load quay.io/biocontainers/insurveyor/1.0.2--h9f5acd7_0
$ module help quay.io/biocontainers/insurveyor/1.0.2--h9f5acd7_0
```
