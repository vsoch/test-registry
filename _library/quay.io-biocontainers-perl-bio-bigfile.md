...
updated_at: "2023-03-09 02:57:42.561633"
...
```bash
$ shpc install quay.io/biocontainers/perl-bio-bigfile:1.07--pl526hab1572f_1
```
...
```bash
$ module load quay.io/biocontainers/perl-bio-bigfile/1.07--pl526hab1572f_1
$ module help quay.io/biocontainers/perl-bio-bigfile/1.07--pl526hab1572f_1
```
