---
layout: container
name:  "quay.io/biocontainers/r-corpcor"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:02:20.266830"
...
```bash
$ shpc install quay.io/biocontainers/r-corpcor
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-corpcor:1.6.8--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-corpcor/1.6.8--r3.2.2_0
$ module help quay.io/biocontainers/r-corpcor/1.6.8--r3.2.2_0
```
...
#### r-corpcor-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-corpcor-inspect-deffile:
