---
layout: container
name:  "quay.io/biocontainers/salmid"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:04:23.790681"
latest: "0.1.23--py_0"
...
```bash
$ shpc install quay.io/biocontainers/salmid
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/salmid:0.1.23--py_0
```
...
```bash
$ module load quay.io/biocontainers/salmid/0.1.23--py_0
$ module help quay.io/biocontainers/salmid/0.1.23--py_0
```
...
#### salmid-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### salmid-inspect-deffile:
