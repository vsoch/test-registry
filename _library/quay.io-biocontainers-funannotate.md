---
layout: container
name:  "quay.io/biocontainers/funannotate"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:02:59.628973"
latest: "1.8.13--pyhdfd78af_0"
...
config: {"url": "https://biocontainers.pro/tools/funannotate", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for funannotate", "latest": {"1.8.13--pyhdfd78af_0": "sha256:4ceceffb1621cd8a31a88e2ab9c725170b711e358e115ba8ef96fb239979127b"}, "tags": {"1.8.9--pyhdfd78af_3": "sha256:7d5100997b58f0a94b48463a2a6bb77a00b7e8bee01517bea8977509b33fe13a", "1.8.13--pyhdfd78af_0": "sha256:4ceceffb1621cd8a31a88e2ab9c725170b711e358e115ba8ef96fb239979127b"}, "docker": "quay.io/biocontainers/funannotate", "aliases": {"CodingQuarry": "/usr/local/bin/CodingQuarry", "CufflinksGTF_to_CodingQuarryGFF3.py": "/usr/local/bin/CufflinksGTF_to_CodingQuarryGFF3.py", "EukHighConfidenceFilter": "/usr/local/bin/EukHighConfidenceFilter", "PtR": "/usr/local/bin/PtR", "SplicedAlignment.pm": "/usr/local/bin/SplicedAlignment.pm", "TransDecoder.LongOrfs": "/usr/local/bin/TransDecoder.LongOrfs", "TransDecoder.Predict": "/usr/local/bin/TransDecoder.Predict", "Trinity": "/usr/local/bin/Trinity", "TrinityStats.pl": "/usr/local/bin/TrinityStats.pl", "Trinity_gene_splice_modeler.py": "/usr/local/bin/Trinity_gene_splice_modeler.py", "aa2nonred.pl": "/usr/local/bin/aa2nonred.pl", "abundance_estimates_to_matrix.pl": "/usr/local/bin/abundance_estimates_to_matrix.pl", "align_and_estimate_abundance.pl": "/usr/local/bin/align_and_estimate_abundance.pl", "analyze_blastPlus_topHit_coverage.pl": "/usr/local/bin/analyze_blastPlus_topHit_coverage.pl", "analyze_diff_expr.pl": "/usr/local/bin/analyze_diff_expr.pl", "ann_exons_ens.pl": "/usr/local/bin/ann_exons_ens.pl", "ann_exons_ncbi.pl": "/usr/local/bin/ann_exons_ncbi.pl", "ann_exons_up_sql.pl": "/usr/local/bin/ann_exons_up_sql.pl", "ann_exons_up_www.pl": "/usr/local/bin/ann_exons_up_www.pl", "ann_feats2ipr.pl": "/usr/local/bin/ann_feats2ipr.pl", "ann_feats2ipr_e.pl": "/usr/local/bin/ann_feats2ipr_e.pl", "ann_feats_up_sql.pl": "/usr/local/bin/ann_feats_up_sql.pl", "ann_feats_up_www2.pl": "/usr/local/bin/ann_feats_up_www2.pl", "ann_ipr_www.pl": "/usr/local/bin/ann_ipr_www.pl", "ann_pdb_cath.pl": "/usr/local/bin/ann_pdb_cath.pl", "ann_pdb_vast.pl": "/usr/local/bin/ann_pdb_vast.pl", "ann_pfam27.pl": "/usr/local/bin/ann_pfam27.pl", "ann_pfam28.pl": "/usr/local/bin/ann_pfam28.pl", "ann_pfam30.pl": "/usr/local/bin/ann_pfam30.pl", "ann_pfam30_tmptbl.pl": "/usr/local/bin/ann_pfam30_tmptbl.pl", "ann_pfam_www.pl": "/usr/local/bin/ann_pfam_www.pl", "ann_upfeats_pfam_www_e.pl": "/usr/local/bin/ann_upfeats_pfam_www_e.pl", "annot_blast_btop2.pl": "/usr/local/bin/annot_blast_btop2.pl", "atoiindex": "/usr/local/bin/atoiindex", "augustus2browser.pl": "/usr/local/bin/augustus2browser.pl", "augustus2gbrowse.pl": "/usr/local/bin/augustus2gbrowse.pl", "autoAug.pl": "/usr/local/bin/autoAug.pl", "autoAugPred.pl": "/usr/local/bin/autoAugPred.pl", "autoAugTrain.pl": "/usr/local/bin/autoAugTrain.pl", "autoRun.pathInfo": "/usr/local/bin/autoRun.pathInfo", "bam2wig": "/usr/local/bin/bam2wig", "bamToWig.py": "/usr/local/bin/bamToWig.py", "bedgraph2wig.pl": "/usr/local/bin/bedgraph2wig.pl", "blat2gbrowse.pl": "/usr/local/bin/blat2gbrowse.pl", "blat2hints.pl": "/usr/local/bin/blat2hints.pl", "block2prfl.pl": "/usr/local/bin/block2prfl.pl", "cdbfasta": "/usr/local/bin/cdbfasta", "cdbyank": "/usr/local/bin/cdbyank", "cdna_alignment_orf_to_genome_orf.pl": "/usr/local/bin/cdna_alignment_orf_to_genome_orf.pl", "cds-trainer.pl": "/usr/local/bin/cds-trainer.pl", "cegma2gff.pl": "/usr/local/bin/cegma2gff.pl", "checkParamArchive.pl": "/usr/local/bin/checkParamArchive.pl", "checkUTR": "/usr/local/bin/checkUTR", "cleanDOSfasta.pl": "/usr/local/bin/cleanDOSfasta.pl", "clusterAndSplitGenes.pl": "/usr/local/bin/clusterAndSplitGenes.pl", "cmetindex": "/usr/local/bin/cmetindex", "color_defs.pl": "/usr/local/bin/color_defs.pl", "compare_gos.py": "/usr/local/bin/compare_gos.py", "compare_masking.pl": "/usr/local/bin/compare_masking.pl", "compileSpliceCands": "/usr/local/bin/compileSpliceCands", "computeFlankingRegion.pl": "/usr/local/bin/computeFlankingRegion.pl", "compute_base_probs.pl": "/usr/local/bin/compute_base_probs.pl", "contig_ExN50_statistic.pl": "/usr/local/bin/contig_ExN50_statistic.pl", "covels-SE": "/usr/local/bin/covels-SE", "coves-SE": "/usr/local/bin/coves-SE", "cpuid": "/usr/local/bin/cpuid", "createAugustusJoblist.pl": "/usr/local/bin/createAugustusJoblist.pl", "dbsnp_iit": "/usr/local/bin/dbsnp_iit", "define_clusters_by_cutting_tree.pl": "/usr/local/bin/define_clusters_by_cutting_tree.pl", "del_from_prfl.pl": "/usr/local/bin/del_from_prfl.pl", "distro": "/usr/local/bin/distro", "ensembl_genes": "/usr/local/bin/ensembl_genes", "esd2esi": "/usr/local/bin/esd2esi", "espoca": "/usr/local/bin/espoca", "eufindtRNA": "/usr/local/bin/eufindtRNA", "evalCGP.pl": "/usr/local/bin/evalCGP.pl", "eval_dualdecomp.pl": "/usr/local/bin/eval_dualdecomp.pl", "eval_multi_gtf.pl": "/usr/local/bin/eval_multi_gtf.pl", "evidence_modeler.pl": "/usr/local/bin/evidence_modeler.pl", "exclude_similar_proteins.pl": "/usr/local/bin/exclude_similar_proteins.pl", "exonerate": "/usr/local/bin/exonerate", "exonerate-server": "/usr/local/bin/exonerate-server", "exonerate2hints.pl": "/usr/local/bin/exonerate2hints.pl", "exoniphyDb2hints.pl": "/usr/local/bin/exoniphyDb2hints.pl", "exonpairs": "/usr/local/bin/exonpairs", "exp_up_ensg.pl": "/usr/local/bin/exp_up_ensg.pl", "expand_links.pl": "/usr/local/bin/expand_links.pl", "expand_uniref50.pl": "/usr/local/bin/expand_uniref50.pl", "extractTranscriptEnds.pl": "/usr/local/bin/extractTranscriptEnds.pl", "extract_exons.py": "/usr/local/bin/extract_exons.py", "extract_splice_sites.py": "/usr/local/bin/extract_splice_sites.py", "extract_supertranscript_from_reference.py": "/usr/local/bin/extract_supertranscript_from_reference.py", "fa_coords": "/usr/local/bin/fa_coords", "fasta": "/usr/local/bin/fasta", "fasta2esd": "/usr/local/bin/fasta2esd", "fasta2gsi": "/usr/local/bin/fasta2gsi", "fasta36": "/usr/local/bin/fasta36", "fasta_prot_checker.pl": "/usr/local/bin/fasta_prot_checker.pl", "fastaannotatecdna": "/usr/local/bin/fastaannotatecdna", "fastachecksum": "/usr/local/bin/fastachecksum", "fastaclean": "/usr/local/bin/fastaclean", "fastaclip": "/usr/local/bin/fastaclip", "fastacomposition": "/usr/local/bin/fastacomposition", "fastadiff": "/usr/local/bin/fastadiff", "fastaexplode": "/usr/local/bin/fastaexplode", "fastafetch": "/usr/local/bin/fastafetch", "fastahardmask": "/usr/local/bin/fastahardmask", "fastaindex": "/usr/local/bin/fastaindex", "fastalength": "/usr/local/bin/fastalength", "fastanrdb": "/usr/local/bin/fastanrdb", "fastaoverlap": "/usr/local/bin/fastaoverlap", "fastareformat": "/usr/local/bin/fastareformat", "fastaremove": "/usr/local/bin/fastaremove", "fastarevcomp": "/usr/local/bin/fastarevcomp", "fastasoftmask": "/usr/local/bin/fastasoftmask", "fastasort": "/usr/local/bin/fastasort", "fastasplit": "/usr/local/bin/fastasplit", "fastasubseq": "/usr/local/bin/fastasubseq", "fastatranslate": "/usr/local/bin/fastatranslate", "fastavalidcds": "/usr/local/bin/fastavalidcds", "fastf36": "/usr/local/bin/fastf36", "fastm36": "/usr/local/bin/fastm36", "fasts36": "/usr/local/bin/fasts36", "fastx36": "/usr/local/bin/fastx36", "fasty36": "/usr/local/bin/fasty36", "fathom": "/usr/local/bin/fathom", "fetch_associations.py": "/usr/local/bin/fetch_associations.py", "ffindex_resume.pl": "/usr/local/bin/ffindex_resume.pl", "filter-ppx.pl": "/usr/local/bin/filter-ppx.pl", "filterGenes.pl": "/usr/local/bin/filterGenes.pl", "filterGenesIn.pl": "/usr/local/bin/filterGenesIn.pl", "filterGenesIn_mRNAname.pl": "/usr/local/bin/filterGenesIn_mRNAname.pl", "filterGenesOut_mRNAname.pl": "/usr/local/bin/filterGenesOut_mRNAname.pl", "filterInFrameStopCodons.pl": "/usr/local/bin/filterInFrameStopCodons.pl", "filterMaf.pl": "/usr/local/bin/filterMaf.pl", "filterPSL.pl": "/usr/local/bin/filterPSL.pl", "filterShrimp.pl": "/usr/local/bin/filterShrimp.pl", "filterSpliceHints.pl": "/usr/local/bin/filterSpliceHints.pl", "filter_low_expr_transcripts.pl": "/usr/local/bin/filter_low_expr_transcripts.pl", "findGffNamesInFasta.pl": "/usr/local/bin/findGffNamesInFasta.pl", "find_enrichment.py": "/usr/local/bin/find_enrichment.py", "fix_in_frame_stop_codon_genes.py": "/usr/local/bin/fix_in_frame_stop_codon_genes.py", "fix_joingenes_gtf.pl": "/usr/local/bin/fix_joingenes_gtf.pl", "forge": "/usr/local/bin/forge", "funannotate": "/usr/local/bin/funannotate", "gbSmallDNA2gff.pl": "/usr/local/bin/gbSmallDNA2gff.pl", "gbrowse.conf": "/usr/local/bin/gbrowse.conf", "gbrowseold2gff3.pl": "/usr/local/bin/gbrowseold2gff3.pl", "gene_list_to_gff.pl": "/usr/local/bin/gene_list_to_gff.pl", "get-genome": "/usr/local/bin/get-genome", "getAnnoFasta.pl": "/usr/local/bin/getAnnoFasta.pl", "getAnnoFastaFromJoingenes.py": "/usr/local/bin/getAnnoFastaFromJoingenes.py", "getLinesMatching.pl": "/usr/local/bin/getLinesMatching.pl", "getSeq": "/usr/local/bin/getSeq", "get_FL_accs.pl": "/usr/local/bin/get_FL_accs.pl", "get_Trinity_gene_to_trans_map.pl": "/usr/local/bin/get_Trinity_gene_to_trans_map.pl", "get_longest_ORF_per_transcript.pl": "/usr/local/bin/get_longest_ORF_per_transcript.pl", "get_top_longest_fasta_entries.pl": "/usr/local/bin/get_top_longest_fasta_entries.pl", "gff2gbSmallDNA.pl": "/usr/local/bin/gff2gbSmallDNA.pl", "gff2ps_mycustom": "/usr/local/bin/gff2ps_mycustom", "gff3_file_to_bed.pl": "/usr/local/bin/gff3_file_to_bed.pl", "gff3_file_to_proteins.pl": "/usr/local/bin/gff3_file_to_proteins.pl", "gff3_gene_to_gtf_format.pl": "/usr/local/bin/gff3_gene_to_gtf_format.pl", "gff3_genes": "/usr/local/bin/gff3_genes", "gff3_introns": "/usr/local/bin/gff3_introns", "gff3_splicesites": "/usr/local/bin/gff3_splicesites", "gffGetmRNA.pl": "/usr/local/bin/gffGetmRNA.pl", "ggsearch36": "/usr/local/bin/ggsearch36", "glsearch36": "/usr/local/bin/glsearch36", "gmap.nosimd": "/usr/local/bin/gmap.nosimd", "gmap.sse42": "/usr/local/bin/gmap.sse42", "gmap_build": "/usr/local/bin/gmap_build", "gmap_compress": "/usr/local/bin/gmap_compress", "gmap_process": "/usr/local/bin/gmap_process", "gmap_reassemble": "/usr/local/bin/gmap_reassemble", "gmap_uncompress": "/usr/local/bin/gmap_uncompress", "gmapindex": "/usr/local/bin/gmapindex", "gmapl": "/usr/local/bin/gmapl", "gmapl.nosimd": "/usr/local/bin/gmapl.nosimd", "gmapl.sse42": "/usr/local/bin/gmapl.sse42", "go_plot.py": "/usr/local/bin/go_plot.py", "gp2othergp.pl": "/usr/local/bin/gp2othergp.pl", "gsnap": "/usr/local/bin/gsnap", "gsnap.nosimd": "/usr/local/bin/gsnap.nosimd", "gsnap.sse42": "/usr/local/bin/gsnap.sse42", "gsnapl": "/usr/local/bin/gsnapl", "gsnapl.nosimd": "/usr/local/bin/gsnapl.nosimd", "gsnapl.sse42": "/usr/local/bin/gsnapl.sse42", "gss-server": "/usr/local/bin/gss-server", "gtf2aa.pl": "/usr/local/bin/gtf2aa.pl", "gtf2gff.pl": "/usr/local/bin/gtf2gff.pl", "gtf_genes": "/usr/local/bin/gtf_genes", "gtf_genome_to_cdna_fasta.pl": "/usr/local/bin/gtf_genome_to_cdna_fasta.pl", "gtf_introns": "/usr/local/bin/gtf_introns", "gtf_splicesites": "/usr/local/bin/gtf_splicesites", "gtf_to_alignment_gff3.pl": "/usr/local/bin/gtf_to_alignment_gff3.pl", "gtf_to_bed.pl": "/usr/local/bin/gtf_to_bed.pl", "gtf_transcript_splicesites": "/usr/local/bin/gtf_transcript_splicesites", "gth2gtf.pl": "/usr/local/bin/gth2gtf.pl", "gvf_iit": "/usr/local/bin/gvf_iit", "hal2maf_split.pl": "/usr/local/bin/hal2maf_split.pl", "helpMod.pm": "/usr/local/bin/helpMod.pm", "hisat2": "/usr/local/bin/hisat2", "hisat2-align-l": "/usr/local/bin/hisat2-align-l", "hisat2-align-s": "/usr/local/bin/hisat2-align-s", "hisat2-build": "/usr/local/bin/hisat2-build", "hisat2-build-l": "/usr/local/bin/hisat2-build-l", "hisat2-build-s": "/usr/local/bin/hisat2-build-s", "hisat2-inspect": "/usr/local/bin/hisat2-inspect", "hisat2-inspect-l": "/usr/local/bin/hisat2-inspect-l", "hisat2-inspect-s": "/usr/local/bin/hisat2-inspect-s", "hisat2_extract_exons.py": "/usr/local/bin/hisat2_extract_exons.py", "hisat2_extract_snps_haplotypes_UCSC.py": "/usr/local/bin/hisat2_extract_snps_haplotypes_UCSC.py", "hisat2_extract_snps_haplotypes_VCF.py": "/usr/local/bin/hisat2_extract_snps_haplotypes_VCF.py", "hisat2_extract_splice_sites.py": "/usr/local/bin/hisat2_extract_splice_sites.py", "hisat2_read_statistics.py": "/usr/local/bin/hisat2_read_statistics.py", "hisat2_simulate_reads.py": "/usr/local/bin/hisat2_simulate_reads.py", "hmm-assembler.pl": "/usr/local/bin/hmm-assembler.pl", "hmm-info": "/usr/local/bin/hmm-info", "iit_dump": "/usr/local/bin/iit_dump", "iit_get": "/usr/local/bin/iit_get", "iit_store": "/usr/local/bin/iit_store", "insilico_read_normalization.pl": "/usr/local/bin/insilico_read_normalization.pl", "ipcress": "/usr/local/bin/ipcress", "iqtree2": "/usr/local/bin/iqtree2", "joinPeptides.pl": "/usr/local/bin/joinPeptides.pl", "join_aug_pred.pl": "/usr/local/bin/join_aug_pred.pl", "join_mult_hints.pl": "/usr/local/bin/join_mult_hints.pl", "kadmin.local": "/usr/local/bin/kadmin.local", "kadmind": "/usr/local/bin/kadmind", "kallisto": "/usr/local/bin/kallisto", "kdb5_util": "/usr/local/bin/kdb5_util", "kprop": "/usr/local/bin/kprop", "kpropd": "/usr/local/bin/kpropd", "kproplog": "/usr/local/bin/kproplog", "krb5-send-pr": "/usr/local/bin/krb5-send-pr", "krb5kdc": "/usr/local/bin/krb5kdc", "lalign36": "/usr/local/bin/lalign36", "lav2plt.pl": "/usr/local/bin/lav2plt.pl", "lavplt_ps.pl": "/usr/local/bin/lavplt_ps.pl", "lavplt_svg.pl": "/usr/local/bin/lavplt_svg.pl", "lighttpd": "/usr/local/bin/lighttpd", "lighttpd-angel": "/usr/local/bin/lighttpd-angel", "links2sql.pl": "/usr/local/bin/links2sql.pl", "load2sqlitedb": "/usr/local/bin/load2sqlitedb", "lp_solve": "/usr/local/bin/lp_solve", "m8_btop_msa.pl": "/usr/local/bin/m8_btop_msa.pl", "m9B_btop_msa.pl": "/usr/local/bin/m9B_btop_msa.pl", "maf2conswig.pl": "/usr/local/bin/maf2conswig.pl", "makeMatchLists.pl": "/usr/local/bin/makeMatchLists.pl", "makeUtrTrainingSet.pl": "/usr/local/bin/makeUtrTrainingSet.pl", "map_db": "/usr/local/bin/map_db", "map_to_slim.py": "/usr/local/bin/map_to_slim.py", "maskNregions.pl": "/usr/local/bin/maskNregions.pl", "md_coords": "/usr/local/bin/md_coords", "merge_blast_btab.pl": "/usr/local/bin/merge_blast_btab.pl", "merge_masking.pl": "/usr/local/bin/merge_masking.pl", "moveParameters.pl": "/usr/local/bin/moveParameters.pl", "msa2prfl.pl": "/usr/local/bin/msa2prfl.pl", "ncbi_gene_results_to_python.py": "/usr/local/bin/ncbi_gene_results_to_python.py", "new_species.pl": "/usr/local/bin/new_species.pl", "noncoding-trainer.pl": "/usr/local/bin/noncoding-trainer.pl", "nr_ORFs_gff3.pl": "/usr/local/bin/nr_ORFs_gff3.pl", "opt_init_and_term_probs.pl": "/usr/local/bin/opt_init_and_term_probs.pl", "optimize_augustus.pl": "/usr/local/bin/optimize_augustus.pl", "parseSim4Output.pl": "/usr/local/bin/parseSim4Output.pl", "parse_m9.pl": "/usr/local/bin/parse_m9.pl", "partition_gtf2gb.pl": "/usr/local/bin/partition_gtf2gb.pl", "pasapolyA2hints.pl": "/usr/local/bin/pasapolyA2hints.pl", "patch-hmm.pl": "/usr/local/bin/patch-hmm.pl", "peptides2alternatives.pl": "/usr/local/bin/peptides2alternatives.pl", "peptides2hints.pl": "/usr/local/bin/peptides2hints.pl", "pfam_runner.pl": "/usr/local/bin/pfam_runner.pl", "phastconsDB2hints.pl": "/usr/local/bin/phastconsDB2hints.pl", "phyml": "/usr/local/bin/phyml", "phyml-mpi": "/usr/local/bin/phyml-mpi", "phyrex": "/usr/local/bin/phyrex", "phytime": "/usr/local/bin/phytime", "plot_go_term.py": "/usr/local/bin/plot_go_term.py", "pluginviewer": "/usr/local/bin/pluginviewer", "polyA2hints.pl": "/usr/local/bin/polyA2hints.pl", "prepDE.py": "/usr/local/bin/prepDE.py", "prints2prfl.pl": "/usr/local/bin/prints2prfl.pl", "proteinortho": "/usr/local/bin/proteinortho", "proteinortho2html.pl": "/usr/local/bin/proteinortho2html.pl", "proteinortho2tree.pl": "/usr/local/bin/proteinortho2tree.pl", "proteinortho2xml.pl": "/usr/local/bin/proteinortho2xml.pl", "proteinortho6.pl": "/usr/local/bin/proteinortho6.pl", "proteinortho_cleanupblastgraph": "/usr/local/bin/proteinortho_cleanupblastgraph", "proteinortho_clustering": "/usr/local/bin/proteinortho_clustering", "proteinortho_compareProteinorthoGraphs.pl": "/usr/local/bin/proteinortho_compareProteinorthoGraphs.pl", "proteinortho_do_mcl.pl": "/usr/local/bin/proteinortho_do_mcl.pl", "proteinortho_extract_from_graph.pl": "/usr/local/bin/proteinortho_extract_from_graph.pl", "proteinortho_ffadj_mcs.py": "/usr/local/bin/proteinortho_ffadj_mcs.py", "proteinortho_formatUsearch.pl": "/usr/local/bin/proteinortho_formatUsearch.pl", "proteinortho_grab_proteins.pl": "/usr/local/bin/proteinortho_grab_proteins.pl", "proteinortho_graphMinusRemovegraph": "/usr/local/bin/proteinortho_graphMinusRemovegraph", "proteinortho_history.pl": "/usr/local/bin/proteinortho_history.pl", "proteinortho_singletons.pl": "/usr/local/bin/proteinortho_singletons.pl", "proteinortho_summary.pl": "/usr/local/bin/proteinortho_summary.pl", "proteinortho_treeBuilderCore": "/usr/local/bin/proteinortho_treeBuilderCore", "prt_terms.py": "/usr/local/bin/prt_terms.py", "pslCDnaFilter": "/usr/local/bin/pslCDnaFilter", "pslMap.pl": "/usr/local/bin/pslMap.pl", "psl_genes": "/usr/local/bin/psl_genes", "psl_introns": "/usr/local/bin/psl_introns", "psl_splicesites": "/usr/local/bin/psl_splicesites", "randomSplit.pl": "/usr/local/bin/randomSplit.pl", "ratewig.pl": "/usr/local/bin/ratewig.pl", "refine_gff3_group_iso_strip_utrs.pl": "/usr/local/bin/refine_gff3_group_iso_strip_utrs.pl", "refine_hexamer_scores.pl": "/usr/local/bin/refine_hexamer_scores.pl", "remove_eclipsed_ORFs.pl": "/usr/local/bin/remove_eclipsed_ORFs.pl", "res2R.pl": "/usr/local/bin/res2R.pl", "retrieve_sequences_from_fasta.pl": "/usr/local/bin/retrieve_sequences_from_fasta.pl", "retroDB2hints.pl": "/usr/local/bin/retroDB2hints.pl", "rmRedundantHints.pl": "/usr/local/bin/rmRedundantHints.pl", "runAllSim4.pl": "/usr/local/bin/runAllSim4.pl", "run_CQ-PM_mine.sh": "/usr/local/bin/run_CQ-PM_mine.sh", "run_CQ-PM_stranded.sh": "/usr/local/bin/run_CQ-PM_stranded.sh", "run_CQ-PM_unstranded.sh": "/usr/local/bin/run_CQ-PM_unstranded.sh", "run_DE_analysis.pl": "/usr/local/bin/run_DE_analysis.pl", "run_DE_analysis_from_samples_file.pl": "/usr/local/bin/run_DE_analysis_from_samples_file.pl", "samMap.pl": "/usr/local/bin/samMap.pl", "sam_sort": "/usr/local/bin/sam_sort", "saslauthd": "/usr/local/bin/saslauthd", "scipiogff2gff.pl": "/usr/local/bin/scipiogff2gff.pl", "score_CDS_likelihood_all_6_frames.pl": "/usr/local/bin/score_CDS_likelihood_all_6_frames.pl", "select_best_ORFs_per_transcript.pl": "/usr/local/bin/select_best_ORFs_per_transcript.pl", "seq_n_baseprobs_to_loglikelihood_vals.pl": "/usr/local/bin/seq_n_baseprobs_to_loglikelihood_vals.pl", "seqtk-trinity": "/usr/local/bin/seqtk-trinity", "setStopCodonFreqs.pl": "/usr/local/bin/setStopCodonFreqs.pl", "shuffle_embed.pl": "/usr/local/bin/shuffle_embed.pl", "sift_bam_max_cov.pl": "/usr/local/bin/sift_bam_max_cov.pl", "sim_server": "/usr/local/bin/sim_server", "simpleFastaHeaders.pl": "/usr/local/bin/simpleFastaHeaders.pl", "simplifyFastaHeaders.pl": "/usr/local/bin/simplifyFastaHeaders.pl", "slclust": "/usr/local/bin/slclust", "snap": "/usr/local/bin/snap", "snpindex": "/usr/local/bin/snpindex", "splitMfasta.pl": "/usr/local/bin/splitMfasta.pl", "split_wiggle.pl": "/usr/local/bin/split_wiggle.pl", "ssearch36": "/usr/local/bin/ssearch36", "sserver": "/usr/local/bin/sserver", "sstofa": "/usr/local/bin/sstofa", "start_codon_refinement.pl": "/usr/local/bin/start_codon_refinement.pl", "stringtie": "/usr/local/bin/stringtie", "summ_domain_ident.pl": "/usr/local/bin/summ_domain_ident.pl", "summarizeACGTcontent.pl": "/usr/local/bin/summarizeACGTcontent.pl", "tRNAscan-SE": "/usr/local/bin/tRNAscan-SE", "tRNAscan-SE.conf": "/usr/local/bin/tRNAscan-SE.conf", "tantan": "/usr/local/bin/tantan", "testsaslauthd": "/usr/local/bin/testsaslauthd", "tfastf36": "/usr/local/bin/tfastf36", "tfastm36": "/usr/local/bin/tfastm36", "tfasts36": "/usr/local/bin/tfasts36", "tfastx36": "/usr/local/bin/tfastx36", "tfasty36": "/usr/local/bin/tfasty36", "train_start_PWM.pl": "/usr/local/bin/train_start_PWM.pl", "transMap2hints.pl": "/usr/local/bin/transMap2hints.pl", "trnascan-1.4": "/usr/local/bin/trnascan-1.4", "uniqscan": "/usr/local/bin/uniqscan", "uniqscanl": "/usr/local/bin/uniqscanl", "uniquePeptides.pl": "/usr/local/bin/uniquePeptides.pl", "uri_unescape.pl": "/usr/local/bin/uri_unescape.pl", "utrgff2gbrowse.pl": "/usr/local/bin/utrgff2gbrowse.pl", "utrrnaseq": "/usr/local/bin/utrrnaseq", "uuserver": "/usr/local/bin/uuserver", "vcf_iit": "/usr/local/bin/vcf_iit", "webserver-results.head": "/usr/local/bin/webserver-results.head", "webserver-results.tail": "/usr/local/bin/webserver-results.tail", "weedMaf.pl": "/usr/local/bin/weedMaf.pl", "wig2hints.pl": "/usr/local/bin/wig2hints.pl", "wigchoose.pl": "/usr/local/bin/wigchoose.pl", "wr_hier.py": "/usr/local/bin/wr_hier.py", "wr_sections.py": "/usr/local/bin/wr_sections.py", "writeResultsPage.pl": "/usr/local/bin/writeResultsPage.pl", "yaml2gff.1.4.pl": "/usr/local/bin/yaml2gff.1.4.pl", "zff2gff3.pl": "/usr/local/bin/zff2gff3.pl", "augustus": "/usr/local/bin/augustus", "bam2hints": "/usr/local/bin/bam2hints", "etraining": "/usr/local/bin/etraining", "fastBlockSearch": "/usr/local/bin/fastBlockSearch", "filterBam": "/usr/local/bin/filterBam", "gmap": "/usr/local/bin/gmap", "gtf2bed.pl": "/usr/local/bin/gtf2bed.pl", "homGeneMapping": "/usr/local/bin/homGeneMapping", "joingenes": "/usr/local/bin/joingenes", "prepareAlign": "/usr/local/bin/prepareAlign"}}
---
...
```bash
$ shpc install quay.io/biocontainers/funannotate
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/funannotate:1.8.13--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/funannotate/1.8.13--pyhdfd78af_0
$ module help quay.io/biocontainers/funannotate/1.8.13--pyhdfd78af_0
```
...
#### funannotate-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### funannotate-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/fasta
$ podman run --it --rm --entrypoint /usr/local/bin/fasta   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fasta   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/funannotate
$ podman run --it --rm --entrypoint /usr/local/bin/funannotate   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/funannotate   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gss-server
$ podman run --it --rm --entrypoint /usr/local/bin/gss-server   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gss-server   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/kadmin.local
$ podman run --it --rm --entrypoint /usr/local/bin/kadmin.local   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kadmin.local   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/kadmind
$ podman run --it --rm --entrypoint /usr/local/bin/kadmind   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kadmind   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/kdb5_util
$ podman run --it --rm --entrypoint /usr/local/bin/kdb5_util   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kdb5_util   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/kprop
$ podman run --it --rm --entrypoint /usr/local/bin/kprop   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kprop   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/kpropd
$ podman run --it --rm --entrypoint /usr/local/bin/kpropd   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kpropd   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/kproplog
$ podman run --it --rm --entrypoint /usr/local/bin/kproplog   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/kproplog   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/krb5-send-pr
$ podman run --it --rm --entrypoint /usr/local/bin/krb5-send-pr   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/krb5-send-pr   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/krb5kdc
$ podman run --it --rm --entrypoint /usr/local/bin/krb5kdc   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/krb5kdc   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/lighttpd
$ podman run --it --rm --entrypoint /usr/local/bin/lighttpd   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/lighttpd   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/lighttpd-angel
$ podman run --it --rm --entrypoint /usr/local/bin/lighttpd-angel   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/lighttpd-angel   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/pluginviewer
$ podman run --it --rm --entrypoint /usr/local/bin/pluginviewer   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/pluginviewer   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/saslauthd
$ podman run --it --rm --entrypoint /usr/local/bin/saslauthd   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/saslauthd   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/sim_server
$ podman run --it --rm --entrypoint /usr/local/bin/sim_server   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sim_server   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/sserver
$ podman run --it --rm --entrypoint /usr/local/bin/sserver   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sserver   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/tantan
$ podman run --it --rm --entrypoint /usr/local/bin/tantan   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/tantan   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/testsaslauthd
$ podman run --it --rm --entrypoint /usr/local/bin/testsaslauthd   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/testsaslauthd   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/uniqscan
$ podman run --it --rm --entrypoint /usr/local/bin/uniqscan   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/uniqscan   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/uniqscanl
$ podman run --it --rm --entrypoint /usr/local/bin/uniqscanl   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/uniqscanl   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/uuserver
$ podman run --it --rm --entrypoint /usr/local/bin/uuserver   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/uuserver   -v ${PWD} -w ${PWD} <container> -c " $@"
```
