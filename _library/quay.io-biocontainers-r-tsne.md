---
layout: container
name:  "quay.io/biocontainers/r-tsne"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:07:12.276491"
...
```bash
$ shpc install quay.io/biocontainers/r-tsne
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-tsne:0.1_3--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-tsne/0.1_3--r3.3.1_0
$ module help quay.io/biocontainers/r-tsne/0.1_3--r3.3.1_0
```
...
#### r-tsne-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-tsne-inspect-deffile:
