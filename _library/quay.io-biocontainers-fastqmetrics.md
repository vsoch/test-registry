---
layout: container
name:  "quay.io/biocontainers/fastqmetrics"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:31:23.186752"
latest: "0.1.0--py_2"
...
```bash
$ shpc install quay.io/biocontainers/fastqmetrics
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/fastqmetrics:0.1.0--py_2
```
...
```bash
$ module load quay.io/biocontainers/fastqmetrics/0.1.0--py_2
$ module help quay.io/biocontainers/fastqmetrics/0.1.0--py_2
```
...
#### fastqmetrics-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### fastqmetrics-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/fastqmetrics
$ podman run --it --rm --entrypoint /usr/local/bin/fastqmetrics   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fastqmetrics   -v ${PWD} -w ${PWD} <container> -c " $@"
```
