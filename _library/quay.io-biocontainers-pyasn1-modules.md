---
layout: container
name:  "quay.io/biocontainers/pyasn1-modules"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:25:11.469990"
latest: "0.0.8--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/pyasn1-modules
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyasn1-modules:0.0.8--py35_0
```
...
```bash
$ module load quay.io/biocontainers/pyasn1-modules/0.0.8--py35_0
$ module help quay.io/biocontainers/pyasn1-modules/0.0.8--py35_0
```
...
#### pyasn1-modules-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyasn1-modules-inspect-deffile:
