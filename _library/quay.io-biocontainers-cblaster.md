...
updated_at: "2023-03-10 03:42:26.542781"
latest: "1.3.17--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cblaster:1.3.17--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cblaster/1.3.17--pyhdfd78af_0
$ module help quay.io/biocontainers/cblaster/1.3.17--pyhdfd78af_0
```
