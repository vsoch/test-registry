...
updated_at: "2023-03-09 03:40:16.326681"
latest: "3.12.1--pyhca03a8a_0"
...
```bash
$ shpc install quay.io/biocontainers/biobb_structure_checking:3.12.1--pyhca03a8a_0
```
...
```bash
$ module load quay.io/biocontainers/biobb_structure_checking/3.12.1--pyhca03a8a_0
$ module help quay.io/biocontainers/biobb_structure_checking/3.12.1--pyhca03a8a_0
```
