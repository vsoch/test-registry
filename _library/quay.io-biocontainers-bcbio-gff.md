...
updated_at: "2023-03-10 03:35:24.083211"
latest: "0.6.9--pyh5e36f6f_0"
...
```bash
$ shpc install quay.io/biocontainers/bcbio-gff:0.6.9--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/bcbio-gff/0.6.9--pyh5e36f6f_0
$ module help quay.io/biocontainers/bcbio-gff/0.6.9--pyh5e36f6f_0
```
