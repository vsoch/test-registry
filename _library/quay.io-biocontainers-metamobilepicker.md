---
layout: container
name:  "quay.io/biocontainers/metamobilepicker"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:40:07.060137"
...
```bash
$ shpc install quay.io/biocontainers/metamobilepicker
```
...
#### metamobilepicker-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### metamobilepicker-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/metamobilepicker
$ podman run --it --rm --entrypoint /usr/local/bin/metamobilepicker   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/metamobilepicker   -v ${PWD} -w ${PWD} <container> -c " $@"
```
