---
layout: container
name:  "quay.io/biocontainers/cctk"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:34:17.008525"
...
```bash
$ shpc install quay.io/biocontainers/cctk
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cctk:1.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cctk/1.0--pyhdfd78af_0
$ module help quay.io/biocontainers/cctk/1.0--pyhdfd78af_0
```
...
#### cctk-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cctk-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/cctk
$ podman run --it --rm --entrypoint /usr/local/bin/cctk   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/cctk   -v ${PWD} -w ${PWD} <container> -c " $@"
```
