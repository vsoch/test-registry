---
layout: container
name:  "quay.io/biocontainers/gffmunger"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:26:49.108840"
latest: "0.1.3--py_1"
...
```bash
$ shpc install quay.io/biocontainers/gffmunger
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/gffmunger:0.1.3--py_1
```
...
```bash
$ module load quay.io/biocontainers/gffmunger/0.1.3--py_1
$ module help quay.io/biocontainers/gffmunger/0.1.3--py_1
```
...
#### gffmunger-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gffmunger-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/gffmunger
$ podman run --it --rm --entrypoint /usr/local/bin/gffmunger   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gffmunger   -v ${PWD} -w ${PWD} <container> -c " $@"
```
