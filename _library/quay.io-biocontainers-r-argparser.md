---
layout: container
name:  "quay.io/biocontainers/r-argparser"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:02:50.655006"
latest: "0.4--r3.3.1_0"
...
```bash
$ shpc install quay.io/biocontainers/r-argparser
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-argparser:0.4--r3.3.1_0
```
...
```bash
$ module load quay.io/biocontainers/r-argparser/0.4--r3.3.1_0
$ module help quay.io/biocontainers/r-argparser/0.4--r3.3.1_0
```
...
#### r-argparser-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-argparser-inspect-deffile:
