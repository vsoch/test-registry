---
layout: container
name:  "quay.io/biocontainers/r-htmlwidgets"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:35:41.167562"
latest: "0.5--r3.3.2_0"
...
```bash
$ shpc install quay.io/biocontainers/r-htmlwidgets
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-htmlwidgets:0.5--r3.3.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-htmlwidgets/0.5--r3.3.2_0
$ module help quay.io/biocontainers/r-htmlwidgets/0.5--r3.3.2_0
```
...
#### r-htmlwidgets-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-htmlwidgets-inspect-deffile:
