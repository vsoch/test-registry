...
updated_at: "2023-03-10 03:06:33.711007"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-indeed:2.12.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-indeed/2.12.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-indeed/2.12.0--r42hdfd78af_0
```
