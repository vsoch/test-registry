---
layout: container
name:  "quay.io/biocontainers/cellprofiler-core"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:15:36.260420"
latest: "4.2.5--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/cellprofiler-core
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/cellprofiler-core:4.2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/cellprofiler-core/4.2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/cellprofiler-core/4.2.5--pyhdfd78af_0
```
...
#### cellprofiler-core-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### cellprofiler-core-inspect-deffile:
