---
layout: container
name:  "quay.io/biocontainers/bioconductor-rprimer"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:21:15.917584"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rprimer
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-rprimer:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rprimer/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rprimer/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-rprimer-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-rprimer-inspect-deffile:
