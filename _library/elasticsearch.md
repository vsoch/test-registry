...
updated_at: "2023-03-09 02:54:34.775316"
latest: "8.6.1"
...
```bash
$ shpc install elasticsearch:8.6.1
```
...
```bash
$ module load elasticsearch/8.6.1
$ module help elasticsearch/8.6.1
```
