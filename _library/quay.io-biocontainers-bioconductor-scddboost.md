---
layout: container
name:  "quay.io/biocontainers/bioconductor-scddboost"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:14:13.000844"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-scddboost
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-scddboost:1.0.0--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-scddboost/1.0.0--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-scddboost/1.0.0--r42hc247a5b_0
```
...
#### bioconductor-scddboost-inspect:
...
#### bioconductor-scddboost-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-scddboost-inspect-deffile:
