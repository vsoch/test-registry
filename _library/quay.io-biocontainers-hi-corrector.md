...
updated_at: "2023-03-09 02:57:20.759615"
latest: "1.2--hee9e358_1"
...
```bash
$ shpc install quay.io/biocontainers/hi-corrector:1.2--hee9e358_1
```
...
```bash
$ module load quay.io/biocontainers/hi-corrector/1.2--hee9e358_1
$ module help quay.io/biocontainers/hi-corrector/1.2--hee9e358_1
```
