...
updated_at: "2023-03-09 03:12:08.355497"
latest: "0.1.5--py37h466c021_3"
...
```bash
$ shpc install quay.io/biocontainers/deltapd:0.1.5--py37h466c021_3
```
...
```bash
$ module load quay.io/biocontainers/deltapd/0.1.5--py37h466c021_3
$ module help quay.io/biocontainers/deltapd/0.1.5--py37h466c021_3
```
