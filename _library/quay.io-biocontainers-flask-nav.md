---
layout: container
name:  "quay.io/biocontainers/flask-nav"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:03:52.506182"
latest: "0.5--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/flask-nav
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/flask-nav:0.5--py36_0
```
...
```bash
$ module load quay.io/biocontainers/flask-nav/0.5--py36_0
$ module help quay.io/biocontainers/flask-nav/0.5--py36_0
```
...
#### flask-nav-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### flask-nav-inspect-deffile:
