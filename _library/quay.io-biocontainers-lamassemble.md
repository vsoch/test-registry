...
updated_at: "2023-03-10 03:15:00.333559"
latest: "1.4.2--pyh3252c3a_0"
...
```bash
$ shpc install quay.io/biocontainers/lamassemble:1.4.2--pyh3252c3a_0
```
...
```bash
$ module load quay.io/biocontainers/lamassemble/1.4.2--pyh3252c3a_0
$ module help quay.io/biocontainers/lamassemble/1.4.2--pyh3252c3a_0
```
