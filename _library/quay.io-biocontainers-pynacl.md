---
layout: container
name:  "quay.io/biocontainers/pynacl"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:42:51.127083"
latest: "0.3.0--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/pynacl
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pynacl:0.3.0--py36_0
```
...
```bash
$ module load quay.io/biocontainers/pynacl/0.3.0--py36_0
$ module help quay.io/biocontainers/pynacl/0.3.0--py36_0
```
...
#### pynacl-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pynacl-inspect-deffile:
