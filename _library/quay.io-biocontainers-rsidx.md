---
layout: container
name:  "quay.io/biocontainers/rsidx"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:23:36.538801"
...
```bash
$ shpc install quay.io/biocontainers/rsidx
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/rsidx:0.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/rsidx/0.3--pyhdfd78af_0
$ module help quay.io/biocontainers/rsidx/0.3--pyhdfd78af_0
```
...
#### rsidx-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### rsidx-inspect-deffile:
