---
layout: container
name:  "quay.io/biocontainers/toposort"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:05:44.144600"
latest: "1.4--py35_0"
...
versions:
 - "1.4--py35_0"
description: "shpc-registry automated BioContainers addition for toposort"
config: {"url": "https://biocontainers.pro/tools/toposort", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for toposort", "latest": {"1.4--py35_0": "sha256:e530e9fadf6f85a8d6a25b1abfe75d4dca6a8b8ccc3fdd8da55d4b3b0404237b"}, "tags": {"1.4--py35_0": "sha256:e530e9fadf6f85a8d6a25b1abfe75d4dca6a8b8ccc3fdd8da55d4b3b0404237b"}, "docker": "quay.io/biocontainers/toposort", "aliases": {"easy_install-3.5": "/usr/local/bin/easy_install-3.5", "2to3-3.5": "/usr/local/bin/2to3-3.5", "idle3.5": "/usr/local/bin/idle3.5", "pydoc3.5": "/usr/local/bin/pydoc3.5", "python3.5": "/usr/local/bin/python3.5", "python3.5-config": "/usr/local/bin/python3.5-config", "python3.5m": "/usr/local/bin/python3.5m", "python3.5m-config": "/usr/local/bin/python3.5m-config", "pyvenv-3.5": "/usr/local/bin/pyvenv-3.5", "tclsh8.5": "/usr/local/bin/tclsh8.5"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/toposort.
shpc-registry automated BioContainers addition for toposort
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/toposort
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/toposort:1.4--py35_0
```
...
```bash
$ module load quay.io/biocontainers/toposort/1.4--py35_0
$ module help quay.io/biocontainers/toposort/1.4--py35_0
```
...
#### toposort-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### toposort-inspect-deffile:
