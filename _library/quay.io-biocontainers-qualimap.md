---
layout: container
name:  "quay.io/biocontainers/qualimap"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:09:31.137373"
...
```bash
$ shpc install quay.io/biocontainers/qualimap
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/qualimap:2.2.2d--hdfd78af_2
```
...
```bash
$ module load quay.io/biocontainers/qualimap/2.2.2d--hdfd78af_2
$ module help quay.io/biocontainers/qualimap/2.2.2d--hdfd78af_2
```
...
#### qualimap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### qualimap-inspect-deffile:
