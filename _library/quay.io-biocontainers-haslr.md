...
updated_at: "2023-03-09 03:09:57.390504"
latest: "0.8a1--py37h595c7a6_3"
...
```bash
$ shpc install quay.io/biocontainers/haslr:0.8a1--py37h595c7a6_3
```
...
```bash
$ module load quay.io/biocontainers/haslr/0.8a1--py37h595c7a6_3
$ module help quay.io/biocontainers/haslr/0.8a1--py37h595c7a6_3
```
