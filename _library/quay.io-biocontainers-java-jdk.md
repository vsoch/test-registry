---
layout: container
name:  "quay.io/biocontainers/java-jdk"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:33:11.430895"
latest: "8.0.112--1"
...
```bash
$ shpc install quay.io/biocontainers/java-jdk
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/java-jdk:8.0.112--1
```
...
```bash
$ module load quay.io/biocontainers/java-jdk/8.0.112--1
$ module help quay.io/biocontainers/java-jdk/8.0.112--1
```
...
#### java-jdk-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### java-jdk-inspect-deffile:
