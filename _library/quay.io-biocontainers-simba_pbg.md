---
layout: container
name:  "quay.io/biocontainers/simba_pbg"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:24:47.557699"
...
```bash
$ shpc install quay.io/biocontainers/simba_pbg
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/simba_pbg:1.2--py39hbf8eff0_0
```
...
```bash
$ module load quay.io/biocontainers/simba_pbg/1.2--py39hbf8eff0_0
$ module help quay.io/biocontainers/simba_pbg/1.2--py39hbf8eff0_0
```
...
#### simba_pbg-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### simba_pbg-inspect-deffile:
