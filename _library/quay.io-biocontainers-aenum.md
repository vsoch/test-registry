---
layout: container
name:  "quay.io/biocontainers/aenum"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:35:45.524662"
latest: "2.0.8--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/aenum
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/aenum:2.0.8--py35_0
```
...
```bash
$ module load quay.io/biocontainers/aenum/2.0.8--py35_0
$ module help quay.io/biocontainers/aenum/2.0.8--py35_0
```
...
#### aenum-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### aenum-inspect-deffile:
