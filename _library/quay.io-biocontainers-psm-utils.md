---
layout: container
name:  "quay.io/biocontainers/psm-utils"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:13:57.814998"
...
```bash
$ shpc install quay.io/biocontainers/psm-utils
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/psm-utils:0.2.1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/psm-utils/0.2.1--pyhdfd78af_0
$ module help quay.io/biocontainers/psm-utils/0.2.1--pyhdfd78af_0
```
...
#### psm-utils-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### psm-utils-inspect-deffile:
