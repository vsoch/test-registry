---
layout: container
name:  "quay.io/biocontainers/pycli"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:04:28.782973"
latest: "2.0.3--py_1"
...
```bash
$ shpc install quay.io/biocontainers/pycli
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pycli:2.0.3--py_1
```
...
```bash
$ module load quay.io/biocontainers/pycli/2.0.3--py_1
$ module help quay.io/biocontainers/pycli/2.0.3--py_1
```
...
#### pycli-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pycli-inspect-deffile:
