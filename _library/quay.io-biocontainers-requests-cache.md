---
layout: container
name:  "quay.io/biocontainers/requests-cache"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:33:53.055823"
...
```bash
$ shpc install quay.io/biocontainers/requests-cache
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/requests-cache:0.4.10--py35_0
```
...
```bash
$ module load quay.io/biocontainers/requests-cache/0.4.10--py35_0
$ module help quay.io/biocontainers/requests-cache/0.4.10--py35_0
```
...
#### requests-cache-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### requests-cache-inspect-deffile:
