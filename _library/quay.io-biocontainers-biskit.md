---
layout: container
name:  "quay.io/biocontainers/biskit"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:18:07.897889"
latest: "2.5.1--py_0"
...
```bash
$ shpc install quay.io/biocontainers/biskit
```
...
#### biskit-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### biskit-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bis.py
$ podman run --it --rm --entrypoint /usr/local/bin/bis.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bis.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
