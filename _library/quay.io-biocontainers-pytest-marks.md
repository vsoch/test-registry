---
layout: container
name:  "quay.io/biocontainers/pytest-marks"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:06:40.595641"
latest: "0.4--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/pytest-marks
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pytest-marks:0.4--py36_0
```
...
```bash
$ module load quay.io/biocontainers/pytest-marks/0.4--py36_0
$ module help quay.io/biocontainers/pytest-marks/0.4--py36_0
```
...
#### pytest-marks-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pytest-marks-inspect-deffile:
