---
layout: container
name:  "quay.io/biocontainers/r-rniftyreg"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:03:32.888359"
...
```bash
$ shpc install quay.io/biocontainers/r-rniftyreg
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-rniftyreg:2.2.0--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-rniftyreg/2.2.0--r3.2.2_0
$ module help quay.io/biocontainers/r-rniftyreg/2.2.0--r3.2.2_0
```
...
#### r-rniftyreg-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-rniftyreg-inspect-deffile:
