...
updated_at: "2023-03-09 03:20:07.701423"
...
```bash
$ shpc install quay.io/biocontainers/dinf:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/dinf/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/dinf/0.3.0--pyhdfd78af_0
```
