...
updated_at: "2023-03-10 03:22:12.779683"
...
```bash
$ shpc install quay.io/biocontainers/semibin:1.5.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/semibin/1.5.0--pyhdfd78af_1
$ module help quay.io/biocontainers/semibin/1.5.0--pyhdfd78af_1
```
