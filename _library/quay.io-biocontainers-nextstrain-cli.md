...
updated_at: "2023-03-10 03:00:52.999825"
latest: "6.2.0--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:6.2.0--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/6.2.0--pyhdfd78af_1
$ module help quay.io/biocontainers/nextstrain-cli/6.2.0--pyhdfd78af_1
```
