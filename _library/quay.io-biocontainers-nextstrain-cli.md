...
updated_at: "2023-03-09 03:04:08.173585"
latest: "6.1.0.post1--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/nextstrain-cli:6.1.0.post1--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/nextstrain-cli/6.1.0.post1--pyhdfd78af_0
$ module help quay.io/biocontainers/nextstrain-cli/6.1.0.post1--pyhdfd78af_0
```
