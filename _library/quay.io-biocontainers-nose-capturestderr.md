---
layout: container
name:  "quay.io/biocontainers/nose-capturestderr"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:25:20.222246"
latest: "1.2--py27_0"
...
```bash
$ shpc install quay.io/biocontainers/nose-capturestderr
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/nose-capturestderr:1.2--py27_0
```
...
```bash
$ module load quay.io/biocontainers/nose-capturestderr/1.2--py27_0
$ module help quay.io/biocontainers/nose-capturestderr/1.2--py27_0
```
...
#### nose-capturestderr-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### nose-capturestderr-inspect-deffile:
