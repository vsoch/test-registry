---
layout: container
name:  "quay.io/biocontainers/pyaml"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:31:25.397745"
...
```bash
$ shpc install quay.io/biocontainers/pyaml
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyaml:15.8.2--py36_0
```
...
```bash
$ module load quay.io/biocontainers/pyaml/15.8.2--py36_0
$ module help quay.io/biocontainers/pyaml/15.8.2--py36_0
```
...
#### pyaml-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyaml-inspect-deffile:
