---
layout: container
name:  "quay.io/biocontainers/perl-border-style"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:06:29.048054"
...
```bash
$ shpc install quay.io/biocontainers/perl-border-style
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/perl-border-style:0.01--pl5321hdfd78af_3
```
...
```bash
$ module load quay.io/biocontainers/perl-border-style/0.01--pl5321hdfd78af_3
$ module help quay.io/biocontainers/perl-border-style/0.01--pl5321hdfd78af_3
```
...
#### perl-border-style-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-border-style-inspect-deffile:
