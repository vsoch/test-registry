...
updated_at: "2023-03-09 03:36:51.047247"
latest: "0.3.4--r42hdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/r-acidsinglecell:0.3.4--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/r-acidsinglecell/0.3.4--r42hdfd78af_0
$ module help quay.io/biocontainers/r-acidsinglecell/0.3.4--r42hdfd78af_0
```
