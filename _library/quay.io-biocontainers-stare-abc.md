...
updated_at: "2023-03-10 03:38:13.631583"
latest: "1.0.3.1--h72a8191_0"
...
```bash
$ shpc install quay.io/biocontainers/stare-abc:1.0.3.1--h72a8191_0
```
...
```bash
$ module load quay.io/biocontainers/stare-abc/1.0.3.1--h72a8191_0
$ module help quay.io/biocontainers/stare-abc/1.0.3.1--h72a8191_0
```
