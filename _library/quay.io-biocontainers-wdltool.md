---
layout: container
name:  "quay.io/biocontainers/wdltool"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:41:01.228477"
latest: "0.14--1"
...
```bash
$ shpc install quay.io/biocontainers/wdltool
```
...
#### wdltool-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### wdltool-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/wdltool
$ podman run --it --rm --entrypoint /usr/local/bin/wdltool   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/wdltool   -v ${PWD} -w ${PWD} <container> -c " $@"
```
