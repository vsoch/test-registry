---
layout: container
name:  "quay.io/biocontainers/fgbio-minimal"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:24:28.114508"
...
```bash
$ shpc install quay.io/biocontainers/fgbio-minimal
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/fgbio-minimal:2.1.0--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/fgbio-minimal/2.1.0--hdfd78af_0
$ module help quay.io/biocontainers/fgbio-minimal/2.1.0--hdfd78af_0
```
...
#### fgbio-minimal-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### fgbio-minimal-inspect-deffile:
