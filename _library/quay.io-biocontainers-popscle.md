---
layout: container
name:  "quay.io/biocontainers/popscle"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:14:48.613606"
...
```bash
$ shpc install quay.io/biocontainers/popscle
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/popscle:0.1beta--h985387c_1
```
...
```bash
$ module load quay.io/biocontainers/popscle/0.1beta--h985387c_1
$ module help quay.io/biocontainers/popscle/0.1beta--h985387c_1
```
...
#### popscle-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### popscle-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/popscle
$ podman run --it --rm --entrypoint /usr/local/bin/popscle   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/popscle   -v ${PWD} -w ${PWD} <container> -c " $@"
```
