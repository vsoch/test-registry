...
updated_at: "2023-03-10 03:33:43.078193"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-rtcga.cnv:1.25.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-rtcga.cnv/1.25.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-rtcga.cnv/1.25.0--r42hdfd78af_0
```
