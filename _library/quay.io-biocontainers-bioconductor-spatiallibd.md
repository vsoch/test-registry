---
layout: container
name:  "quay.io/biocontainers/bioconductor-spatiallibd"
maintainer: "@vsoch"
github: "https://github.com/singularityhub/shpc-registry/blob/main/quay.io/biocontainers/bioconductor-spatiallibd/container.yaml"
config_url: "https://raw.githubusercontent.com/singularityhub/shpc-registry/main/quay.io/biocontainers/bioconductor-spatiallibd/container.yaml"
updated_at: "2023-03-09 03:24:53.626893"
latest: "1.10.0--r42hdfd78af_0"
container_url: "https://biocontainers.pro/tools/bioconductor-spatiallibd"
aliases:
...
description: "shpc-registry automated BioContainers addition for bioconductor-spatiallibd"
config: {"url": "https://biocontainers.pro/tools/bioconductor-spatiallibd", "maintainer": "@vsoch", "description": "shpc-registry automated BioContainers addition for bioconductor-spatiallibd", "latest": {"1.10.0--r42hdfd78af_0": "sha256:5a5519539f1f948e939a93280b5217705a98cd53fc8bfb1741ee857fe51cdaeb"}, "tags": {"1.6.0--r41hdfd78af_0": "sha256:116d75ecb820397199e58ae477d7216b6ffee72a4fcd7763a5561f03d308b60f", "1.10.0--r42hdfd78af_0": "sha256:5a5519539f1f948e939a93280b5217705a98cd53fc8bfb1741ee857fe51cdaeb"}, "docker": "quay.io/biocontainers/bioconductor-spatiallibd", "aliases": {"x86_64-conda-linux-gnu-pkg-config": "/usr/local/bin/x86_64-conda-linux-gnu-pkg-config", "Magick++-config": "/usr/local/bin/Magick++-config", "MagickCore-config": "/usr/local/bin/MagickCore-config", "MagickWand-config": "/usr/local/bin/MagickWand-config", "animate": "/usr/local/bin/animate", "composite": "/usr/local/bin/composite", "conjure": "/usr/local/bin/conjure", "convert": "/usr/local/bin/convert", "display": "/usr/local/bin/display", "identify": "/usr/local/bin/identify"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-spatiallibd.
shpc-registry automated BioContainers addition for bioconductor-spatiallibd
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-spatiallibd
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-spatiallibd:1.10.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-spatiallibd/1.10.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-spatiallibd/1.10.0--r42hdfd78af_0
```
...
#### bioconductor-spatiallibd-shell:
...
#### bioconductor-spatiallibd-inspect:
...
#### bioconductor-spatiallibd-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-spatiallibd-inspect-deffile:
