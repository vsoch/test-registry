---
layout: container
name:  "quay.io/biocontainers/vkmz"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:13:26.110348"
latest: "1.4.6--py_0"
...
```bash
$ shpc install quay.io/biocontainers/vkmz
```
...
#### vkmz-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### vkmz-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/vkmz
$ podman run --it --rm --entrypoint /usr/local/bin/vkmz   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/vkmz   -v ${PWD} -w ${PWD} <container> -c " $@"
```
