---
layout: container
name:  "quay.io/biocontainers/ruamel.yaml"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:33:53.663675"
...
```bash
$ shpc install quay.io/biocontainers/ruamel.yaml
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ruamel.yaml:0.12.13--py35_0
```
...
```bash
$ module load quay.io/biocontainers/ruamel.yaml/0.12.13--py35_0
$ module help quay.io/biocontainers/ruamel.yaml/0.12.13--py35_0
```
...
#### ruamel.yaml-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ruamel.yaml-inspect-deffile:
