---
layout: container
name:  "quay.io/biocontainers/munkres"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:00:33.914120"
latest: "1.0.7--py_1"
...
```bash
$ shpc install quay.io/biocontainers/munkres
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/munkres:1.0.7--py_1
```
...
```bash
$ module load quay.io/biocontainers/munkres/1.0.7--py_1
$ module help quay.io/biocontainers/munkres/1.0.7--py_1
```
...
#### munkres-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### munkres-inspect-deffile:
