---
layout: container
name:  "quay.io/biocontainers/paraphase"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:35:41.952604"
...
```bash
$ shpc install quay.io/biocontainers/paraphase
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/paraphase:1.1.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/paraphase/1.1.3--pyhdfd78af_0
$ module help quay.io/biocontainers/paraphase/1.1.3--pyhdfd78af_0
```
...
#### paraphase-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### paraphase-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/paraphase
$ podman run --it --rm --entrypoint /usr/local/bin/paraphase   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/paraphase   -v ${PWD} -w ${PWD} <container> -c " $@"
```
