---
layout: container
name:  "quay.io/biocontainers/thesias"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:30:25.924695"
...
```bash
$ shpc install quay.io/biocontainers/thesias
```
...
#### thesias-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### thesias-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/THESIAS
$ podman run --it --rm --entrypoint /usr/local/bin/THESIAS   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/THESIAS   -v ${PWD} -w ${PWD} <container> -c " $@"
```
