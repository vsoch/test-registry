---
layout: container
name:  "quay.io/biocontainers/manormfast"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:23:02.399470"
latest: "0.1.2--py36_1"
...
```bash
$ shpc install quay.io/biocontainers/manormfast
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/manormfast:0.1.2--py36_1
```
...
```bash
$ module load quay.io/biocontainers/manormfast/0.1.2--py36_1
$ module help quay.io/biocontainers/manormfast/0.1.2--py36_1
```
...
#### manormfast-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### manormfast-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/MAnormFast
$ podman run --it --rm --entrypoint /usr/local/bin/MAnormFast   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/MAnormFast   -v ${PWD} -w ${PWD} <container> -c " $@"
```
