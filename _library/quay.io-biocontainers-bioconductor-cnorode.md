---
layout: container
name:  "quay.io/biocontainers/bioconductor-cnorode"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:41:55.892571"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnorode
```
...
#### bioconductor-cnorode-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cnorode-inspect-deffile:
