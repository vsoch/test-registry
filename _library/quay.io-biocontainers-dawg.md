...
updated_at: "2023-03-10 03:00:48.765939"
...
```bash
$ shpc install quay.io/biocontainers/dawg
```
...
#### dawg-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### dawg-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/dawg
$ podman run --it --rm --entrypoint /usr/local/bin/dawg   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/dawg   -v ${PWD} -w ${PWD} <container> -c " $@"
```
