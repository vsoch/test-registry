---
layout: container
name:  "quay.io/biocontainers/infinity"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:27:49.199584"
latest: "1.4--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/infinity
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/infinity:1.4--py35_0
```
...
```bash
$ module load quay.io/biocontainers/infinity/1.4--py35_0
$ module help quay.io/biocontainers/infinity/1.4--py35_0
```
...
#### infinity-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### infinity-inspect-deffile:
