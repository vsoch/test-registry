---
layout: container
name:  "quay.io/biocontainers/svgutils"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:39:24.889471"
latest: "0.1.0--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/svgutils
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/svgutils:0.1.0--py36_0
```
...
```bash
$ module load quay.io/biocontainers/svgutils/0.1.0--py36_0
$ module help quay.io/biocontainers/svgutils/0.1.0--py36_0
```
...
#### svgutils-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### svgutils-inspect-deffile:
