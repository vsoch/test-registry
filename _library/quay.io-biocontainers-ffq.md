---
layout: container
name:  "quay.io/biocontainers/ffq"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:07:52.519883"
...
```bash
$ shpc install quay.io/biocontainers/ffq
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ffq:0.3.0--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/ffq/0.3.0--pyhdfd78af_0
$ module help quay.io/biocontainers/ffq/0.3.0--pyhdfd78af_0
```
