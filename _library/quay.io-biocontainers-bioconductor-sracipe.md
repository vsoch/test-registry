...
updated_at: "2023-03-10 03:12:55.674604"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-sracipe:1.14.0--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-sracipe/1.14.0--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-sracipe/1.14.0--r42hc247a5b_0
```
