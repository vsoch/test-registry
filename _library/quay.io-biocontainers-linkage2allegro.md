---
layout: container
name:  "quay.io/biocontainers/linkage2allegro"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:38:21.195695"
latest: "2017.3--py_1"
...
```bash
$ shpc install quay.io/biocontainers/linkage2allegro
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/linkage2allegro:2017.3--py_1
```
...
```bash
$ module load quay.io/biocontainers/linkage2allegro/2017.3--py_1
$ module help quay.io/biocontainers/linkage2allegro/2017.3--py_1
```
...
#### linkage2allegro-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### linkage2allegro-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/linkage2allegro
$ podman run --it --rm --entrypoint /usr/local/bin/linkage2allegro   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/linkage2allegro   -v ${PWD} -w ${PWD} <container> -c " $@"
```
