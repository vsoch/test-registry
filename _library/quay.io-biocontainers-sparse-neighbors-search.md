---
layout: container
name:  "quay.io/biocontainers/sparse-neighbors-search"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:26:08.728716"
...
```bash
$ shpc install quay.io/biocontainers/sparse-neighbors-search
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/sparse-neighbors-search:0.7--py37h675a0cb_2
```
...
```bash
$ module load quay.io/biocontainers/sparse-neighbors-search/0.7--py37h675a0cb_2
$ module help quay.io/biocontainers/sparse-neighbors-search/0.7--py37h675a0cb_2
```
...
#### sparse-neighbors-search-inspect:
...
#### sparse-neighbors-search-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### sparse-neighbors-search-inspect-deffile:
