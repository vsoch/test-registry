---
layout: container
name:  "quay.io/biocontainers/bioconductor-vdjdive"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:02:08.582444"
...
versions:
 - "1.0.0--r42hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-vdjdive"
config: {"url": "https://biocontainers.pro/tools/bioconductor-vdjdive", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-vdjdive", "latest": {"1.0.0--r42hdfd78af_0": "sha256:61fcf321fe78949634680194abe2e420876f7feb430bc74f5de03c713ffa38a7"}, "tags": {"1.0.0--r42hdfd78af_0": "sha256:61fcf321fe78949634680194abe2e420876f7feb430bc74f5de03c713ffa38a7"}, "docker": "quay.io/biocontainers/bioconductor-vdjdive", "aliases": {"installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-vdjdive.
singularity registry hpc automated addition for bioconductor-vdjdive
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-vdjdive
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-vdjdive:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-vdjdive/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-vdjdive/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-vdjdive-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-vdjdive-inspect-deffile:
