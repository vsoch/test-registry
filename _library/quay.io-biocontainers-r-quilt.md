...
updated_at: "2023-03-10 03:17:30.045417"
latest: "1.0.3--r42h37595e4_2"
...
```bash
$ shpc install quay.io/biocontainers/r-quilt:1.0.3--r42h37595e4_2
```
...
```bash
$ module load quay.io/biocontainers/r-quilt/1.0.3--r42h37595e4_2
$ module help quay.io/biocontainers/r-quilt/1.0.3--r42h37595e4_2
```
