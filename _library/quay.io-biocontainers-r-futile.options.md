---
layout: container
name:  "quay.io/biocontainers/r-futile.options"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:33:42.848567"
...
```bash
$ shpc install quay.io/biocontainers/r-futile.options
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-futile.options:1.0.0--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-futile.options/1.0.0--r3.2.2_0
$ module help quay.io/biocontainers/r-futile.options/1.0.0--r3.2.2_0
```
...
#### r-futile.options-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-futile.options-inspect-deffile:
