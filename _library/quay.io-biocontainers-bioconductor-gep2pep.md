---
layout: container
name:  "quay.io/biocontainers/bioconductor-gep2pep"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:41:17.339278"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-gep2pep
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-gep2pep:1.18.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-gep2pep/1.18.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-gep2pep/1.18.0--r42hdfd78af_0
```
...
#### bioconductor-gep2pep-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-gep2pep-inspect-deffile:
