---
layout: container
name:  "quay.io/biocontainers/ribocutter"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:07:15.372771"
...
```bash
$ shpc install quay.io/biocontainers/ribocutter
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/ribocutter:0.1.1--pyh5e36f6f_0
```
...
```bash
$ module load quay.io/biocontainers/ribocutter/0.1.1--pyh5e36f6f_0
$ module help quay.io/biocontainers/ribocutter/0.1.1--pyh5e36f6f_0
```
...
#### ribocutter-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### ribocutter-inspect-deffile:
