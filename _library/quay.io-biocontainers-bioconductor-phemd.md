---
layout: container
name:  "quay.io/biocontainers/bioconductor-phemd"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:14:22.709218"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phemd
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-phemd:1.6.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phemd/1.6.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-phemd/1.6.0--r40hdfd78af_1
```
...
#### bioconductor-phemd-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-phemd-inspect-deffile:
