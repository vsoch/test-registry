---
layout: container
name:  "quay.io/biocontainers/pybamparser"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:33:12.981055"
latest: "0.0.3--py_2"
...
```bash
$ shpc install quay.io/biocontainers/pybamparser
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pybamparser:0.0.3--py_2
```
...
```bash
$ module load quay.io/biocontainers/pybamparser/0.0.3--py_2
$ module help quay.io/biocontainers/pybamparser/0.0.3--py_2
```
...
#### pybamparser-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pybamparser-inspect-deffile:
