---
layout: container
name:  "quay.io/biocontainers/gffutils"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:39:47.901213"
...
```bash
$ shpc install quay.io/biocontainers/gffutils
```
...
#### gffutils-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gffutils-inspect-deffile:
