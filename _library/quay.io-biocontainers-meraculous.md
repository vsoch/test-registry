...
updated_at: "2023-03-09 03:10:59.930266"
...
```bash
$ shpc install quay.io/biocontainers/meraculous:2.2.6--pl5321h2df963e_4
```
...
```bash
$ module load quay.io/biocontainers/meraculous/2.2.6--pl5321h2df963e_4
$ module help quay.io/biocontainers/meraculous/2.2.6--pl5321h2df963e_4
```
