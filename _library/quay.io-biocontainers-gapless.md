---
layout: container
name:  "quay.io/biocontainers/gapless"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:01:14.549051"
...
versions:
 - "0.4--hdfd78af_0"
description: "singularity registry hpc automated addition for gapless"
config: {"url": "https://biocontainers.pro/tools/gapless", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for gapless", "latest": {"0.4--hdfd78af_0": "sha256:9dcaf3c65e811fb54fba70ea798c724947309d55d3448439139b5c8057d98171"}, "tags": {"0.4--hdfd78af_0": "sha256:9dcaf3c65e811fb54fba70ea798c724947309d55d3448439139b5c8057d98171"}, "docker": "quay.io/biocontainers/gapless", "aliases": {"f2py3.11": "/usr/local/bin/f2py3.11", "gapless.py": "/usr/local/bin/gapless.py", "gapless.sh": "/usr/local/bin/gapless.sh", "2to3-3.11": "/usr/local/bin/2to3-3.11", "idle3.11": "/usr/local/bin/idle3.11", "pydoc3.11": "/usr/local/bin/pydoc3.11", "python3.11": "/usr/local/bin/python3.11", "python3.11-config": "/usr/local/bin/python3.11-config", "fonttools": "/usr/local/bin/fonttools", "pyftmerge": "/usr/local/bin/pyftmerge", "pyftsubset": "/usr/local/bin/pyftsubset", "ttx": "/usr/local/bin/ttx", "brotli": "/usr/local/bin/brotli", "opj_compress": "/usr/local/bin/opj_compress", "opj_decompress": "/usr/local/bin/opj_decompress", "opj_dump": "/usr/local/bin/opj_dump", "python3.1": "/usr/local/bin/python3.1", "jpgicc": "/usr/local/bin/jpgicc", "linkicc": "/usr/local/bin/linkicc", "psicc": "/usr/local/bin/psicc", "tificc": "/usr/local/bin/tificc", "transicc": "/usr/local/bin/transicc"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/gapless.
singularity registry hpc automated addition for gapless
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/gapless
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/gapless:0.4--hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/gapless/0.4--hdfd78af_0
$ module help quay.io/biocontainers/gapless/0.4--hdfd78af_0
```
...
#### gapless-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### gapless-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/gapless.py
$ podman run --it --rm --entrypoint /usr/local/bin/gapless.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gapless.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gapless.sh
$ podman run --it --rm --entrypoint /usr/local/bin/gapless.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gapless.sh   -v ${PWD} -w ${PWD} <container> -c " $@"
```
