---
layout: container
name:  "quay.io/biocontainers/bioconductor-ucscrepeatmasker"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:00:34.837142"
latest: "3.15.2--r42hdfd78af_0"
...
aliases:
 ...
 - "python3.1"
versions:
 - "3.15.2--r42hdfd78af_0"
description: "singularity registry hpc automated addition for bioconductor-ucscrepeatmasker"
config: {"url": "https://biocontainers.pro/tools/bioconductor-ucscrepeatmasker", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for bioconductor-ucscrepeatmasker", "latest": {"3.15.2--r42hdfd78af_0": "sha256:92cd28487d51c5afabea13409e7d6cca170b1457543d4beafb91af494dc049f0"}, "tags": {"3.15.2--r42hdfd78af_0": "sha256:92cd28487d51c5afabea13409e7d6cca170b1457543d4beafb91af494dc049f0"}, "docker": "quay.io/biocontainers/bioconductor-ucscrepeatmasker", "aliases": {"installBiocDataPackage.sh": "/usr/local/bin/installBiocDataPackage.sh", "tomlq": "/usr/local/bin/tomlq", "xq": "/usr/local/bin/xq", "yq": "/usr/local/bin/yq", "jq": "/usr/local/bin/jq", "onig-config": "/usr/local/bin/onig-config", "activate-global-python-argcomplete": "/usr/local/bin/activate-global-python-argcomplete", "python-argcomplete-check-easy-install-script": "/usr/local/bin/python-argcomplete-check-easy-install-script", "python-argcomplete-tcsh": "/usr/local/bin/python-argcomplete-tcsh", "register-python-argcomplete": "/usr/local/bin/register-python-argcomplete", "2to3-3.10": "/usr/local/bin/2to3-3.10", "idle3.10": "/usr/local/bin/idle3.10", "pydoc3.10": "/usr/local/bin/pydoc3.10", "python3.10": "/usr/local/bin/python3.10", "python3.10-config": "/usr/local/bin/python3.10-config", "python3.1": "/usr/local/bin/python3.1"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/bioconductor-ucscrepeatmasker.
singularity registry hpc automated addition for bioconductor-ucscrepeatmasker
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/bioconductor-ucscrepeatmasker
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-ucscrepeatmasker:3.15.2--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-ucscrepeatmasker/3.15.2--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-ucscrepeatmasker/3.15.2--r42hdfd78af_0
```
...
#### bioconductor-ucscrepeatmasker-run:
...
#### bioconductor-ucscrepeatmasker-shell:
...
#### bioconductor-ucscrepeatmasker-exec:
...
#### bioconductor-ucscrepeatmasker-inspect:
...
#### bioconductor-ucscrepeatmasker-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-ucscrepeatmasker-inspect-deffile:
