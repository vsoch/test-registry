---
layout: container
name:  "quay.io/biocontainers/bioconductor-phenomis"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:57:01.590387"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-phenomis
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-phenomis:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-phenomis/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-phenomis/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-phenomis-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-phenomis-inspect-deffile:
