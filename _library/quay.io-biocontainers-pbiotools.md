...
updated_at: "2023-03-10 03:07:07.844865"
latest: "4.0.1--pyh7cba7a3_0"
...
```bash
$ shpc install quay.io/biocontainers/pbiotools:4.0.1--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pbiotools/4.0.1--pyh7cba7a3_0
$ module help quay.io/biocontainers/pbiotools/4.0.1--pyh7cba7a3_0
```
