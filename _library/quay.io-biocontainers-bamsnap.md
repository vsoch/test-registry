---
layout: container
name:  "quay.io/biocontainers/bamsnap"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:15:13.365377"
latest: "0.2.19--py_0"
...
```bash
$ shpc install quay.io/biocontainers/bamsnap
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bamsnap:0.2.19--py_0
```
...
```bash
$ module load quay.io/biocontainers/bamsnap/0.2.19--py_0
$ module help quay.io/biocontainers/bamsnap/0.2.19--py_0
```
...
#### bamsnap-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bamsnap-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/bamsnap
$ podman run --it --rm --entrypoint /usr/local/bin/bamsnap   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bamsnap   -v ${PWD} -w ${PWD} <container> -c " $@"
```
