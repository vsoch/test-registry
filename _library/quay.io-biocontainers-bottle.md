---
layout: container
name:  "quay.io/biocontainers/bottle"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:09:19.618097"
...
```bash
$ shpc install quay.io/biocontainers/bottle
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bottle:0.12.9--py35_0
```
...
```bash
$ module load quay.io/biocontainers/bottle/0.12.9--py35_0
$ module help quay.io/biocontainers/bottle/0.12.9--py35_0
```
...
#### bottle-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bottle-inspect-deffile:
