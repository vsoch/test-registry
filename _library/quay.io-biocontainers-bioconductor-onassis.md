---
layout: container
name:  "quay.io/biocontainers/bioconductor-onassis"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:34:56.085913"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-onassis
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-onassis:1.12.0--r40hdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-onassis/1.12.0--r40hdfd78af_1
$ module help quay.io/biocontainers/bioconductor-onassis/1.12.0--r40hdfd78af_1
```
...
#### bioconductor-onassis-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-onassis-inspect-deffile:
