---
layout: container
name:  "quay.io/biocontainers/phylofisher"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:20:47.999283"
...
versions:
 - "1.2.5--pyhdfd78af_0"
description: "singularity registry hpc automated addition for phylofisher"
config: {"url": "https://biocontainers.pro/tools/phylofisher", "maintainer": "@vsoch", "description": "singularity registry hpc automated addition for phylofisher", "latest": {"1.2.5--pyhdfd78af_0": "sha256:f7cd674f5616080d61e63f567fa8100f35cb5031c92b1379839a9f413bfbdbb3"}, "tags": {"1.2.5--pyhdfd78af_0": "sha256:f7cd674f5616080d61e63f567fa8100f35cb5031c92b1379839a9f413bfbdbb3"}, "docker": "quay.io/biocontainers/phylofisher", "aliases": {"aa_comp_calculator.py": "/usr/local/bin/aa_comp_calculator.py", "aa_recoder.py": "/usr/local/bin/aa_recoder.py", "apply_to_db.py": "/usr/local/bin/apply_to_db.py", "astral": "/usr/local/bin/astral", "astral_runner.py": "/usr/local/bin/astral_runner.py", "attr": "/usr/local/bin/attr", "backup_restoration.py": "/usr/local/bin/backup_restoration.py", "balsam": "/usr/local/bin/balsam", "bipartition_examiner.py": "/usr/local/bin/bipartition_examiner.py", "bmge.yaml": "/usr/local/bin/bmge.yaml", "build_database.py": "/usr/local/bin/build_database.py", "config.py": "/usr/local/bin/config.py", "dist_est": "/usr/local/bin/dist_est", "divvier.yaml": "/usr/local/bin/divvier.yaml", "dumpsexp": "/usr/local/bin/dumpsexp", "explore_database.py": "/usr/local/bin/explore_database.py", "fast_site_remover.py": "/usr/local/bin/fast_site_remover.py", "fast_taxa_remover.py": "/usr/local/bin/fast_taxa_remover.py", "fisher.py": "/usr/local/bin/fisher.py", "forest.py": "/usr/local/bin/forest.py", "genetic_code_examiner.py": "/usr/local/bin/genetic_code_examiner.py", "getfattr": "/usr/local/bin/getfattr", "gfmix.yaml": "/usr/local/bin/gfmix.yaml", "gfmix_mammal.smk": "/usr/local/bin/gfmix_mammal.smk", "gfmix_runner.py": "/usr/local/bin/gfmix_runner.py", "gpg-error": "/usr/local/bin/gpg-error", "gpgrt-config": "/usr/local/bin/gpgrt-config", "heterotachy.py": "/usr/local/bin/heterotachy.py", "hmac256": "/usr/local/bin/hmac256", "informant.py": "/usr/local/bin/informant.py", "install_deps.py": "/usr/local/bin/install_deps.py", "jackd": "/usr/local/bin/jackd", "lame": "/usr/local/bin/lame", "libgcrypt-config": "/usr/local/bin/libgcrypt-config", "lprodump": "/usr/local/bin/lprodump", "lrelease-pro": "/usr/local/bin/lrelease-pro", "lupdate-pro": "/usr/local/bin/lupdate-pro", "mafft.yaml": "/usr/local/bin/mafft.yaml", "mammal.yaml": "/usr/local/bin/mammal.yaml", "mammal_modeler.py": "/usr/local/bin/mammal_modeler.py", "matplotlib": "/usr/local/bin/matplotlib", "matrix_constructor.py": "/usr/local/bin/matrix_constructor.py", "meshdebug": "/usr/local/bin/meshdebug", "mpg123": "/usr/local/bin/mpg123", "mpg123-id3dump": "/usr/local/bin/mpg123-id3dump", "mpg123-strip": "/usr/local/bin/mpg123-strip", "mpicalc": "/usr/local/bin/mpicalc", "orc-bugreport": "/usr/local/bin/orc-bugreport", "orcc": "/usr/local/bin/orcc", "out123": "/usr/local/bin/out123", "pa-info": "/usr/local/bin/pa-info", "pacat": "/usr/local/bin/pacat", "pacmd": "/usr/local/bin/pacmd", "pactl": "/usr/local/bin/pactl", "padsp": "/usr/local/bin/padsp", "pamon": "/usr/local/bin/pamon", "paplay": "/usr/local/bin/paplay", "parec": "/usr/local/bin/parec", "parecord": "/usr/local/bin/parecord", "pasuspender": "/usr/local/bin/pasuspender", "prep_final_dataset.py": "/usr/local/bin/prep_final_dataset.py", "prequal.yaml": "/usr/local/bin/prequal.yaml", "pulseaudio": "/usr/local/bin/pulseaudio", "purge.py": "/usr/local/bin/purge.py", "qmlformat": "/usr/local/bin/qmlformat", "qmltime": "/usr/local/bin/qmltime", "qmltyperegistrar": "/usr/local/bin/qmltyperegistrar", "qpaeq": "/usr/local/bin/qpaeq", "random_resampler.py": "/usr/local/bin/random_resampler.py", "raxml.yaml": "/usr/local/bin/raxml.yaml", "rtc_binner.py": "/usr/local/bin/rtc_binner.py", "select_orthologs.py": "/usr/local/bin/select_orthologs.py", "select_taxa.py": "/usr/local/bin/select_taxa.py", "setfattr": "/usr/local/bin/setfattr", "sgt_constructor.py": "/usr/local/bin/sgt_constructor.py", "sgt_constructor.smk": "/usr/local/bin/sgt_constructor.smk", "sip-build": "/usr/local/bin/sip-build", "sip-distinfo": "/usr/local/bin/sip-distinfo", "sip-install": "/usr/local/bin/sip-install", "sip-module": "/usr/local/bin/sip-module", "sip-sdist": "/usr/local/bin/sip-sdist", "sip-wheel": "/usr/local/bin/sip-wheel", "taxon_collapser.py": "/usr/local/bin/taxon_collapser.py", "tracegen": "/usr/local/bin/tracegen", "trimal.yaml": "/usr/local/bin/trimal.yaml", "working_dataset_constructor.py": "/usr/local/bin/working_dataset_constructor.py", "yat2m": "/usr/local/bin/yat2m", "flac": "/usr/local/bin/flac", "metaflac": "/usr/local/bin/metaflac", "sndfile-cmp": "/usr/local/bin/sndfile-cmp", "sndfile-concat": "/usr/local/bin/sndfile-concat", "sndfile-convert": "/usr/local/bin/sndfile-convert", "sndfile-deinterleave": "/usr/local/bin/sndfile-deinterleave", "sndfile-info": "/usr/local/bin/sndfile-info", "sndfile-interleave": "/usr/local/bin/sndfile-interleave", "sndfile-metadata-get": "/usr/local/bin/sndfile-metadata-get", "sndfile-metadata-set": "/usr/local/bin/sndfile-metadata-set", "sndfile-play": "/usr/local/bin/sndfile-play", "sndfile-salvage": "/usr/local/bin/sndfile-salvage", "docutils": "/usr/local/bin/docutils", "FET.pl": "/usr/local/bin/FET.pl", "cd-hit-clstr_2_blm8.pl": "/usr/local/bin/cd-hit-clstr_2_blm8.pl", "clstr_list.pl": "/usr/local/bin/clstr_list.pl", "clstr_list_sort.pl": "/usr/local/bin/clstr_list_sort.pl", "cd-hit": "/usr/local/bin/cd-hit", "cd-hit-2d": "/usr/local/bin/cd-hit-2d", "cd-hit-2d-para.pl": "/usr/local/bin/cd-hit-2d-para.pl", "cd-hit-454": "/usr/local/bin/cd-hit-454", "cd-hit-div": "/usr/local/bin/cd-hit-div", "cd-hit-div.pl": "/usr/local/bin/cd-hit-div.pl", "cd-hit-est-2d": "/usr/local/bin/cd-hit-est-2d", "cd-hit-para.pl": "/usr/local/bin/cd-hit-para.pl"}}
---

This module is a singularity container wrapper for quay.io/biocontainers/phylofisher.
singularity registry hpc automated addition for phylofisher
After [installing shpc](#install) you will want to install this container module:


```bash
$ shpc install quay.io/biocontainers/phylofisher
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/phylofisher:1.2.5--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/phylofisher/1.2.5--pyhdfd78af_0
$ module help quay.io/biocontainers/phylofisher/1.2.5--pyhdfd78af_0
```
...
#### phylofisher-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### phylofisher-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/aa_comp_calculator.py
$ podman run --it --rm --entrypoint /usr/local/bin/aa_comp_calculator.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/aa_comp_calculator.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/aa_recoder.py
$ podman run --it --rm --entrypoint /usr/local/bin/aa_recoder.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/aa_recoder.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/apply_to_db.py
$ podman run --it --rm --entrypoint /usr/local/bin/apply_to_db.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/apply_to_db.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/astral_runner.py
$ podman run --it --rm --entrypoint /usr/local/bin/astral_runner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/astral_runner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/backup_restoration.py
$ podman run --it --rm --entrypoint /usr/local/bin/backup_restoration.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/backup_restoration.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/bipartition_examiner.py
$ podman run --it --rm --entrypoint /usr/local/bin/bipartition_examiner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bipartition_examiner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/bmge.yaml
$ podman run --it --rm --entrypoint /usr/local/bin/bmge.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/bmge.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/build_database.py
$ podman run --it --rm --entrypoint /usr/local/bin/build_database.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/build_database.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/config.py
$ podman run --it --rm --entrypoint /usr/local/bin/config.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/config.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/divvier.yaml
$ podman run --it --rm --entrypoint /usr/local/bin/divvier.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/divvier.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/explore_database.py
$ podman run --it --rm --entrypoint /usr/local/bin/explore_database.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/explore_database.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fast_site_remover.py
$ podman run --it --rm --entrypoint /usr/local/bin/fast_site_remover.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fast_site_remover.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fast_taxa_remover.py
$ podman run --it --rm --entrypoint /usr/local/bin/fast_taxa_remover.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fast_taxa_remover.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/fisher.py
$ podman run --it --rm --entrypoint /usr/local/bin/fisher.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/fisher.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/forest.py
$ podman run --it --rm --entrypoint /usr/local/bin/forest.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/forest.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/genetic_code_examiner.py
$ podman run --it --rm --entrypoint /usr/local/bin/genetic_code_examiner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/genetic_code_examiner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gfmix.yaml
$ podman run --it --rm --entrypoint /usr/local/bin/gfmix.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gfmix.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gfmix_mammal.smk
$ podman run --it --rm --entrypoint /usr/local/bin/gfmix_mammal.smk   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gfmix_mammal.smk   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/gfmix_runner.py
$ podman run --it --rm --entrypoint /usr/local/bin/gfmix_runner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/gfmix_runner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/heterotachy.py
$ podman run --it --rm --entrypoint /usr/local/bin/heterotachy.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/heterotachy.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/informant.py
$ podman run --it --rm --entrypoint /usr/local/bin/informant.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/informant.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/install_deps.py
$ podman run --it --rm --entrypoint /usr/local/bin/install_deps.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/install_deps.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mafft.yaml
$ podman run --it --rm --entrypoint /usr/local/bin/mafft.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mafft.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mammal.yaml
$ podman run --it --rm --entrypoint /usr/local/bin/mammal.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mammal.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/mammal_modeler.py
$ podman run --it --rm --entrypoint /usr/local/bin/mammal_modeler.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/mammal_modeler.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/matrix_constructor.py
$ podman run --it --rm --entrypoint /usr/local/bin/matrix_constructor.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/matrix_constructor.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/prep_final_dataset.py
$ podman run --it --rm --entrypoint /usr/local/bin/prep_final_dataset.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/prep_final_dataset.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/prequal.yaml
$ podman run --it --rm --entrypoint /usr/local/bin/prequal.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/prequal.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/purge.py
$ podman run --it --rm --entrypoint /usr/local/bin/purge.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/purge.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/random_resampler.py
$ podman run --it --rm --entrypoint /usr/local/bin/random_resampler.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/random_resampler.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/raxml.yaml
$ podman run --it --rm --entrypoint /usr/local/bin/raxml.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/raxml.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/rtc_binner.py
$ podman run --it --rm --entrypoint /usr/local/bin/rtc_binner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/rtc_binner.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/select_orthologs.py
$ podman run --it --rm --entrypoint /usr/local/bin/select_orthologs.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/select_orthologs.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/sgt_constructor.py
$ podman run --it --rm --entrypoint /usr/local/bin/sgt_constructor.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sgt_constructor.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/sgt_constructor.smk
$ podman run --it --rm --entrypoint /usr/local/bin/sgt_constructor.smk   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/sgt_constructor.smk   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/taxon_collapser.py
$ podman run --it --rm --entrypoint /usr/local/bin/taxon_collapser.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/taxon_collapser.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/trimal.yaml
$ podman run --it --rm --entrypoint /usr/local/bin/trimal.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/trimal.yaml   -v ${PWD} -w ${PWD} <container> -c " $@"
```
...
```bash
$ singularity exec <container> /usr/local/bin/working_dataset_constructor.py
$ podman run --it --rm --entrypoint /usr/local/bin/working_dataset_constructor.py   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/working_dataset_constructor.py   -v ${PWD} -w ${PWD} <container> -c " $@"
```
