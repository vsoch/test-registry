...
updated_at: "2023-03-10 03:23:43.233704"
latest: "0.70--pyhdfd78af_1"
...
```bash
$ shpc install quay.io/biocontainers/pydamage:0.70--pyhdfd78af_1
```
...
```bash
$ module load quay.io/biocontainers/pydamage/0.70--pyhdfd78af_1
$ module help quay.io/biocontainers/pydamage/0.70--pyhdfd78af_1
```
