---
layout: container
name:  "quay.io/biocontainers/intervaltree"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:11:25.632651"
latest: "2.1.0--py36_0"
...
```bash
$ shpc install quay.io/biocontainers/intervaltree
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/intervaltree:2.1.0--py36_0
```
...
```bash
$ module load quay.io/biocontainers/intervaltree/2.1.0--py36_0
$ module help quay.io/biocontainers/intervaltree/2.1.0--py36_0
```
...
#### intervaltree-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### intervaltree-inspect-deffile:
