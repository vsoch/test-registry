---
layout: container
name:  "quay.io/biocontainers/astalavista"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:18:53.897553"
latest: "4.0--1"
...
```bash
$ shpc install quay.io/biocontainers/astalavista
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/astalavista:4.0--1
```
...
```bash
$ module load quay.io/biocontainers/astalavista/4.0--1
$ module help quay.io/biocontainers/astalavista/4.0--1
```
...
#### astalavista-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### astalavista-inspect-deffile:
...
```bash
$ singularity exec <container> /usr/local/bin/astalavista
$ podman run --it --rm --entrypoint /usr/local/bin/astalavista   -v ${PWD} -w ${PWD} <container> -c " $@"
$ docker run --it --rm --entrypoint /usr/local/bin/astalavista   -v ${PWD} -w ${PWD} <container> -c " $@"
```
