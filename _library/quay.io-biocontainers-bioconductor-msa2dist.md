---
layout: container
name:  "quay.io/biocontainers/bioconductor-msa2dist"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:10:14.263499"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-msa2dist
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-msa2dist:1.2.0--r42hc247a5b_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-msa2dist/1.2.0--r42hc247a5b_0
$ module help quay.io/biocontainers/bioconductor-msa2dist/1.2.0--r42hc247a5b_0
```
...
#### bioconductor-msa2dist-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-msa2dist-inspect-deffile:
