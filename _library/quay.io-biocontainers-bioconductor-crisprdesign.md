---
layout: container
name:  "quay.io/biocontainers/bioconductor-crisprdesign"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 02:56:38.187337"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprdesign
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-crisprdesign:1.0.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-crisprdesign/1.0.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-crisprdesign/1.0.0--r42hdfd78af_0
```
...
#### bioconductor-crisprdesign-shell:
...
#### bioconductor-crisprdesign-exec:
...
#### bioconductor-crisprdesign-inspect:
...
#### bioconductor-crisprdesign-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-crisprdesign-inspect-deffile:
