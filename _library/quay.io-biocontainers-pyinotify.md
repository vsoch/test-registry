---
layout: container
name:  "quay.io/biocontainers/pyinotify"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:22:40.721660"
latest: "0.9.6--py35_0"
...
```bash
$ shpc install quay.io/biocontainers/pyinotify
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/pyinotify:0.9.6--py35_0
```
...
```bash
$ module load quay.io/biocontainers/pyinotify/0.9.6--py35_0
$ module help quay.io/biocontainers/pyinotify/0.9.6--py35_0
```
...
#### pyinotify-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### pyinotify-inspect-deffile:
