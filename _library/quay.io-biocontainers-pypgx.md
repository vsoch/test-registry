...
updated_at: "2023-03-10 03:34:21.853089"
...
```bash
$ shpc install quay.io/biocontainers/pypgx:0.20.0--pyh7cba7a3_0
```
...
```bash
$ module load quay.io/biocontainers/pypgx/0.20.0--pyh7cba7a3_0
$ module help quay.io/biocontainers/pypgx/0.20.0--pyh7cba7a3_0
```
