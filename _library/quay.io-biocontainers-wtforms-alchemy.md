---
layout: container
name:  "quay.io/biocontainers/wtforms-alchemy"
maintainer: "@vsoch"
...
updated_at: "2023-03-10 03:40:36.463621"
latest: "0.16.9--py_0"
...
```bash
$ shpc install quay.io/biocontainers/wtforms-alchemy
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/wtforms-alchemy:0.16.9--py_0
```
...
```bash
$ module load quay.io/biocontainers/wtforms-alchemy/0.16.9--py_0
$ module help quay.io/biocontainers/wtforms-alchemy/0.16.9--py_0
```
...
#### wtforms-alchemy-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### wtforms-alchemy-inspect-deffile:
