---
layout: container
name:  "quay.io/biocontainers/r-robustrankaggreg"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:22:39.776257"
latest: "1.1--r3.2.2_0"
...
```bash
$ shpc install quay.io/biocontainers/r-robustrankaggreg
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/r-robustrankaggreg:1.1--r3.2.2_0
```
...
```bash
$ module load quay.io/biocontainers/r-robustrankaggreg/1.1--r3.2.2_0
$ module help quay.io/biocontainers/r-robustrankaggreg/1.1--r3.2.2_0
```
...
#### r-robustrankaggreg-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### r-robustrankaggreg-inspect-deffile:
