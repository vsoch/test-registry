...
updated_at: "2023-03-10 03:04:25.076681"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-tomoseqr:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-tomoseqr/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-tomoseqr/1.2.0--r42hdfd78af_0
```
