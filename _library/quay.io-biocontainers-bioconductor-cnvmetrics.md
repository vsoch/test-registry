---
layout: container
name:  "quay.io/biocontainers/bioconductor-cnvmetrics"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:14:13.138436"
...
```bash
$ shpc install quay.io/biocontainers/bioconductor-cnvmetrics
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/bioconductor-cnvmetrics:1.2.0--r42hdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/bioconductor-cnvmetrics/1.2.0--r42hdfd78af_0
$ module help quay.io/biocontainers/bioconductor-cnvmetrics/1.2.0--r42hdfd78af_0
```
...
#### bioconductor-cnvmetrics-inspect:
...
#### bioconductor-cnvmetrics-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### bioconductor-cnvmetrics-inspect-deffile:
