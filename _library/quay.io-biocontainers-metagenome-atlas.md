...
updated_at: "2023-03-09 02:59:44.312113"
latest: "2.14.3--pyhdfd78af_0"
...
```bash
$ shpc install quay.io/biocontainers/metagenome-atlas:2.14.3--pyhdfd78af_0
```
...
```bash
$ module load quay.io/biocontainers/metagenome-atlas/2.14.3--pyhdfd78af_0
$ module help quay.io/biocontainers/metagenome-atlas/2.14.3--pyhdfd78af_0
```
