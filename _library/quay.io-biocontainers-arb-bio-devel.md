---
layout: container
name:  "quay.io/biocontainers/arb-bio-devel"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:32:30.286533"
...
```bash
$ shpc install quay.io/biocontainers/arb-bio-devel
```

Or a specific version:

```bash
$ shpc install quay.io/biocontainers/arb-bio-devel:6.0.6--h6bb024c_8
```
...
```bash
$ module load quay.io/biocontainers/arb-bio-devel/6.0.6--h6bb024c_8
$ module help quay.io/biocontainers/arb-bio-devel/6.0.6--h6bb024c_8
```
...
#### arb-bio-devel-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### arb-bio-devel-inspect-deffile:
