---
layout: container
name:  "quay.io/biocontainers/perl-number-format"
maintainer: "@vsoch"
...
updated_at: "2023-03-09 03:39:53.759871"
...
```bash
$ shpc install quay.io/biocontainers/perl-number-format
```
...
#### perl-number-format-inspect-runscript:

```bash
$ singularity inspect -r <container>
```

#### perl-number-format-inspect-deffile:
